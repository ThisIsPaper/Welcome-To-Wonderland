        ...
        public override ActionResult Index(RenderModel renderModel)
        {
            ...
            if (topFundraisers == null || topPartyHosts == null)
            {
                ...
                if (topFundraisers == null)
                {
                    ...
                    cache.Insert("TopFundraisers", topFundraisers, null, DateTime.UtcNow.AddMinutes(10 + random.Next(5)), Cache.NoSlidingExpiration);
                }
                ...
                if (topPartyHosts == null)
                {
                    ...
                    cache.Insert("TopPartyHosts", topPartyHosts, null, DateTime.UtcNow.AddMinutes(10 + random.Next(5)), Cache.NoSlidingExpiration);
                }
            }
