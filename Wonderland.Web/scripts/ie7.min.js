...
(function() {
    function N(p, r) {
        ...
        var v, B, w, H = H.prototype, u = H.toString, s = new C(-0xc782b5b800cec);
        try {
        ...
        if (!q("json")) {
            ...
            if ((v = H.hasOwnProperty) || (v = function(a) {
                ...
                return b = f = null, e ? B = 2 == e ? function(a, c) {
                    var f, e = {}, b = "[object Function]" == u.call(a);
                ...
                B = function(a, c) {
                    var b, e = "[object Function]" == u.call(a), h = !e && "function" != typeof a.constructor && F[typeof a.hasOwnProperty] && a.hasOwnProperty || v;
                ...
                var U = {
                    ...
                    if ("object" == typeof g && g) if (m = u.call(g), "[object Date]" != m || v.call(g, "toJSON")) "function" == typeof g.toJSON && ("[object Number]" != m && "[object String]" != m && "[object Array]" != m || v.call(g, "toJSON")) && (g = g.toJSON(a)); else if (g > -1 / 0 && 1 / 0 > g) {
                        if (E) {
                ...
                r.stringify = function(a, c, b) {
                    ...
                    if (b) if ("[object Number]" == (d = u.call(b))) {
                        if (0 < (b -= b % 1)) for (h = "", b > 10 && (b = 10); h.length < b; h += " ") ;
                    } else "[object String]" == d && (h = 10 >= b.length ? b : b.slice(0, 10));
                    return O("", (l = {}, l[""] = a, l), f, n, h, "", []);
                };
            }
            if (!q("json-parse")) {
                var b, J, V = A.fromCharCode, W = {
                    92: "\\",
                    34: '"',
                    47: "/",
                    98: "\b",
                    ...
                    for (var e, h, f, k, d, a = J, c = a.length; c > b; ) switch (d = a.charCodeAt(b)) {
                      ...
                      case 34:
                        for (e = "@", b++; c > b; ) if (d = a.charCodeAt(b), 32 > d) l(); else if (92 == d) switch (d = a.charCodeAt(++b)) {
                          case 92:
                          case 34:
                          case 47:
                          case 98:
    ...
    var K = "function" == typeof define && define.amd, F = {
        "function": !0,
        object: !0
    ...
    if (!t || t.global !== t && t.window !== t && t.self !== t || (k = t), G && !K) N(k, G); else {
...
}).call(this), document.querySelectorAll || (document.querySelectorAll = function(selectors) {
    var element, style = document.createElement("style"), elements = [];
    for (document.documentElement.firstChild.appendChild(style), document._qsa = [], 
    style.styleSheet.cssText = selectors + "{x-qsa:expression(document._qsa && document._qsa.push(this))}", 
    window.scrollBy(0, 0), style.parentNode.removeChild(style); document._qsa.length; ) element = document._qsa.shift(), 
    element.style.removeAttribute("x-qsa"), elements.push(element);
