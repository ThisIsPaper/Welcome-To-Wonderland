...
wonderlandApp.config([ "$provide", function($provide) {
    ...
    $scope.partyCopyData = null, $scope.partyCopyDataForForm = null, $scope.partyCopyDataInit = function(partyCopyData) {
        ...
        $scope.partyCopyDataInit(dataObject), $ocModal.close("partyCopyModal");
    ...
    $scope.fundraisingTargetDataInit = function(fundraisingTargetData) {
        ...
        $scope.fundraisingTargetDataInit(dataObject), $ocModal.close("fundraisingTargetDataModal");
    });
    var initUrl = null;
    ...
    return {
        ...
        link: function(scope, element, attrs) {
            function handleResponse(response, originalData) {
                response && response.data && dataVar.assign(scope.$parent, response.data), response && response.success === !1 ? setProgressState("ready") : (setProgressState("saved"), 
            ...
            var progressState, progressVar = attrs.mProgressVar && $parse(attrs.mProgressVar), dataVar = $parse(attrs.mPostOnSubmit), formSubmitRequest = null, savedConfirmTimer = null, serialized = attrs.hasOwnProperty("mSerialized"), onSuccessEvent = attrs.mOnSuccessEvent;
