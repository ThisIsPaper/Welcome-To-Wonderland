...
}}),ngTranscludeDirective=ngDirective({link:function($scope,$element,$attrs,controller,$transclude){if(!$transclude)throw minErr("ngTransclude")("orphan","Illegal use of ngTransclude directive in the template! No parent directive that requires a transclusion found. Element: {0}",startingTag($element));$transclude(function(clone){$element.empty(),$element.append(clone)})}}),scriptDirective=["$templateCache",function($templateCache){return{restrict:"E",terminal:!0,compile:function(element,attr){if("text/ng-template"==attr.type){var templateUrl=attr.id,text=element[0].text;$templateCache.put(templateUrl,text)}}}}],ngOptionsMinErr=minErr("ngOptions"),ngOptionsDirective=valueFn({terminal:!0}),selectDirective=["$compile","$parse",function($compile,$parse){var NG_OPTIONS_REGEXP=/^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,nullModelCtrl={$setViewValue:noop};return{restrict:"E",require:["select","?ngModel"],controller:["$element","$scope","$attrs",function($element,$scope,$attrs){var nullOption,unknownOption,self=this,optionsMap={},ngModelCtrl=nullModelCtrl;self.databound=$attrs.ngModel,self.init=function(ngModelCtrl_,nullOption_,unknownOption_){ngModelCtrl=ngModelCtrl_,nullOption=nullOption_,unknownOption=unknownOption_},self.addOption=function(value){assertNotHasOwnProperty(value,'"option value"'),optionsMap[value]=!0,ngModelCtrl.$viewValue==value&&($element.val(value),unknownOption.parent()&&unknownOption.remove())},self.removeOption=function(value){this.hasOption(value)&&(delete optionsMap[value],ngModelCtrl.$viewValue==value&&this.renderUnknownOption(value))},self.renderUnknownOption=function(val){var unknownVal="? "+hashKey(val)+" ?";unknownOption.val(unknownVal),$element.prepend(unknownOption),$element.val(unknownVal),unknownOption.prop("selected",!0)},self.hasOption=function(value){return optionsMap.hasOwnProperty(value)},$scope.$on("$destroy",function(){self.renderUnknownOption=noop})}],link:function(scope,element,attr,ctrls){function setupAsSingle(scope,selectElement,ngModelCtrl,selectCtrl){ngModelCtrl.$render=function(){var viewValue=ngModelCtrl.$viewValue;selectCtrl.hasOption(viewValue)?(unknownOption.parent()&&unknownOption.remove(),selectElement.val(viewValue),""===viewValue&&emptyOption.prop("selected",!0)):isUndefined(viewValue)&&emptyOption?selectElement.val(""):selectCtrl.renderUnknownOption(viewValue)},selectElement.on("change",function(){scope.$apply(function(){unknownOption.parent()&&unknownOption.remove(),ngModelCtrl.$setViewValue(selectElement.val())})})}function setupAsMultiple(scope,selectElement,ctrl){var lastView;ctrl.$render=function(){var items=new HashMap(ctrl.$viewValue);forEach(selectElement.find("option"),function(option){option.selected=isDefined(items.get(option.value))})},scope.$watch(function(){equals(lastView,ctrl.$viewValue)||(lastView=shallowCopy(ctrl.$viewValue),ctrl.$render())}),selectElement.on("change",function(){scope.$apply(function(){var array=[];forEach(selectElement.find("option"),function(option){option.selected&&array.push(option.value)}),ctrl.$setViewValue(array)})})}function setupAsOptions(scope,selectElement,ctrl){function getSelectedSet(){var selectedSet=!1;if(multiple){var modelValue=ctrl.$modelValue;if(trackFn&&isArray(modelValue)){selectedSet=new HashMap([]);for(var locals={},trackIndex=0;trackIndex<modelValue.length;trackIndex++)locals[valueName]=modelValue[trackIndex],selectedSet.put(trackFn(scope,locals),modelValue[trackIndex])}else selectedSet=new HashMap(modelValue)}return selectedSet}function render(){var optionGroupName,optionGroup,option,existingParent,existingOptions,existingOption,key,groupLength,length,groupIndex,index,selected,lastElement,element,label,optionGroups={"":[]},optionGroupNames=[""],modelValue=ctrl.$modelValue,values=valuesFn(scope)||[],keys=keyName?sortedKeys(values):values,locals={},selectedSet=getSelectedSet();for(index=0;length=keys.length,length>index;index++){if(key=index,keyName){if(key=keys[index],"$"===key.charAt(0))continue;locals[keyName]=key}if(locals[valueName]=values[key],optionGroupName=groupByFn(scope,locals)||"",(optionGroup=optionGroups[optionGroupName])||(optionGroup=optionGroups[optionGroupName]=[],optionGroupNames.push(optionGroupName)),multiple)selected=isDefined(selectedSet.remove(trackFn?trackFn(scope,locals):valueFn(scope,locals)));else{if(trackFn){var modelCast={};modelCast[valueName]=modelValue,selected=trackFn(scope,modelCast)===trackFn(scope,locals)}else selected=modelValue===valueFn(scope,locals);selectedSet=selectedSet||selected}label=displayFn(scope,locals),label=isDefined(label)?label:"",optionGroup.push({id:trackFn?trackFn(scope,locals):keyName?keys[index]:index,label:label,selected:selected})}for(multiple||(nullOption||null===modelValue?optionGroups[""].unshift({id:"",label:"",selected:!selectedSet}):selectedSet||optionGroups[""].unshift({id:"?",label:"",selected:!0})),groupIndex=0,groupLength=optionGroupNames.length;groupLength>groupIndex;groupIndex++){for(optionGroupName=optionGroupNames[groupIndex],optionGroup=optionGroups[optionGroupName],optionGroupsCache.length<=groupIndex?(existingParent={element:optGroupTemplate.clone().attr("label",optionGroupName),label:optionGroup.label},existingOptions=[existingParent],optionGroupsCache.push(existingOptions),selectElement.append(existingParent.element)):(existingOptions=optionGroupsCache[groupIndex],existingParent=existingOptions[0],existingParent.label!=optionGroupName&&existingParent.element.attr("label",existingParent.label=optionGroupName)),lastElement=null,index=0,length=optionGroup.length;length>index;index++)option=optionGroup[index],(existingOption=existingOptions[index+1])?(lastElement=existingOption.element,existingOption.label!==option.label&&lastElement.text(existingOption.label=option.label),existingOption.id!==option.id&&lastElement.val(existingOption.id=option.id),lastElement[0].selected!==option.selected&&(lastElement.prop("selected",existingOption.selected=option.selected),msie&&lastElement.prop("selected",existingOption.selected))):(""===option.id&&nullOption?element=nullOption:(element=optionTemplate.clone()).val(option.id).prop("selected",option.selected).attr("selected",option.selected).text(option.label),existingOptions.push(existingOption={element:element,label:option.label,id:option.id,selected:option.selected}),selectCtrl.addOption(option.label,element),lastElement?lastElement.after(element):existingParent.element.append(element),lastElement=element);for(index++;existingOptions.length>index;)option=existingOptions.pop(),selectCtrl.removeOption(option.label),option.element.remove()}for(;optionGroupsCache.length>groupIndex;)optionGroupsCache.pop()[0].element.remove()}var match;if(!(match=optionsExp.match(NG_OPTIONS_REGEXP)))throw ngOptionsMinErr("iexp","Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}",optionsExp,startingTag(selectElement));var displayFn=$parse(match[2]||match[1]),valueName=match[4]||match[6],keyName=match[5],groupByFn=$parse(match[3]||""),valueFn=$parse(match[2]?match[1]:valueName),valuesFn=$parse(match[7]),track=match[8],trackFn=track?$parse(match[8]):null,optionGroupsCache=[[{element:selectElement,label:""}]];nullOption&&($compile(nullOption)(scope),nullOption.removeClass("ng-scope"),nullOption.remove()),selectElement.empty(),selectElement.on("change",function(){scope.$apply(function(){var optionGroup,key,value,optionElement,index,groupIndex,length,groupLength,trackIndex,collection=valuesFn(scope)||[],locals={};if(multiple){for(value=[],groupIndex=0,groupLength=optionGroupsCache.length;groupLength>groupIndex;groupIndex++)for(optionGroup=optionGroupsCache[groupIndex],index=1,length=optionGroup.length;length>index;index++)if((optionElement=optionGroup[index].element)[0].selected){if(key=optionElement.val(),keyName&&(locals[keyName]=key),trackFn)for(trackIndex=0;trackIndex<collection.length&&(locals[valueName]=collection[trackIndex],trackFn(scope,locals)!=key);trackIndex++);else locals[valueName]=collection[key];value.push(valueFn(scope,locals))}}else if(key=selectElement.val(),"?"==key)value=undefined;else if(""===key)value=null;else if(trackFn){for(trackIndex=0;trackIndex<collection.length;trackIndex++)if(locals[valueName]=collection[trackIndex],trackFn(scope,locals)==key){value=valueFn(scope,locals);break}}else locals[valueName]=collection[key],keyName&&(locals[keyName]=key),value=valueFn(scope,locals);ctrl.$setViewValue(value),render()})}),ctrl.$render=render,scope.$watchCollection(valuesFn,render),scope.$watchCollection(function(){var locals={},values=valuesFn(scope);if(values){for(var toDisplay=new Array(values.length),i=0,ii=values.length;ii>i;i++)locals[valueName]=values[i],toDisplay[i]=displayFn(scope,locals);return toDisplay}},render),multiple&&scope.$watchCollection(function(){return ctrl.$modelValue},render)}if(ctrls[1]){for(var emptyOption,selectCtrl=ctrls[0],ngModelCtrl=ctrls[1],multiple=attr.multiple,optionsExp=attr.ngOptions,nullOption=!1,optionTemplate=jqLite(document.createElement("option")),optGroupTemplate=jqLite(document.createElement("optgroup")),unknownOption=optionTemplate.clone(),i=0,children=element.children(),ii=children.length;ii>i;i++)if(""===children[i].value){emptyOption=nullOption=children.eq(i);break}selectCtrl.init(ngModelCtrl,nullOption,unknownOption),multiple&&(ngModelCtrl.$isEmpty=function(value){return!value||0===value.length}),optionsExp?setupAsOptions(scope,element,ngModelCtrl):multiple?setupAsMultiple(scope,element,ngModelCtrl):setupAsSingle(scope,element,ngModelCtrl,selectCtrl)}}}}],optionDirective=["$interpolate",function($interpolate){var nullSelectCtrl={addOption:noop,removeOption:noop};return{restrict:"E",priority:100,compile:function(element,attr){if(isUndefined(attr.value)){var interpolateFn=$interpolate(element.text(),!0);interpolateFn||attr.$set("value",element.text())}return function(scope,element,attr){var selectCtrlName="$selectController",parent=element.parent(),selectCtrl=parent.data(selectCtrlName)||parent.parent().data(selectCtrlName);selectCtrl&&selectCtrl.databound?element.prop("selected",!1):selectCtrl=nullSelectCtrl,interpolateFn?scope.$watch(interpolateFn,function(newVal,oldVal){attr.$set("value",newVal),newVal!==oldVal&&selectCtrl.removeOption(oldVal),selectCtrl.addOption(newVal)}):selectCtrl.addOption(attr.value),element.on("$destroy",function(){selectCtrl.removeOption(attr.value)})}}}}],styleDirective=valueFn({restrict:"E",terminal:!0});window.angular.bootstrap||(bindJQuery(),publishExternalAPI(angular),jqLite(document).ready(function(){angularInit(document,bootstrap)}))}(window,document),!window.angular.$$csp()&&window.angular.element(document).find("head").prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\\:form{display:block;}.ng-animate-block-transitions{transition:0s all!important;-webkit-transition:0s all!important;}.ng-hide-add-active,.ng-hide-remove{display:block!important;}</style>'),function(){"use strict";var ocModal=angular.module("oc.modal",[]);ocModal.factory("$ocModal",["$rootScope","$controller","$location","$timeout","$compile","$sniffer","$q",function($rootScope,$controller,$location,$timeout,$compile,$sniffer,$q){var baseOverflow,$body=angular.element(document.body),$dialogsWrapper=angular.element('<div role="dialog" tabindex="-1" class="modal"><div class="modal-backdrop"></div></div>'),$modalWrapper=angular.element('<div class="modal-wrapper"></div>'),modals={},openedModals=[];$modalWrapper.css("display","none"),$modalWrapper.append($dialogsWrapper),$body.append($modalWrapper),$dialogsWrapper.on("click",function(e){angular.element(e.target).hasClass("modal-backdrop")&&$rootScope.$apply(function(){self.closeOnEsc()}),e.stopPropagation()});var parseMaxTime=function(str){var total=0,values=angular.isString(str)?str.split(/\s*,\s*/):[];return angular.forEach(values,function(value){total=Math.max(parseFloat(value)||0,total)}),total},getAnimDuration=function($element){var duration=0;if($sniffer.transitions||$sniffer.animations){var w3cAnimationProp="animation",w3cTransitionProp="transition",vendorAnimationProp=$sniffer.vendorPrefix+"Animation",vendorTransitionProp=$sniffer.vendorPrefix+"Transition",durationKey="Duration",delayKey="Delay",animationIterationCountKey="IterationCount",ELEMENT_NODE=1;angular.forEach($element,function(element){if(element.nodeType==ELEMENT_NODE){var elementStyles=window.getComputedStyle(element)||{},transitionDelay=Math.max(parseMaxTime(elementStyles[w3cTransitionProp+delayKey]),parseMaxTime(elementStyles[vendorTransitionProp+delayKey])),animationDelay=Math.max(parseMaxTime(elementStyles[w3cAnimationProp+delayKey]),parseMaxTime(elementStyles[vendorAnimationProp+delayKey])),transitionDuration=Math.max(parseMaxTime(elementStyles[w3cTransitionProp+durationKey]),parseMaxTime(elementStyles[vendorTransitionProp+durationKey])),animationDuration=Math.max(parseMaxTime(elementStyles[w3cAnimationProp+durationKey]),parseMaxTime(elementStyles[vendorAnimationProp+durationKey]));animationDuration>0&&(animationDuration*=Math.max(parseInt(elementStyles[w3cAnimationProp+animationIterationCountKey])||0,parseInt(elementStyles[vendorAnimationProp+animationIterationCountKey])||0,1)),duration=Math.max(animationDelay+animationDuration,transitionDelay+transitionDuration,duration)}})}return 1e3*duration};angular.element(document).on("keyup",function(e){27==e.keyCode&&openedModals.length>0&&(e.stopPropagation(),$rootScope.$apply(function(){self.closeOnEsc(openedModals[openedModals.length-1])}))});var self={waitingForOpen:!1,getOpenedModals:function(){return openedModals},register:function(params){modals[params.id||"_default"]=params},remove:function(id){delete modals[id||"_default"]},open:function(opt){"string"==typeof opt&&(opt=opt.match("<")?{template:opt}:{url:opt});var modal=modals[opt.id||"_default"];if(!modal)return $dialogsWrapper.append($compile('<div oc-modal="'+(opt.id?opt.id:"_default")+'"></div>')($rootScope)),void $timeout(function(){self.open(opt)});if(modal&&-1!==openedModals.indexOf(opt.id||"_default")){if(self.waitingForOpen)return;return self.waitingForOpen=!0,void self.close(opt.id).then(function(){self.open(opt)})}if(!self.waitingForOpen)if(0===openedModals.length)baseOverflow=document.body.style.overflow,document.body.style.overflow="hidden",$modalWrapper.css("display","block");else for(var i=0,len=openedModals.length;len>i;i++){var $e=modals[openedModals[i]].$element;modals[openedModals[i]].baseZIndex=$e.css("z-index"),$e.css("z-index","-1"),$e.addClass("no-backdrop")}self.waitingForOpen=!1,openedModals.push(opt.id||"_default"),modal.params=opt,modal.$scope.customClass=modal.params.cls,$rootScope.$digest(),$body[0].offsetWidth,$timeout(function(){modal.$scope.modalShow=!0},100),"function"==typeof modal.params.onOpen&&modal.params.onOpen();var off=modal.$scope.$on("$includeContentLoaded",function(event){modal.params.init&&!modal.params.isolate&&angular.extend(event.targetScope,modal.params.init,!0),"string"==typeof modal.params.controller&&$controller(modal.params.controller,{$scope:event.targetScope,$init:modal.params.init,$ocModalParams:modal.params}),off()});if(modal.params.template)modal.$scope.modalTemplate=modal.params.template;else{if(!modal.params.url)throw"You need to define a template or an url";modal.$scope.modalUrl=modal.params.url}"function"==typeof callback&&modal.$scope.callbacksList.push(callback)},closeOnEsc:function(id){return modals[id||openedModals[openedModals.length-1]].params.closeOnEsc!==!1?self.close(id):void 0},close:function(id){var args,deferred=$q.defer();args="string"==typeof id&&-1!==openedModals.indexOf(id)?Array.prototype.slice.call(arguments,1):arguments,("undefined"==typeof id||-1===openedModals.indexOf(id))&&(id=openedModals[openedModals.length-1]);var modal=modals[id||openedModals[openedModals.length-1]];if(modal&&modal.$scope.modalShow===!0){var animDuration=getAnimDuration(angular.element(modal.$element[0].querySelector(".modal-content")));$timeout(function(){modal.$scope.modalShow=!1,$timeout(function(){if(modal.$scope.$destroy(),modal.$element.remove(),modal.callbacksList=[],openedModals.splice(openedModals.indexOf(id||openedModals[openedModals.length-1]),1),0===openedModals.length)self.waitingForOpen||(document.body.style.overflow=baseOverflow,$modalWrapper.css("display","none"));else{var topModal=modals[openedModals[openedModals.length-1]];topModal.$element.css("z-index",topModal.baseZIndex),topModal.$element.removeClass("no-backdrop")}"function"==typeof modal.params.onClose&&modal.params.onClose.apply(void 0,args),deferred.resolve()},animDuration)})}else deferred.resolve();return deferred.promise}};return self}]),ocModal.directive("ocModal",["$ocModal","$compile","$timeout",function($ocModal,$compile){return{restrict:"AE",replace:!0,scope:!0,template:'<div class="modal-dialog"><div class="modal-backdrop"></div><div class="modal-content {{customClass}}" ng-class="{opened: modalShow}" ng-if="modalTemplate"></div><div class="modal-content {{customClass}}" ng-class="{opened: modalShow}" ng-include="modalUrl"></div></div>',link:function($scope,$element,$attrs){var $templateWrapper,id=$attrs.ocModal;$scope.closeModal=function(){var args=Array.prototype.slice.call(arguments);args.unshift(id),$ocModal.close.apply(void 0,args)},$ocModal.register({id:id,$scope:$scope,$element:$element}),$element.on("$destroy",function(){$ocModal.remove(id)}),$scope.$watch("modalTemplate",function(newVal){"undefined"!=typeof newVal&&($templateWrapper||($templateWrapper=angular.element($element.children()[1])),$templateWrapper.append($compile(newVal)($scope)),$scope.$emit("$includeContentLoaded"))})}}}]),ocModal.directive("ocModalOpen",["$ocModal",function($ocModal){return{restrict:"A",require:"?modal",link:function($scope,$element,$attrs){$element.on("click touchstart",function(e){e.preventDefault(),e.stopPropagation();var newScope=$scope.$new(),params=newScope.$eval($attrs.ocModalOpen);if(params){if("number"==typeof params?params={url:$attrs.ocModalOpen}:"string"==typeof params&&(params={url:params}),!params.url)throw"You need to set the modal url";$scope.$apply(function(){$ocModal.open(params)})}})}}}]),ocModal.directive("ocModalClose",["$ocModal",function($ocModal){return{restrict:"A",require:"?modal",link:function($scope,$element,$attrs){$element.on("click touchstart",function(e){e.preventDefault(),e.stopPropagation(),$scope.$apply(function(){if($attrs.ocModalClose)var params=$scope.$new().$eval($attrs.ocModalClose);$ocModal.close(params)})})}}}])}(),function(e,t,n){function x(e){f.cssText=e}function N(e,t){return typeof e===t}function C(e,t){return!!~(""+e).indexOf(t)}function k(e,t){for(var r in e){var i=e[r];if(!C(i,"-")&&f[i]!==n)return"pfx"==t?i:!0}return!1}function L(e,t,r){for(var i in e){var s=t[e[i]];if(s!==n)return r===!1?e[i]:N(s,"function")?s.bind(r||t):s}return!1}function A(e,t,n){var r=e.charAt(0).toUpperCase()+e.slice(1),i=(e+" "+p.join(r+" ")+r).split(" ");return N(t,"string")||N(t,"undefined")?k(i,t):(i=(e+" "+d.join(r+" ")+r).split(" "),L(i,t,n))}var l,w,S,r="2.8.2",i={},s=!0,o=t.documentElement,u="modernizr",a=t.createElement(u),f=a.style,h=({}.toString,"Webkit Moz O ms"),p=h.split(" "),d=h.toLowerCase().split(" "),v={},y=[],b=y.slice,E={}.hasOwnProperty;S=N(E,"undefined")||N(E.call,"undefined")?function(e,t){return t in e&&N(e.constructor.prototype[t],"undefined")}:function(e,t){return E.call(e,t)},Function.prototype.bind||(Function.prototype.bind=function(t){var n=this;if("function"!=typeof n)throw new TypeError;var r=b.call(arguments,1),i=function(){if(this instanceof i){var e=function(){};e.prototype=n.prototype;var s=new e,o=n.apply(s,r.concat(b.call(arguments)));return Object(o)===o?o:s}return n.apply(t,r.concat(b.call(arguments)))};return i}),v.flexbox=function(){return A("flexWrap")},v.csstransforms=function(){return!!A("transform")};for(var O in v)S(v,O)&&(w=O.toLowerCase(),i[w]=v[O](),y.push((i[w]?"":"no-")+w));return i.addTest=function(e,t){if("object"==typeof e)for(var r in e)S(e,r)&&i.addTest(r,e[r]);else{if(e=e.toLowerCase(),i[e]!==n)return i;t="function"==typeof t?t():t,"undefined"!=typeof s&&s&&(o.className+=" "+(t?"":"no-")+e),i[e]=t}return i},x(""),a=l=null,function(e,t){function c(e,t){var n=e.createElement("p"),r=e.getElementsByTagName("head")[0]||e.documentElement;return n.innerHTML="x<style>"+t+"</style>",r.insertBefore(n.lastChild,r.firstChild)}function h(){var e=y.elements;return"string"==typeof e?e.split(" "):e}function p(e){var t=f[e[u]];return t||(t={},a++,e[u]=a,f[a]=t),t}function d(e,n,r){if(n||(n=t),l)return n.createElement(e);r||(r=p(n));var o;return o=r.cache[e]?r.cache[e].cloneNode():s.test(e)?(r.cache[e]=r.createElem(e)).cloneNode():r.createElem(e),!o.canHaveChildren||i.test(e)||o.tagUrn?o:r.frag.appendChild(o)}function v(e,n){if(e||(e=t),l)return e.createDocumentFragment();n=n||p(e);for(var r=n.frag.cloneNode(),i=0,s=h(),o=s.length;o>i;i++)r.createElement(s[i]);return r}function m(e,t){t.cache||(t.cache={},t.createElem=e.createElement,t.createFrag=e.createDocumentFragment,t.frag=t.createFrag()),e.createElement=function(n){return y.shivMethods?d(n,e,t):t.createElem(n)},e.createDocumentFragment=Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+h().join().replace(/[\w\-]+/g,function(e){return t.createElem(e),t.frag.createElement(e),'c("'+e+'")'})+");return n}")(y,t.frag)}function g(e){e||(e=t);var n=p(e);return!y.shivCSS||o||n.hasCSS||(n.hasCSS=!!c(e,"article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")),l||m(e,n),e}var o,l,n="3.7.0",r=e.html5||{},i=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,s=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,u="_html5shiv",a=0,f={};!function(){try{var e=t.createElement("a");e.innerHTML="<xyz></xyz>",o="hidden"in e,l=1==e.childNodes.length||function(){t.createElement("a");var e=t.createDocumentFragment();return"undefined"==typeof e.cloneNode||"undefined"==typeof e.createDocumentFragment||"undefined"==typeof e.createElement}()}catch(n){o=!0,l=!0}}();var y={elements:r.elements||"abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output progress section summary template time video",version:n,shivCSS:r.shivCSS!==!1,supportsUnknownElements:l,shivMethods:r.shivMethods!==!1,type:"default",shivDocument:g,createElement:d,createDocumentFragment:v};e.html5=y,g(t)}(this,t),i._version=r,i._domPrefixes=d,i._cssomPrefixes=p,i.testProp=function(e){return k([e])},i.testAllProps=A,o.className=o.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(s?" js "+y.join(" "):""),i}(this,this.document),function(undefined){function dfl(a,b,c){switch(arguments.length){case 2:return null!=a?a:b;case 3:return null!=a?a:null!=b?b:c;default:throw new Error("Implement me")}}function hasOwnProp(a,b){return hasOwnProperty.call(a,b)}function defaultParsingFlags(){return{empty:!1,unusedTokens:[],unusedInput:[],overflow:-2,charsLeftOver:0,nullInput:!1,invalidMonth:null,invalidFormat:!1,userInvalidated:!1,iso:!1}}function printMsg(msg){moment.suppressDeprecationWarnings===!1&&"undefined"!=typeof console&&console.warn}function deprecate(msg,fn){var firstTime=!0;return extend(function(){return firstTime&&(printMsg(msg),firstTime=!1),fn.apply(this,arguments)},fn)}function deprecateSimple(name,msg){deprecations[name]||(printMsg(msg),deprecations[name]=!0)}function padToken(func,count){return function(a){return leftZeroFill(func.call(this,a),count)}}function ordinalizeToken(func,period){return function(a){return this.localeData().ordinal(func.call(this,a),period)}}function Locale(){}function Moment(config,skipOverflow){skipOverflow!==!1&&checkOverflow(config),copyConfig(this,config),this._d=new Date(+config._d)}function Duration(duration){var normalizedInput=normalizeObjectUnits(duration),years=normalizedInput.year||0,quarters=normalizedInput.quarter||0,months=normalizedInput.month||0,weeks=normalizedInput.week||0,days=normalizedInput.day||0,hours=normalizedInput.hour||0,minutes=normalizedInput.minute||0,seconds=normalizedInput.second||0,milliseconds=normalizedInput.millisecond||0;this._milliseconds=+milliseconds+1e3*seconds+6e4*minutes+36e5*hours,this._days=+days+7*weeks,this._months=+months+3*quarters+12*years,this._data={},this._locale=moment.localeData(),this._bubble()}function extend(a,b){for(var i in b)hasOwnProp(b,i)&&(a[i]=b[i]);return hasOwnProp(b,"toString")&&(a.toString=b.toString),hasOwnProp(b,"valueOf")&&(a.valueOf=b.valueOf),a}function copyConfig(to,from){var i,prop,val;if("undefined"!=typeof from._isAMomentObject&&(to._isAMomentObject=from._isAMomentObject),"undefined"!=typeof from._i&&(to._i=from._i),"undefined"!=typeof from._f&&(to._f=from._f),"undefined"!=typeof from._l&&(to._l=from._l),"undefined"!=typeof from._strict&&(to._strict=from._strict),"undefined"!=typeof from._tzm&&(to._tzm=from._tzm),"undefined"!=typeof from._isUTC&&(to._isUTC=from._isUTC),"undefined"!=typeof from._offset&&(to._offset=from._offset),"undefined"!=typeof from._pf&&(to._pf=from._pf),"undefined"!=typeof from._locale&&(to._locale=from._locale),momentProperties.length>0)for(i in momentProperties)prop=momentProperties[i],val=from[prop],"undefined"!=typeof val&&(to[prop]=val);return to}function absRound(number){return 0>number?Math.ceil(number):Math.floor(number)}function leftZeroFill(number,targetLength,forceSign){for(var output=""+Math.abs(number),sign=number>=0;output.length<targetLength;)output="0"+output;return(sign?forceSign?"+":"":"-")+output}function positiveMomentsDifference(base,other){var res={milliseconds:0,months:0};return res.months=other.month()-base.month()+12*(other.year()-base.year()),base.clone().add(res.months,"M").isAfter(other)&&--res.months,res.milliseconds=+other-+base.clone().add(res.months,"M"),res}function momentsDifference(base,other){var res;return other=makeAs(other,base),base.isBefore(other)?res=positiveMomentsDifference(base,other):(res=positiveMomentsDifference(other,base),res.milliseconds=-res.milliseconds,res.months=-res.months),res}function createAdder(direction,name){return function(val,period){var dur,tmp;return null===period||isNaN(+period)||(deprecateSimple(name,"moment()."+name+"(period, number) is deprecated. Please use moment()."+name+"(number, period)."),tmp=val,val=period,period=tmp),val="string"==typeof val?+val:val,dur=moment.duration(val,period),addOrSubtractDurationFromMoment(this,dur,direction),this}}function addOrSubtractDurationFromMoment(mom,duration,isAdding,updateOffset){var milliseconds=duration._milliseconds,days=duration._days,months=duration._months;updateOffset=null==updateOffset?!0:updateOffset,milliseconds&&mom._d.setTime(+mom._d+milliseconds*isAdding),days&&rawSetter(mom,"Date",rawGetter(mom,"Date")+days*isAdding),months&&rawMonthSetter(mom,rawGetter(mom,"Month")+months*isAdding),updateOffset&&moment.updateOffset(mom,days||months)}function isArray(input){return"[object Array]"===Object.prototype.toString.call(input)}function isDate(input){return"[object Date]"===Object.prototype.toString.call(input)||input instanceof Date}function compareArrays(array1,array2,dontConvert){var i,len=Math.min(array1.length,array2.length),lengthDiff=Math.abs(array1.length-array2.length),diffs=0;for(i=0;len>i;i++)(dontConvert&&array1[i]!==array2[i]||!dontConvert&&toInt(array1[i])!==toInt(array2[i]))&&diffs++;return diffs+lengthDiff}function normalizeUnits(units){if(units){var lowered=units.toLowerCase().replace(/(.)s$/,"$1");units=unitAliases[units]||camelFunctions[lowered]||lowered}return units}function normalizeObjectUnits(inputObject){var normalizedProp,prop,normalizedInput={};for(prop in inputObject)hasOwnProp(inputObject,prop)&&(normalizedProp=normalizeUnits(prop),normalizedProp&&(normalizedInput[normalizedProp]=inputObject[prop]));return normalizedInput}function makeList(field){var count,setter;if(0===field.indexOf("week"))count=7,setter="day";else{if(0!==field.indexOf("month"))return;count=12,setter="month"}moment[field]=function(format,index){var i,getter,method=moment._locale[field],results=[];if("number"==typeof format&&(index=format,format=undefined),getter=function(i){var m=moment().utc().set(setter,i);return method.call(moment._locale,m,format||"")},null!=index)return getter(index);for(i=0;count>i;i++)results.push(getter(i));return results}}function toInt(argumentForCoercion){var coercedNumber=+argumentForCoercion,value=0;return 0!==coercedNumber&&isFinite(coercedNumber)&&(value=coercedNumber>=0?Math.floor(coercedNumber):Math.ceil(coercedNumber)),value}function daysInMonth(year,month){return new Date(Date.UTC(year,month+1,0)).getUTCDate()}function weeksInYear(year,dow,doy){return weekOfYear(moment([year,11,31+dow-doy]),dow,doy).week}function daysInYear(year){return isLeapYear(year)?366:365}function isLeapYear(year){return year%4===0&&year%100!==0||year%400===0}function checkOverflow(m){var overflow;m._a&&-2===m._pf.overflow&&(overflow=m._a[MONTH]<0||m._a[MONTH]>11?MONTH:m._a[DATE]<1||m._a[DATE]>daysInMonth(m._a[YEAR],m._a[MONTH])?DATE:m._a[HOUR]<0||m._a[HOUR]>23?HOUR:m._a[MINUTE]<0||m._a[MINUTE]>59?MINUTE:m._a[SECOND]<0||m._a[SECOND]>59?SECOND:m._a[MILLISECOND]<0||m._a[MILLISECOND]>999?MILLISECOND:-1,m._pf._overflowDayOfYear&&(YEAR>overflow||overflow>DATE)&&(overflow=DATE),m._pf.overflow=overflow)}function isValid(m){return null==m._isValid&&(m._isValid=!isNaN(m._d.getTime())&&m._pf.overflow<0&&!m._pf.empty&&!m._pf.invalidMonth&&!m._pf.nullInput&&!m._pf.invalidFormat&&!m._pf.userInvalidated,m._strict&&(m._isValid=m._isValid&&0===m._pf.charsLeftOver&&0===m._pf.unusedTokens.length)),m._isValid}function normalizeLocale(key){return key?key.toLowerCase().replace("_","-"):key}function chooseLocale(names){for(var j,next,locale,split,i=0;i<names.length;){for(split=normalizeLocale(names[i]).split("-"),j=split.length,next=normalizeLocale(names[i+1]),next=next?next.split("-"):null;j>0;){if(locale=loadLocale(split.slice(0,j).join("-")))return locale;if(next&&next.length>=j&&compareArrays(split,next,!0)>=j-1)break;j--}i++}return null}function loadLocale(name){var oldLocale=null;if(!locales[name]&&hasModule)try{oldLocale=moment.locale(),require("./locale/"+name),moment.locale(oldLocale)}catch(e){}return locales[name]}function makeAs(input,model){return model._isUTC?moment(input).zone(model._offset||0):moment(input).local()}function removeFormattingTokens(input){return input.match(/\[[\s\S]/)?input.replace(/^\[|\]$/g,""):input.replace(/\\/g,"")}function makeFormatFunction(format){var i,length,array=format.match(formattingTokens);for(i=0,length=array.length;length>i;i++)array[i]=formatTokenFunctions[array[i]]?formatTokenFunctions[array[i]]:removeFormattingTokens(array[i]);return function(mom){var output="";for(i=0;length>i;i++)output+=array[i]instanceof Function?array[i].call(mom,format):array[i];return output}}function formatMoment(m,format){return m.isValid()?(format=expandFormat(format,m.localeData()),formatFunctions[format]||(formatFunctions[format]=makeFormatFunction(format)),formatFunctions[format](m)):m.localeData().invalidDate()}function expandFormat(format,locale){function replaceLongDateFormatTokens(input){return locale.longDateFormat(input)||input}var i=5;for(localFormattingTokens.lastIndex=0;i>=0&&localFormattingTokens.test(format);)format=format.replace(localFormattingTokens,replaceLongDateFormatTokens),localFormattingTokens.lastIndex=0,i-=1;return format}function getParseRegexForToken(token,config){var a,strict=config._strict;switch(token){case"Q":return parseTokenOneDigit;case"DDDD":return parseTokenThreeDigits;case"YYYY":case"GGGG":case"gggg":return strict?parseTokenFourDigits:parseTokenOneToFourDigits;
case"Y":case"G":case"g":return parseTokenSignedNumber;case"YYYYYY":case"YYYYY":case"GGGGG":case"ggggg":return strict?parseTokenSixDigits:parseTokenOneToSixDigits;case"S":if(strict)return parseTokenOneDigit;case"SS":if(strict)return parseTokenTwoDigits;case"SSS":if(strict)return parseTokenThreeDigits;case"DDD":return parseTokenOneToThreeDigits;case"MMM":case"MMMM":case"dd":case"ddd":case"dddd":return parseTokenWord;case"a":case"A":return config._locale._meridiemParse;case"X":return parseTokenTimestampMs;case"Z":case"ZZ":return parseTokenTimezone;case"T":return parseTokenT;case"SSSS":return parseTokenDigits;case"MM":case"DD":case"YY":case"GG":case"gg":case"HH":case"hh":case"mm":case"ss":case"ww":case"WW":return strict?parseTokenTwoDigits:parseTokenOneOrTwoDigits;case"M":case"D":case"d":case"H":case"h":case"m":case"s":case"w":case"W":case"e":case"E":return parseTokenOneOrTwoDigits;case"Do":return parseTokenOrdinal;default:return a=new RegExp(regexpEscape(unescapeFormat(token.replace("\\","")),"i"))}}function timezoneMinutesFromString(string){string=string||"";var possibleTzMatches=string.match(parseTokenTimezone)||[],tzChunk=possibleTzMatches[possibleTzMatches.length-1]||[],parts=(tzChunk+"").match(parseTimezoneChunker)||["-",0,0],minutes=+(60*parts[1])+toInt(parts[2]);return"+"===parts[0]?-minutes:minutes}function addTimeToArrayFromToken(token,input,config){var a,datePartArray=config._a;switch(token){case"Q":null!=input&&(datePartArray[MONTH]=3*(toInt(input)-1));break;case"M":case"MM":null!=input&&(datePartArray[MONTH]=toInt(input)-1);break;case"MMM":case"MMMM":a=config._locale.monthsParse(input),null!=a?datePartArray[MONTH]=a:config._pf.invalidMonth=input;break;case"D":case"DD":null!=input&&(datePartArray[DATE]=toInt(input));break;case"Do":null!=input&&(datePartArray[DATE]=toInt(parseInt(input,10)));break;case"DDD":case"DDDD":null!=input&&(config._dayOfYear=toInt(input));break;case"YY":datePartArray[YEAR]=moment.parseTwoDigitYear(input);break;case"YYYY":case"YYYYY":case"YYYYYY":datePartArray[YEAR]=toInt(input);break;case"a":case"A":config._isPm=config._locale.isPM(input);break;case"H":case"HH":case"h":case"hh":datePartArray[HOUR]=toInt(input);break;case"m":case"mm":datePartArray[MINUTE]=toInt(input);break;case"s":case"ss":datePartArray[SECOND]=toInt(input);break;case"S":case"SS":case"SSS":case"SSSS":datePartArray[MILLISECOND]=toInt(1e3*("0."+input));break;case"X":config._d=new Date(1e3*parseFloat(input));break;case"Z":case"ZZ":config._useUTC=!0,config._tzm=timezoneMinutesFromString(input);break;case"dd":case"ddd":case"dddd":a=config._locale.weekdaysParse(input),null!=a?(config._w=config._w||{},config._w.d=a):config._pf.invalidWeekday=input;break;case"w":case"ww":case"W":case"WW":case"d":case"e":case"E":token=token.substr(0,1);case"gggg":case"GGGG":case"GGGGG":token=token.substr(0,2),input&&(config._w=config._w||{},config._w[token]=toInt(input));break;case"gg":case"GG":config._w=config._w||{},config._w[token]=moment.parseTwoDigitYear(input)}}function dayOfYearFromWeekInfo(config){var w,weekYear,week,weekday,dow,doy,temp;w=config._w,null!=w.GG||null!=w.W||null!=w.E?(dow=1,doy=4,weekYear=dfl(w.GG,config._a[YEAR],weekOfYear(moment(),1,4).year),week=dfl(w.W,1),weekday=dfl(w.E,1)):(dow=config._locale._week.dow,doy=config._locale._week.doy,weekYear=dfl(w.gg,config._a[YEAR],weekOfYear(moment(),dow,doy).year),week=dfl(w.w,1),null!=w.d?(weekday=w.d,dow>weekday&&++week):weekday=null!=w.e?w.e+dow:dow),temp=dayOfYearFromWeeks(weekYear,week,weekday,doy,dow),config._a[YEAR]=temp.year,config._dayOfYear=temp.dayOfYear}function dateFromConfig(config){var i,date,currentDate,yearToUse,input=[];if(!config._d){for(currentDate=currentDateArray(config),config._w&&null==config._a[DATE]&&null==config._a[MONTH]&&dayOfYearFromWeekInfo(config),config._dayOfYear&&(yearToUse=dfl(config._a[YEAR],currentDate[YEAR]),config._dayOfYear>daysInYear(yearToUse)&&(config._pf._overflowDayOfYear=!0),date=makeUTCDate(yearToUse,0,config._dayOfYear),config._a[MONTH]=date.getUTCMonth(),config._a[DATE]=date.getUTCDate()),i=0;3>i&&null==config._a[i];++i)config._a[i]=input[i]=currentDate[i];for(;7>i;i++)config._a[i]=input[i]=null==config._a[i]?2===i?1:0:config._a[i];config._d=(config._useUTC?makeUTCDate:makeDate).apply(null,input),null!=config._tzm&&config._d.setUTCMinutes(config._d.getUTCMinutes()+config._tzm)}}function dateFromObject(config){var normalizedInput;config._d||(normalizedInput=normalizeObjectUnits(config._i),config._a=[normalizedInput.year,normalizedInput.month,normalizedInput.day,normalizedInput.hour,normalizedInput.minute,normalizedInput.second,normalizedInput.millisecond],dateFromConfig(config))}function currentDateArray(config){var now=new Date;return config._useUTC?[now.getUTCFullYear(),now.getUTCMonth(),now.getUTCDate()]:[now.getFullYear(),now.getMonth(),now.getDate()]}function makeDateFromStringAndFormat(config){if(config._f===moment.ISO_8601)return void parseISO(config);config._a=[],config._pf.empty=!0;var i,parsedInput,tokens,token,skipped,string=""+config._i,stringLength=string.length,totalParsedInputLength=0;for(tokens=expandFormat(config._f,config._locale).match(formattingTokens)||[],i=0;i<tokens.length;i++)token=tokens[i],parsedInput=(string.match(getParseRegexForToken(token,config))||[])[0],parsedInput&&(skipped=string.substr(0,string.indexOf(parsedInput)),skipped.length>0&&config._pf.unusedInput.push(skipped),string=string.slice(string.indexOf(parsedInput)+parsedInput.length),totalParsedInputLength+=parsedInput.length),formatTokenFunctions[token]?(parsedInput?config._pf.empty=!1:config._pf.unusedTokens.push(token),addTimeToArrayFromToken(token,parsedInput,config)):config._strict&&!parsedInput&&config._pf.unusedTokens.push(token);config._pf.charsLeftOver=stringLength-totalParsedInputLength,string.length>0&&config._pf.unusedInput.push(string),config._isPm&&config._a[HOUR]<12&&(config._a[HOUR]+=12),config._isPm===!1&&12===config._a[HOUR]&&(config._a[HOUR]=0),dateFromConfig(config),checkOverflow(config)}function unescapeFormat(s){return s.replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g,function(matched,p1,p2,p3,p4){return p1||p2||p3||p4})}function regexpEscape(s){return s.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}function makeDateFromStringAndArray(config){var tempConfig,bestMoment,scoreToBeat,i,currentScore;if(0===config._f.length)return config._pf.invalidFormat=!0,void(config._d=new Date(0/0));for(i=0;i<config._f.length;i++)currentScore=0,tempConfig=copyConfig({},config),null!=config._useUTC&&(tempConfig._useUTC=config._useUTC),tempConfig._pf=defaultParsingFlags(),tempConfig._f=config._f[i],makeDateFromStringAndFormat(tempConfig),isValid(tempConfig)&&(currentScore+=tempConfig._pf.charsLeftOver,currentScore+=10*tempConfig._pf.unusedTokens.length,tempConfig._pf.score=currentScore,(null==scoreToBeat||scoreToBeat>currentScore)&&(scoreToBeat=currentScore,bestMoment=tempConfig));extend(config,bestMoment||tempConfig)}function parseISO(config){var i,l,string=config._i,match=isoRegex.exec(string);if(match){for(config._pf.iso=!0,i=0,l=isoDates.length;l>i;i++)if(isoDates[i][1].exec(string)){config._f=isoDates[i][0]+(match[6]||" ");break}for(i=0,l=isoTimes.length;l>i;i++)if(isoTimes[i][1].exec(string)){config._f+=isoTimes[i][0];break}string.match(parseTokenTimezone)&&(config._f+="Z"),makeDateFromStringAndFormat(config)}else config._isValid=!1}function makeDateFromString(config){parseISO(config),config._isValid===!1&&(delete config._isValid,moment.createFromInputFallback(config))}function map(arr,fn){var i,res=[];for(i=0;i<arr.length;++i)res.push(fn(arr[i],i));return res}function makeDateFromInput(config){var matched,input=config._i;input===undefined?config._d=new Date:isDate(input)?config._d=new Date(+input):null!==(matched=aspNetJsonRegex.exec(input))?config._d=new Date(+matched[1]):"string"==typeof input?makeDateFromString(config):isArray(input)?(config._a=map(input.slice(0),function(obj){return parseInt(obj,10)}),dateFromConfig(config)):"object"==typeof input?dateFromObject(config):"number"==typeof input?config._d=new Date(input):moment.createFromInputFallback(config)}function makeDate(y,m,d,h,M,s,ms){var date=new Date(y,m,d,h,M,s,ms);return 1970>y&&date.setFullYear(y),date}function makeUTCDate(y){var date=new Date(Date.UTC.apply(null,arguments));return 1970>y&&date.setUTCFullYear(y),date}function parseWeekday(input,locale){if("string"==typeof input)if(isNaN(input)){if(input=locale.weekdaysParse(input),"number"!=typeof input)return null}else input=parseInt(input,10);return input}function substituteTimeAgo(string,number,withoutSuffix,isFuture,locale){return locale.relativeTime(number||1,!!withoutSuffix,string,isFuture)}function relativeTime(posNegDuration,withoutSuffix,locale){var duration=moment.duration(posNegDuration).abs(),seconds=round(duration.as("s")),minutes=round(duration.as("m")),hours=round(duration.as("h")),days=round(duration.as("d")),months=round(duration.as("M")),years=round(duration.as("y")),args=seconds<relativeTimeThresholds.s&&["s",seconds]||1===minutes&&["m"]||minutes<relativeTimeThresholds.m&&["mm",minutes]||1===hours&&["h"]||hours<relativeTimeThresholds.h&&["hh",hours]||1===days&&["d"]||days<relativeTimeThresholds.d&&["dd",days]||1===months&&["M"]||months<relativeTimeThresholds.M&&["MM",months]||1===years&&["y"]||["yy",years];return args[2]=withoutSuffix,args[3]=+posNegDuration>0,args[4]=locale,substituteTimeAgo.apply({},args)}function weekOfYear(mom,firstDayOfWeek,firstDayOfWeekOfYear){var adjustedMoment,end=firstDayOfWeekOfYear-firstDayOfWeek,daysToDayOfWeek=firstDayOfWeekOfYear-mom.day();return daysToDayOfWeek>end&&(daysToDayOfWeek-=7),end-7>daysToDayOfWeek&&(daysToDayOfWeek+=7),adjustedMoment=moment(mom).add(daysToDayOfWeek,"d"),{week:Math.ceil(adjustedMoment.dayOfYear()/7),year:adjustedMoment.year()}}function dayOfYearFromWeeks(year,week,weekday,firstDayOfWeekOfYear,firstDayOfWeek){var daysToAdd,dayOfYear,d=makeUTCDate(year,0,1).getUTCDay();return d=0===d?7:d,weekday=null!=weekday?weekday:firstDayOfWeek,daysToAdd=firstDayOfWeek-d+(d>firstDayOfWeekOfYear?7:0)-(firstDayOfWeek>d?7:0),dayOfYear=7*(week-1)+(weekday-firstDayOfWeek)+daysToAdd+1,{year:dayOfYear>0?year:year-1,dayOfYear:dayOfYear>0?dayOfYear:daysInYear(year-1)+dayOfYear}}function makeMoment(config){var input=config._i,format=config._f;return config._locale=config._locale||moment.localeData(config._l),null===input||format===undefined&&""===input?moment.invalid({nullInput:!0}):("string"==typeof input&&(config._i=input=config._locale.preparse(input)),moment.isMoment(input)?new Moment(input,!0):(format?isArray(format)?makeDateFromStringAndArray(config):makeDateFromStringAndFormat(config):makeDateFromInput(config),new Moment(config)))}function pickBy(fn,moments){var res,i;if(1===moments.length&&isArray(moments[0])&&(moments=moments[0]),!moments.length)return moment();for(res=moments[0],i=1;i<moments.length;++i)moments[i][fn](res)&&(res=moments[i]);return res}function rawMonthSetter(mom,value){var dayOfMonth;return"string"==typeof value&&(value=mom.localeData().monthsParse(value),"number"!=typeof value)?mom:(dayOfMonth=Math.min(mom.date(),daysInMonth(mom.year(),value)),mom._d["set"+(mom._isUTC?"UTC":"")+"Month"](value,dayOfMonth),mom)}function rawGetter(mom,unit){return mom._d["get"+(mom._isUTC?"UTC":"")+unit]()}function rawSetter(mom,unit,value){return"Month"===unit?rawMonthSetter(mom,value):mom._d["set"+(mom._isUTC?"UTC":"")+unit](value)}function makeAccessor(unit,keepTime){return function(value){return null!=value?(rawSetter(this,unit,value),moment.updateOffset(this,keepTime),this):rawGetter(this,unit)}}function daysToYears(days){return 400*days/146097}function yearsToDays(years){return 146097*years/400}function makeDurationGetter(name){moment.duration.fn[name]=function(){return this._data[name]}}function makeGlobal(shouldDeprecate){"undefined"==typeof ender&&(oldGlobalMoment=globalScope.moment,globalScope.moment=shouldDeprecate?deprecate("Accessing Moment through the global scope is deprecated, and will be removed in an upcoming release.",moment):moment)}for(var moment,oldGlobalMoment,i,VERSION="2.8.3",globalScope="undefined"!=typeof global?global:this,round=Math.round,hasOwnProperty=Object.prototype.hasOwnProperty,YEAR=0,MONTH=1,DATE=2,HOUR=3,MINUTE=4,SECOND=5,MILLISECOND=6,locales={},momentProperties=[],hasModule="undefined"!=typeof module&&module.exports,aspNetJsonRegex=/^\/?Date\((\-?\d+)/i,aspNetTimeSpanJsonRegex=/(\-)?(?:(\d*)\.)?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/,isoDurationRegex=/^(-)?P(?:(?:([0-9,.]*)Y)?(?:([0-9,.]*)M)?(?:([0-9,.]*)D)?(?:T(?:([0-9,.]*)H)?(?:([0-9,.]*)M)?(?:([0-9,.]*)S)?)?|([0-9,.]*)W)$/,formattingTokens=/(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Q|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,4}|X|zz?|ZZ?|.)/g,localFormattingTokens=/(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g,parseTokenOneOrTwoDigits=/\d\d?/,parseTokenOneToThreeDigits=/\d{1,3}/,parseTokenOneToFourDigits=/\d{1,4}/,parseTokenOneToSixDigits=/[+\-]?\d{1,6}/,parseTokenDigits=/\d+/,parseTokenWord=/[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,parseTokenTimezone=/Z|[\+\-]\d\d:?\d\d/gi,parseTokenT=/T/i,parseTokenTimestampMs=/[\+\-]?\d+(\.\d{1,3})?/,parseTokenOrdinal=/\d{1,2}/,parseTokenOneDigit=/\d/,parseTokenTwoDigits=/\d\d/,parseTokenThreeDigits=/\d{3}/,parseTokenFourDigits=/\d{4}/,parseTokenSixDigits=/[+-]?\d{6}/,parseTokenSignedNumber=/[+-]?\d+/,isoRegex=/^\s*(?:[+-]\d{6}|\d{4})-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,isoFormat="YYYY-MM-DDTHH:mm:ssZ",isoDates=[["YYYYYY-MM-DD",/[+-]\d{6}-\d{2}-\d{2}/],["YYYY-MM-DD",/\d{4}-\d{2}-\d{2}/],["GGGG-[W]WW-E",/\d{4}-W\d{2}-\d/],["GGGG-[W]WW",/\d{4}-W\d{2}/],["YYYY-DDD",/\d{4}-\d{3}/]],isoTimes=[["HH:mm:ss.SSSS",/(T| )\d\d:\d\d:\d\d\.\d+/],["HH:mm:ss",/(T| )\d\d:\d\d:\d\d/],["HH:mm",/(T| )\d\d:\d\d/],["HH",/(T| )\d\d/]],parseTimezoneChunker=/([\+\-]|\d\d)/gi,unitMillisecondFactors=("Date|Hours|Minutes|Seconds|Milliseconds".split("|"),{Milliseconds:1,Seconds:1e3,Minutes:6e4,Hours:36e5,Days:864e5,Months:2592e6,Years:31536e6}),unitAliases={ms:"millisecond",s:"second",m:"minute",h:"hour",d:"day",D:"date",w:"week",W:"isoWeek",M:"month",Q:"quarter",y:"year",DDD:"dayOfYear",e:"weekday",E:"isoWeekday",gg:"weekYear",GG:"isoWeekYear"},camelFunctions={dayofyear:"dayOfYear",isoweekday:"isoWeekday",isoweek:"isoWeek",weekyear:"weekYear",isoweekyear:"isoWeekYear"},formatFunctions={},relativeTimeThresholds={s:45,m:45,h:22,d:26,M:11},ordinalizeTokens="DDD w W M D d".split(" "),paddedTokens="M D H h m s w W".split(" "),formatTokenFunctions={M:function(){return this.month()+1},MMM:function(format){return this.localeData().monthsShort(this,format)},MMMM:function(format){return this.localeData().months(this,format)},D:function(){return this.date()},DDD:function(){return this.dayOfYear()},d:function(){return this.day()},dd:function(format){return this.localeData().weekdaysMin(this,format)},ddd:function(format){return this.localeData().weekdaysShort(this,format)},dddd:function(format){return this.localeData().weekdays(this,format)},w:function(){return this.week()},W:function(){return this.isoWeek()},YY:function(){return leftZeroFill(this.year()%100,2)},YYYY:function(){return leftZeroFill(this.year(),4)},YYYYY:function(){return leftZeroFill(this.year(),5)},YYYYYY:function(){var y=this.year(),sign=y>=0?"+":"-";return sign+leftZeroFill(Math.abs(y),6)},gg:function(){return leftZeroFill(this.weekYear()%100,2)},gggg:function(){return leftZeroFill(this.weekYear(),4)},ggggg:function(){return leftZeroFill(this.weekYear(),5)},GG:function(){return leftZeroFill(this.isoWeekYear()%100,2)},GGGG:function(){return leftZeroFill(this.isoWeekYear(),4)},GGGGG:function(){return leftZeroFill(this.isoWeekYear(),5)},e:function(){return this.weekday()},E:function(){return this.isoWeekday()},a:function(){return this.localeData().meridiem(this.hours(),this.minutes(),!0)},A:function(){return this.localeData().meridiem(this.hours(),this.minutes(),!1)},H:function(){return this.hours()},h:function(){return this.hours()%12||12},m:function(){return this.minutes()},s:function(){return this.seconds()},S:function(){return toInt(this.milliseconds()/100)},SS:function(){return leftZeroFill(toInt(this.milliseconds()/10),2)},SSS:function(){return leftZeroFill(this.milliseconds(),3)},SSSS:function(){return leftZeroFill(this.milliseconds(),3)},Z:function(){var a=-this.zone(),b="+";return 0>a&&(a=-a,b="-"),b+leftZeroFill(toInt(a/60),2)+":"+leftZeroFill(toInt(a)%60,2)},ZZ:function(){var a=-this.zone(),b="+";return 0>a&&(a=-a,b="-"),b+leftZeroFill(toInt(a/60),2)+leftZeroFill(toInt(a)%60,2)},z:function(){return this.zoneAbbr()},zz:function(){return this.zoneName()},X:function(){return this.unix()},Q:function(){return this.quarter()}},deprecations={},lists=["months","monthsShort","weekdays","weekdaysShort","weekdaysMin"];ordinalizeTokens.length;)i=ordinalizeTokens.pop(),formatTokenFunctions[i+"o"]=ordinalizeToken(formatTokenFunctions[i],i);for(;paddedTokens.length;)i=paddedTokens.pop(),formatTokenFunctions[i+i]=padToken(formatTokenFunctions[i],2);formatTokenFunctions.DDDD=padToken(formatTokenFunctions.DDD,3),extend(Locale.prototype,{set:function(config){var prop,i;for(i in config)prop=config[i],"function"==typeof prop?this[i]=prop:this["_"+i]=prop},_months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),months:function(m){return this._months[m.month()]},_monthsShort:"Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"),monthsShort:function(m){return this._monthsShort[m.month()]},monthsParse:function(monthName){var i,mom,regex;for(this._monthsParse||(this._monthsParse=[]),i=0;12>i;i++)if(this._monthsParse[i]||(mom=moment.utc([2e3,i]),regex="^"+this.months(mom,"")+"|^"+this.monthsShort(mom,""),this._monthsParse[i]=new RegExp(regex.replace(".",""),"i")),this._monthsParse[i].test(monthName))return i},_weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),weekdays:function(m){return this._weekdays[m.day()]},_weekdaysShort:"Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"),weekdaysShort:function(m){return this._weekdaysShort[m.day()]},_weekdaysMin:"Su_Mo_Tu_We_Th_Fr_Sa".split("_"),weekdaysMin:function(m){return this._weekdaysMin[m.day()]},weekdaysParse:function(weekdayName){var i,mom,regex;for(this._weekdaysParse||(this._weekdaysParse=[]),i=0;7>i;i++)if(this._weekdaysParse[i]||(mom=moment([2e3,1]).day(i),regex="^"+this.weekdays(mom,"")+"|^"+this.weekdaysShort(mom,"")+"|^"+this.weekdaysMin(mom,""),this._weekdaysParse[i]=new RegExp(regex.replace(".",""),"i")),this._weekdaysParse[i].test(weekdayName))return i},_longDateFormat:{LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY LT",LLLL:"dddd, MMMM D, YYYY LT"},longDateFormat:function(key){var output=this._longDateFormat[key];return!output&&this._longDateFormat[key.toUpperCase()]&&(output=this._longDateFormat[key.toUpperCase()].replace(/MMMM|MM|DD|dddd/g,function(val){return val.slice(1)}),this._longDateFormat[key]=output),output},isPM:function(input){return"p"===(input+"").toLowerCase().charAt(0)},_meridiemParse:/[ap]\.?m?\.?/i,meridiem:function(hours,minutes,isLower){return hours>11?isLower?"pm":"PM":isLower?"am":"AM"},_calendar:{sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[Last] dddd [at] LT",sameElse:"L"},calendar:function(key,mom){var output=this._calendar[key];return"function"==typeof output?output.apply(mom):output},_relativeTime:{future:"in %s",past:"%s ago",s:"a few seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"},relativeTime:function(number,withoutSuffix,string,isFuture){var output=this._relativeTime[string];return"function"==typeof output?output(number,withoutSuffix,string,isFuture):output.replace(/%d/i,number)},pastFuture:function(diff,output){var format=this._relativeTime[diff>0?"future":"past"];return"function"==typeof format?format(output):format.replace(/%s/i,output)},ordinal:function(number){return this._ordinal.replace("%d",number)},_ordinal:"%d",preparse:function(string){return string},postformat:function(string){return string},week:function(mom){return weekOfYear(mom,this._week.dow,this._week.doy).week},_week:{dow:0,doy:6},_invalidDate:"Invalid date",invalidDate:function(){return this._invalidDate}}),moment=function(input,format,locale,strict){var c;return"boolean"==typeof locale&&(strict=locale,locale=undefined),c={},c._isAMomentObject=!0,c._i=input,c._f=format,c._l=locale,c._strict=strict,c._isUTC=!1,c._pf=defaultParsingFlags(),makeMoment(c)},moment.suppressDeprecationWarnings=!1,moment.createFromInputFallback=deprecate("moment construction falls back to js Date. This is discouraged and will be removed in upcoming major release. Please refer to https://github.com/moment/moment/issues/1407 for more info.",function(config){config._d=new Date(config._i)}),moment.min=function(){var args=[].slice.call(arguments,0);return pickBy("isBefore",args)},moment.max=function(){var args=[].slice.call(arguments,0);return pickBy("isAfter",args)},moment.utc=function(input,format,locale,strict){var c;return"boolean"==typeof locale&&(strict=locale,locale=undefined),c={},c._isAMomentObject=!0,c._useUTC=!0,c._isUTC=!0,c._l=locale,c._i=input,c._f=format,c._strict=strict,c._pf=defaultParsingFlags(),makeMoment(c).utc()},moment.unix=function(input){return moment(1e3*input)},moment.duration=function(input,key){var sign,ret,parseIso,diffRes,duration=input,match=null;return moment.isDuration(input)?duration={ms:input._milliseconds,d:input._days,M:input._months}:"number"==typeof input?(duration={},key?duration[key]=input:duration.milliseconds=input):(match=aspNetTimeSpanJsonRegex.exec(input))?(sign="-"===match[1]?-1:1,duration={y:0,d:toInt(match[DATE])*sign,h:toInt(match[HOUR])*sign,m:toInt(match[MINUTE])*sign,s:toInt(match[SECOND])*sign,ms:toInt(match[MILLISECOND])*sign}):(match=isoDurationRegex.exec(input))?(sign="-"===match[1]?-1:1,parseIso=function(inp){var res=inp&&parseFloat(inp.replace(",","."));return(isNaN(res)?0:res)*sign},duration={y:parseIso(match[2]),M:parseIso(match[3]),d:parseIso(match[4]),h:parseIso(match[5]),m:parseIso(match[6]),s:parseIso(match[7]),w:parseIso(match[8])}):"object"==typeof duration&&("from"in duration||"to"in duration)&&(diffRes=momentsDifference(moment(duration.from),moment(duration.to)),duration={},duration.ms=diffRes.milliseconds,duration.M=diffRes.months),ret=new Duration(duration),moment.isDuration(input)&&hasOwnProp(input,"_locale")&&(ret._locale=input._locale),ret},moment.version=VERSION,moment.defaultFormat=isoFormat,moment.ISO_8601=function(){},moment.momentProperties=momentProperties,moment.updateOffset=function(){},moment.relativeTimeThreshold=function(threshold,limit){return relativeTimeThresholds[threshold]===undefined?!1:limit===undefined?relativeTimeThresholds[threshold]:(relativeTimeThresholds[threshold]=limit,!0)},moment.lang=deprecate("moment.lang is deprecated. Use moment.locale instead.",function(key,value){return moment.locale(key,value)}),moment.locale=function(key,values){var data;return key&&(data="undefined"!=typeof values?moment.defineLocale(key,values):moment.localeData(key),data&&(moment.duration._locale=moment._locale=data)),moment._locale._abbr},moment.defineLocale=function(name,values){return null!==values?(values.abbr=name,locales[name]||(locales[name]=new Locale),locales[name].set(values),moment.locale(name),locales[name]):(delete locales[name],null)},moment.langData=deprecate("moment.langData is deprecated. Use moment.localeData instead.",function(key){return moment.localeData(key)}),moment.localeData=function(key){var locale;if(key&&key._locale&&key._locale._abbr&&(key=key._locale._abbr),!key)return moment._locale;if(!isArray(key)){if(locale=loadLocale(key))return locale;key=[key]}return chooseLocale(key)},moment.isMoment=function(obj){return obj instanceof Moment||null!=obj&&hasOwnProp(obj,"_isAMomentObject")},moment.isDuration=function(obj){return obj instanceof Duration};for(i=lists.length-1;i>=0;--i)makeList(lists[i]);moment.normalizeUnits=function(units){return normalizeUnits(units)},moment.invalid=function(flags){var m=moment.utc(0/0);return null!=flags?extend(m._pf,flags):m._pf.userInvalidated=!0,m},moment.parseZone=function(){return moment.apply(null,arguments).parseZone()},moment.parseTwoDigitYear=function(input){return toInt(input)+(toInt(input)>68?1900:2e3)},extend(moment.fn=Moment.prototype,{clone:function(){return moment(this)},valueOf:function(){return+this._d+6e4*(this._offset||0)},unix:function(){return Math.floor(+this/1e3)},toString:function(){return this.clone().locale("en").format("ddd MMM DD YYYY HH:mm:ss [GMT]ZZ")},toDate:function(){return this._offset?new Date(+this):this._d},toISOString:function(){var m=moment(this).utc();return 0<m.year()&&m.year()<=9999?formatMoment(m,"YYYY-MM-DD[T]HH:mm:ss.SSS[Z]"):formatMoment(m,"YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]")},toArray:function(){var m=this;return[m.year(),m.month(),m.date(),m.hours(),m.minutes(),m.seconds(),m.milliseconds()]},isValid:function(){return isValid(this)},isDSTShifted:function(){return this._a?this.isValid()&&compareArrays(this._a,(this._isUTC?moment.utc(this._a):moment(this._a)).toArray())>0:!1},parsingFlags:function(){return extend({},this._pf)},invalidAt:function(){return this._pf.overflow},utc:function(keepLocalTime){return this.zone(0,keepLocalTime)},local:function(keepLocalTime){return this._isUTC&&(this.zone(0,keepLocalTime),this._isUTC=!1,keepLocalTime&&this.add(this._dateTzOffset(),"m")),this},format:function(inputString){var output=formatMoment(this,inputString||moment.defaultFormat);return this.localeData().postformat(output)},add:createAdder(1,"add"),subtract:createAdder(-1,"subtract"),diff:function(input,units,asFloat){var diff,output,daysAdjust,that=makeAs(input,this),zoneDiff=6e4*(this.zone()-that.zone());return units=normalizeUnits(units),"year"===units||"month"===units?(diff=432e5*(this.daysInMonth()+that.daysInMonth()),output=12*(this.year()-that.year())+(this.month()-that.month()),daysAdjust=this-moment(this).startOf("month")-(that-moment(that).startOf("month")),daysAdjust-=6e4*(this.zone()-moment(this).startOf("month").zone()-(that.zone()-moment(that).startOf("month").zone())),output+=daysAdjust/diff,"year"===units&&(output/=12)):(diff=this-that,output="second"===units?diff/1e3:"minute"===units?diff/6e4:"hour"===units?diff/36e5:"day"===units?(diff-zoneDiff)/864e5:"week"===units?(diff-zoneDiff)/6048e5:diff),asFloat?output:absRound(output)},from:function(time,withoutSuffix){return moment.duration({to:this,from:time}).locale(this.locale()).humanize(!withoutSuffix)},fromNow:function(withoutSuffix){return this.from(moment(),withoutSuffix)},calendar:function(time){var now=time||moment(),sod=makeAs(now,this).startOf("day"),diff=this.diff(sod,"days",!0),format=-6>diff?"sameElse":-1>diff?"lastWeek":0>diff?"lastDay":1>diff?"sameDay":2>diff?"nextDay":7>diff?"nextWeek":"sameElse";return this.format(this.localeData().calendar(format,this))},isLeapYear:function(){return isLeapYear(this.year())},isDST:function(){return this.zone()<this.clone().month(0).zone()||this.zone()<this.clone().month(5).zone()},day:function(input){var day=this._isUTC?this._d.getUTCDay():this._d.getDay();return null!=input?(input=parseWeekday(input,this.localeData()),this.add(input-day,"d")):day},month:makeAccessor("Month",!0),startOf:function(units){switch(units=normalizeUnits(units)){case"year":this.month(0);case"quarter":case"month":this.date(1);case"week":case"isoWeek":case"day":this.hours(0);case"hour":this.minutes(0);case"minute":this.seconds(0);case"second":this.milliseconds(0)}return"week"===units?this.weekday(0):"isoWeek"===units&&this.isoWeekday(1),"quarter"===units&&this.month(3*Math.floor(this.month()/3)),this},endOf:function(units){return units=normalizeUnits(units),this.startOf(units).add(1,"isoWeek"===units?"week":units).subtract(1,"ms")},isAfter:function(input,units){return units=normalizeUnits("undefined"!=typeof units?units:"millisecond"),"millisecond"===units?(input=moment.isMoment(input)?input:moment(input),+this>+input):+this.clone().startOf(units)>+moment(input).startOf(units)},isBefore:function(input,units){return units=normalizeUnits("undefined"!=typeof units?units:"millisecond"),"millisecond"===units?(input=moment.isMoment(input)?input:moment(input),+input>+this):+this.clone().startOf(units)<+moment(input).startOf(units)},isSame:function(input,units){return units=normalizeUnits(units||"millisecond"),"millisecond"===units?(input=moment.isMoment(input)?input:moment(input),+this===+input):+this.clone().startOf(units)===+makeAs(input,this).startOf(units)},min:deprecate("moment().min is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548",function(other){return other=moment.apply(null,arguments),this>other?this:other}),max:deprecate("moment().max is deprecated, use moment.max instead. https://github.com/moment/moment/issues/1548",function(other){return other=moment.apply(null,arguments),other>this?this:other}),zone:function(input,keepLocalTime){var localAdjust,offset=this._offset||0;return null==input?this._isUTC?offset:this._dateTzOffset():("string"==typeof input&&(input=timezoneMinutesFromString(input)),Math.abs(input)<16&&(input=60*input),!this._isUTC&&keepLocalTime&&(localAdjust=this._dateTzOffset()),this._offset=input,this._isUTC=!0,null!=localAdjust&&this.subtract(localAdjust,"m"),offset!==input&&(!keepLocalTime||this._changeInProgress?addOrSubtractDurationFromMoment(this,moment.duration(offset-input,"m"),1,!1):this._changeInProgress||(this._changeInProgress=!0,moment.updateOffset(this,!0),this._changeInProgress=null)),this)},zoneAbbr:function(){return this._isUTC?"UTC":""},zoneName:function(){return this._isUTC?"Coordinated Universal Time":""},parseZone:function(){return this._tzm?this.zone(this._tzm):"string"==typeof this._i&&this.zone(this._i),this},hasAlignedHourOffset:function(input){return input=input?moment(input).zone():0,(this.zone()-input)%60===0},daysInMonth:function(){return daysInMonth(this.year(),this.month())},dayOfYear:function(input){var dayOfYear=round((moment(this).startOf("day")-moment(this).startOf("year"))/864e5)+1;return null==input?dayOfYear:this.add(input-dayOfYear,"d")},quarter:function(input){return null==input?Math.ceil((this.month()+1)/3):this.month(3*(input-1)+this.month()%3)},weekYear:function(input){var year=weekOfYear(this,this.localeData()._week.dow,this.localeData()._week.doy).year;return null==input?year:this.add(input-year,"y")},isoWeekYear:function(input){var year=weekOfYear(this,1,4).year;return null==input?year:this.add(input-year,"y")},week:function(input){var week=this.localeData().week(this);return null==input?week:this.add(7*(input-week),"d")},isoWeek:function(input){var week=weekOfYear(this,1,4).week;return null==input?week:this.add(7*(input-week),"d")},weekday:function(input){var weekday=(this.day()+7-this.localeData()._week.dow)%7;return null==input?weekday:this.add(input-weekday,"d")},isoWeekday:function(input){return null==input?this.day()||7:this.day(this.day()%7?input:input-7)},isoWeeksInYear:function(){return weeksInYear(this.year(),1,4)},weeksInYear:function(){var weekInfo=this.localeData()._week;return weeksInYear(this.year(),weekInfo.dow,weekInfo.doy)},get:function(units){return units=normalizeUnits(units),this[units]()},set:function(units,value){return units=normalizeUnits(units),"function"==typeof this[units]&&this[units](value),this},locale:function(key){var newLocaleData;return key===undefined?this._locale._abbr:(newLocaleData=moment.localeData(key),null!=newLocaleData&&(this._locale=newLocaleData),this)},lang:deprecate("moment().lang() is deprecated. Use moment().localeData() instead.",function(key){return key===undefined?this.localeData():this.locale(key)}),localeData:function(){return this._locale
},_dateTzOffset:function(){return 15*Math.round(this._d.getTimezoneOffset()/15)}}),moment.fn.millisecond=moment.fn.milliseconds=makeAccessor("Milliseconds",!1),moment.fn.second=moment.fn.seconds=makeAccessor("Seconds",!1),moment.fn.minute=moment.fn.minutes=makeAccessor("Minutes",!1),moment.fn.hour=moment.fn.hours=makeAccessor("Hours",!0),moment.fn.date=makeAccessor("Date",!0),moment.fn.dates=deprecate("dates accessor is deprecated. Use date instead.",makeAccessor("Date",!0)),moment.fn.year=makeAccessor("FullYear",!0),moment.fn.years=deprecate("years accessor is deprecated. Use year instead.",makeAccessor("FullYear",!0)),moment.fn.days=moment.fn.day,moment.fn.months=moment.fn.month,moment.fn.weeks=moment.fn.week,moment.fn.isoWeeks=moment.fn.isoWeek,moment.fn.quarters=moment.fn.quarter,moment.fn.toJSON=moment.fn.toISOString,extend(moment.duration.fn=Duration.prototype,{_bubble:function(){var seconds,minutes,hours,milliseconds=this._milliseconds,days=this._days,months=this._months,data=this._data,years=0;data.milliseconds=milliseconds%1e3,seconds=absRound(milliseconds/1e3),data.seconds=seconds%60,minutes=absRound(seconds/60),data.minutes=minutes%60,hours=absRound(minutes/60),data.hours=hours%24,days+=absRound(hours/24),years=absRound(daysToYears(days)),days-=absRound(yearsToDays(years)),months+=absRound(days/30),days%=30,years+=absRound(months/12),months%=12,data.days=days,data.months=months,data.years=years},abs:function(){return this._milliseconds=Math.abs(this._milliseconds),this._days=Math.abs(this._days),this._months=Math.abs(this._months),this._data.milliseconds=Math.abs(this._data.milliseconds),this._data.seconds=Math.abs(this._data.seconds),this._data.minutes=Math.abs(this._data.minutes),this._data.hours=Math.abs(this._data.hours),this._data.months=Math.abs(this._data.months),this._data.years=Math.abs(this._data.years),this},weeks:function(){return absRound(this.days()/7)},valueOf:function(){return this._milliseconds+864e5*this._days+this._months%12*2592e6+31536e6*toInt(this._months/12)},humanize:function(withSuffix){var output=relativeTime(this,!withSuffix,this.localeData());return withSuffix&&(output=this.localeData().pastFuture(+this,output)),this.localeData().postformat(output)},add:function(input,val){var dur=moment.duration(input,val);return this._milliseconds+=dur._milliseconds,this._days+=dur._days,this._months+=dur._months,this._bubble(),this},subtract:function(input,val){var dur=moment.duration(input,val);return this._milliseconds-=dur._milliseconds,this._days-=dur._days,this._months-=dur._months,this._bubble(),this},get:function(units){return units=normalizeUnits(units),this[units.toLowerCase()+"s"]()},as:function(units){var days,months;if(units=normalizeUnits(units),"month"===units||"year"===units)return days=this._days+this._milliseconds/864e5,months=this._months+12*daysToYears(days),"month"===units?months:months/12;switch(days=this._days+yearsToDays(this._months/12),units){case"week":return days/7+this._milliseconds/6048e5;case"day":return days+this._milliseconds/864e5;case"hour":return 24*days+this._milliseconds/36e5;case"minute":return 24*days*60+this._milliseconds/6e4;case"second":return 24*days*60*60+this._milliseconds/1e3;case"millisecond":return Math.floor(24*days*60*60*1e3)+this._milliseconds;default:throw new Error("Unknown unit "+units)}},lang:moment.fn.lang,locale:moment.fn.locale,toIsoString:deprecate("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",function(){return this.toISOString()}),toISOString:function(){var years=Math.abs(this.years()),months=Math.abs(this.months()),days=Math.abs(this.days()),hours=Math.abs(this.hours()),minutes=Math.abs(this.minutes()),seconds=Math.abs(this.seconds()+this.milliseconds()/1e3);return this.asSeconds()?(this.asSeconds()<0?"-":"")+"P"+(years?years+"Y":"")+(months?months+"M":"")+(days?days+"D":"")+(hours||minutes||seconds?"T":"")+(hours?hours+"H":"")+(minutes?minutes+"M":"")+(seconds?seconds+"S":""):"P0D"},localeData:function(){return this._locale}}),moment.duration.fn.toString=moment.duration.fn.toISOString;for(i in unitMillisecondFactors)hasOwnProp(unitMillisecondFactors,i)&&makeDurationGetter(i.toLowerCase());moment.duration.fn.asMilliseconds=function(){return this.as("ms")},moment.duration.fn.asSeconds=function(){return this.as("s")},moment.duration.fn.asMinutes=function(){return this.as("m")},moment.duration.fn.asHours=function(){return this.as("h")},moment.duration.fn.asDays=function(){return this.as("d")},moment.duration.fn.asWeeks=function(){return this.as("weeks")},moment.duration.fn.asMonths=function(){return this.as("M")},moment.duration.fn.asYears=function(){return this.as("y")},moment.locale("en",{ordinal:function(number){var b=number%10,output=1===toInt(number%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th";return number+output}}),hasModule?module.exports=moment:"function"==typeof define&&define.amd?(define("moment",function(require,exports,module){return module.config&&module.config()&&module.config().noGlobal===!0&&(globalScope.moment=oldGlobalMoment),moment}),makeGlobal(!0)):makeGlobal()}.call(this),function(root,factory){"use strict";var moment;if("object"==typeof exports){try{moment=require("moment")}catch(e){}module.exports=factory(moment)}else"function"==typeof define&&define.amd?define(function(req){var id="moment";return moment=req.defined&&req.defined(id)?req(id):void 0,factory(moment)}):root.Pikaday=factory(root.moment)}(this,function(moment){"use strict";var hasMoment="function"==typeof moment,hasEventListeners=!!window.addEventListener,document=window.document,sto=window.setTimeout,addEvent=function(el,e,callback,capture){hasEventListeners?el.addEventListener(e,callback,!!capture):el.attachEvent("on"+e,callback)},removeEvent=function(el,e,callback,capture){hasEventListeners?el.removeEventListener(e,callback,!!capture):el.detachEvent("on"+e,callback)},fireEvent=function(el,eventName,data){var ev;document.createEvent?(ev=document.createEvent("HTMLEvents"),ev.initEvent(eventName,!0,!1),ev=extend(ev,data),el.dispatchEvent(ev)):document.createEventObject&&(ev=document.createEventObject(),ev=extend(ev,data),el.fireEvent("on"+eventName,ev))},trim=function(str){return str.trim?str.trim():str.replace(/^\s+|\s+$/g,"")},hasClass=function(el,cn){return-1!==(" "+el.className+" ").indexOf(" "+cn+" ")},addClass=function(el,cn){hasClass(el,cn)||(el.className=""===el.className?cn:el.className+" "+cn)},removeClass=function(el,cn){el.className=trim((" "+el.className+" ").replace(" "+cn+" "," "))},isArray=function(obj){return/Array/.test(Object.prototype.toString.call(obj))},isDate=function(obj){return/Date/.test(Object.prototype.toString.call(obj))&&!isNaN(obj.getTime())},isLeapYear=function(year){return year%4===0&&year%100!==0||year%400===0},getDaysInMonth=function(year,month){return[31,isLeapYear(year)?29:28,31,30,31,30,31,31,30,31,30,31][month]},setToStartOfDay=function(date){isDate(date)&&date.setHours(0,0,0,0)},compareDates=function(a,b){return a.getTime()===b.getTime()},extend=function(to,from,overwrite){var prop,hasProp;for(prop in from)hasProp=void 0!==to[prop],hasProp&&"object"==typeof from[prop]&&void 0===from[prop].nodeName?isDate(from[prop])?overwrite&&(to[prop]=new Date(from[prop].getTime())):isArray(from[prop])?overwrite&&(to[prop]=from[prop].slice(0)):to[prop]=extend({},from[prop],overwrite):(overwrite||!hasProp)&&(to[prop]=from[prop]);return to},defaults={field:null,bound:void 0,position:"bottom left",format:"YYYY-MM-DD",defaultDate:null,setDefaultDate:!1,firstDay:0,minDate:null,maxDate:null,yearRange:10,minYear:0,maxYear:9999,minMonth:void 0,maxMonth:void 0,isRTL:!1,yearSuffix:"",showMonthAfterYear:!1,numberOfMonths:1,i18n:{previousMonth:"Previous Month",nextMonth:"Next Month",months:["January","February","March","April","May","June","July","August","September","October","November","December"],weekdays:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],weekdaysShort:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"]},onSelect:null,onOpen:null,onClose:null,onDraw:null},renderDayName=function(opts,day,abbr){for(day+=opts.firstDay;day>=7;)day-=7;return abbr?opts.i18n.weekdaysShort[day]:opts.i18n.weekdays[day]},renderDay=function(i,isSelected,isToday,isDisabled,isEmpty){if(isEmpty)return'<td class="is-empty"></td>';var arr=[];return isDisabled&&arr.push("is-disabled"),isToday&&arr.push("is-today"),isSelected&&arr.push("is-selected"),'<td data-day="'+i+'" class="'+arr.join(" ")+'"><button class="pika-button" type="button">'+i+"</button></td>"},renderRow=function(days,isRTL){return"<tr>"+(isRTL?days.reverse():days).join("")+"</tr>"},renderBody=function(rows){return"<tbody>"+rows.join("")+"</tbody>"},renderHead=function(opts){var i,arr=[];for(i=0;7>i;i++)arr.push('<th scope="col"><abbr title="'+renderDayName(opts,i)+'">'+renderDayName(opts,i,!0)+"</abbr></th>");return"<thead>"+(opts.isRTL?arr.reverse():arr).join("")+"</thead>"},renderTitle=function(instance){var i,j,arr,monthHtml,yearHtml,opts=instance._o,month=instance._m,year=instance._y,isMinYear=year===opts.minYear,isMaxYear=year===opts.maxYear,html='<div class="pika-title">',prev=!0,next=!0;for(arr=[],i=0;12>i;i++)arr.push('<option value="'+i+'"'+(i===month?" selected":"")+(isMinYear&&i<opts.minMonth||isMaxYear&&i>opts.maxMonth?"disabled":"")+">"+opts.i18n.months[i]+"</option>");for(monthHtml='<div class="pika-label">'+opts.i18n.months[month]+'<select class="pika-select pika-select-month">'+arr.join("")+"</select></div>",isArray(opts.yearRange)?(i=opts.yearRange[0],j=opts.yearRange[1]+1):(i=year-opts.yearRange,j=1+year+opts.yearRange),arr=[];j>i&&i<=opts.maxYear;i++)i>=opts.minYear&&arr.push('<option value="'+i+'"'+(i===year?" selected":"")+">"+i+"</option>");return yearHtml='<div class="pika-label">'+year+opts.yearSuffix+'<select class="pika-select pika-select-year">'+arr.join("")+"</select></div>",html+=opts.showMonthAfterYear?yearHtml+monthHtml:monthHtml+yearHtml,isMinYear&&(0===month||opts.minMonth>=month)&&(prev=!1),isMaxYear&&(11===month||opts.maxMonth<=month)&&(next=!1),html+='<button class="pika-prev'+(prev?"":" is-disabled")+'" type="button">'+opts.i18n.previousMonth+"</button>",html+='<button class="pika-next'+(next?"":" is-disabled")+'" type="button">'+opts.i18n.nextMonth+"</button>",html+="</div>"},renderTable=function(opts,data){return'<table cellpadding="0" cellspacing="0" class="pika-table">'+renderHead(opts)+renderBody(data)+"</table>"},Pikaday=function(options){var self=this,opts=self.config(options);self._onMouseDown=function(e){if(self._v){e=e||window.event;var target=e.target||e.srcElement;if(target){if(!hasClass(target,"is-disabled")){if(hasClass(target,"pika-button")&&!hasClass(target,"is-empty"))return self.setDate(new Date(self._y,self._m,parseInt(target.innerHTML,10))),void(opts.bound&&sto(function(){self.hide()},100));hasClass(target,"pika-prev")?self.prevMonth():hasClass(target,"pika-next")&&self.nextMonth()}if(hasClass(target,"pika-select"))self._c=!0;else{if(!e.preventDefault)return e.returnValue=!1,!1;e.preventDefault()}}}},self._onChange=function(e){e=e||window.event;var target=e.target||e.srcElement;target&&(hasClass(target,"pika-select-month")?self.gotoMonth(target.value):hasClass(target,"pika-select-year")&&self.gotoYear(target.value))},self._onInputChange=function(e){var date;e.firedBy!==self&&(hasMoment?(date=moment(opts.field.value,opts.format),date=date&&date.isValid()?date.toDate():null):date=new Date(Date.parse(opts.field.value)),self.setDate(isDate(date)?date:null),self._v||self.show())},self._onInputFocus=function(){self.show()},self._onInputClick=function(){self.show()},self._onInputBlur=function(){self._c||(self._b=sto(function(){self.hide()},50)),self._c=!1},self._onClick=function(e){e=e||window.event;var target=e.target||e.srcElement,pEl=target;if(target){!hasEventListeners&&hasClass(target,"pika-select")&&(target.onchange||(target.setAttribute("onchange","return;"),addEvent(target,"change",self._onChange)));do if(hasClass(pEl,"pika-single"))return;while(pEl=pEl.parentNode);self._v&&target!==opts.trigger&&self.hide()}},self.el=document.createElement("div"),self.el.className="pika-single"+(opts.isRTL?" is-rtl":""),addEvent(self.el,"mousedown",self._onMouseDown,!0),addEvent(self.el,"change",self._onChange),opts.field&&(opts.bound?document.body.appendChild(self.el):opts.field.parentNode.insertBefore(self.el,opts.field.nextSibling),addEvent(opts.field,"change",self._onInputChange),opts.defaultDate||(opts.defaultDate=hasMoment&&opts.field.value?moment(opts.field.value,opts.format).toDate():new Date(Date.parse(opts.field.value)),opts.setDefaultDate=!0));var defDate=opts.defaultDate;isDate(defDate)?opts.setDefaultDate?self.setDate(defDate,!0):self.gotoDate(defDate):self.gotoDate(new Date),opts.bound?(this.hide(),self.el.className+=" is-bound",addEvent(opts.trigger,"click",self._onInputClick),addEvent(opts.trigger,"focus",self._onInputFocus),addEvent(opts.trigger,"blur",self._onInputBlur)):this.show()};return Pikaday.prototype={config:function(options){this._o||(this._o=extend({},defaults,!0));var opts=extend(this._o,options,!0);opts.isRTL=!!opts.isRTL,opts.field=opts.field&&opts.field.nodeName?opts.field:null,opts.bound=!!(void 0!==opts.bound?opts.field&&opts.bound:opts.field),opts.trigger=opts.trigger&&opts.trigger.nodeName?opts.trigger:opts.field;var nom=parseInt(opts.numberOfMonths,10)||1;if(opts.numberOfMonths=nom>4?4:nom,isDate(opts.minDate)||(opts.minDate=!1),isDate(opts.maxDate)||(opts.maxDate=!1),opts.minDate&&opts.maxDate&&opts.maxDate<opts.minDate&&(opts.maxDate=opts.minDate=!1),opts.minDate&&(setToStartOfDay(opts.minDate),opts.minYear=opts.minDate.getFullYear(),opts.minMonth=opts.minDate.getMonth()),opts.maxDate&&(setToStartOfDay(opts.maxDate),opts.maxYear=opts.maxDate.getFullYear(),opts.maxMonth=opts.maxDate.getMonth()),isArray(opts.yearRange)){var fallback=(new Date).getFullYear()-10;opts.yearRange[0]=parseInt(opts.yearRange[0],10)||fallback,opts.yearRange[1]=parseInt(opts.yearRange[1],10)||fallback}else opts.yearRange=Math.abs(parseInt(opts.yearRange,10))||defaults.yearRange,opts.yearRange>100&&(opts.yearRange=100);return opts},toString:function(format){return isDate(this._d)?hasMoment?moment(this._d).format(format||this._o.format):this._d.toDateString():""},getMoment:function(){return hasMoment?moment(this._d):null},setMoment:function(date,preventOnSelect){hasMoment&&moment.isMoment(date)&&this.setDate(date.toDate(),preventOnSelect)},getDate:function(){return isDate(this._d)?new Date(this._d.getTime()):null},setDate:function(date,preventOnSelect){if(!date)return this._d=null,this.draw();if("string"==typeof date&&(date=new Date(Date.parse(date))),isDate(date)){var min=this._o.minDate,max=this._o.maxDate;isDate(min)&&min>date?date=min:isDate(max)&&date>max&&(date=max),this._d=new Date(date.getTime()),setToStartOfDay(this._d),this.gotoDate(this._d),this._o.field&&(this._o.field.value=this.toString(),fireEvent(this._o.field,"change",{firedBy:this})),preventOnSelect||"function"!=typeof this._o.onSelect||this._o.onSelect.call(this,this.getDate())}},gotoDate:function(date){isDate(date)&&(this._y=date.getFullYear(),this._m=date.getMonth(),this.draw())},gotoToday:function(){this.gotoDate(new Date)},gotoMonth:function(month){isNaN(month=parseInt(month,10))||(this._m=0>month?0:month>11?11:month,this.draw())},nextMonth:function(){++this._m>11&&(this._m=0,this._y++),this.draw()},prevMonth:function(){--this._m<0&&(this._m=11,this._y--),this.draw()},gotoYear:function(year){isNaN(year)||(this._y=parseInt(year,10),this.draw())},setMinDate:function(value){this._o.minDate=value},setMaxDate:function(value){this._o.maxDate=value},draw:function(force){if(this._v||force){var opts=this._o,minYear=opts.minYear,maxYear=opts.maxYear,minMonth=opts.minMonth,maxMonth=opts.maxMonth;if(this._y<=minYear&&(this._y=minYear,!isNaN(minMonth)&&this._m<minMonth&&(this._m=minMonth)),this._y>=maxYear&&(this._y=maxYear,!isNaN(maxMonth)&&this._m>maxMonth&&(this._m=maxMonth)),this.el.innerHTML=renderTitle(this)+this.render(this._y,this._m),opts.bound&&(this.adjustPosition(),"hidden"!==opts.field.type&&sto(function(){opts.trigger.focus()},1)),"function"==typeof this._o.onDraw){var self=this;sto(function(){self._o.onDraw.call(self)},0)}}},adjustPosition:function(){var left,top,clientRect,field=this._o.trigger,pEl=field,width=this.el.offsetWidth,height=this.el.offsetHeight,viewportWidth=window.innerWidth||document.documentElement.clientWidth,viewportHeight=window.innerHeight||document.documentElement.clientHeight,scrollTop=window.pageYOffset||document.body.scrollTop||document.documentElement.scrollTop;if("function"==typeof field.getBoundingClientRect)clientRect=field.getBoundingClientRect(),left=clientRect.left+window.pageXOffset,top=clientRect.bottom+window.pageYOffset;else for(left=pEl.offsetLeft,top=pEl.offsetTop+pEl.offsetHeight;pEl=pEl.offsetParent;)left+=pEl.offsetLeft,top+=pEl.offsetTop;(left+width>viewportWidth||this._o.position.indexOf("right")>-1&&left-width+field.offsetWidth>0)&&(left=left-width+field.offsetWidth),(top+height>viewportHeight+scrollTop||this._o.position.indexOf("top")>-1&&top-height-field.offsetHeight>0)&&(top=top-height-field.offsetHeight),this.el.style.cssText=["position: absolute","left: "+left+"px","top: "+top+"px"].join(";")},render:function(year,month){var opts=this._o,now=new Date,days=getDaysInMonth(year,month),before=new Date(year,month,1).getDay(),data=[],row=[];setToStartOfDay(now),opts.firstDay>0&&(before-=opts.firstDay,0>before&&(before+=7));for(var cells=days+before,after=cells;after>7;)after-=7;cells+=7-after;for(var i=0,r=0;cells>i;i++){var day=new Date(year,month,1+(i-before)),isDisabled=opts.minDate&&day<opts.minDate||opts.maxDate&&day>opts.maxDate,isSelected=isDate(this._d)?compareDates(day,this._d):!1,isToday=compareDates(day,now),isEmpty=before>i||i>=days+before;row.push(renderDay(1+(i-before),isSelected,isToday,isDisabled,isEmpty)),7===++r&&(data.push(renderRow(row,opts.isRTL)),row=[],r=0)}return renderTable(opts,data)},isVisible:function(){return this._v},show:function(){this._v||(this._o.bound&&addEvent(document,"click",this._onClick),removeClass(this.el,"is-hidden"),this._v=!0,this.draw(),"function"==typeof this._o.onOpen&&this._o.onOpen.call(this))},hide:function(){var v=this._v;v!==!1&&(this._o.bound&&removeEvent(document,"click",this._onClick),this.el.style.cssText="",addClass(this.el,"is-hidden"),this._v=!1,void 0!==v&&"function"==typeof this._o.onClose&&this._o.onClose.call(this))},destroy:function(){this.hide(),removeEvent(this.el,"mousedown",this._onMouseDown,!0),removeEvent(this.el,"change",this._onChange),this._o.field&&(removeEvent(this._o.field,"change",this._onInputChange),this._o.bound&&(removeEvent(this._o.trigger,"click",this._onInputClick),removeEvent(this._o.trigger,"focus",this._onInputFocus),removeEvent(this._o.trigger,"blur",this._onInputBlur))),this.el.parentNode&&this.el.parentNode.removeChild(this.el)}},Pikaday}),function(window,angular){var augmentWidthOrHeight,core_pnum,cssExpand,extendjQuery,getStyles,getWidthOrHeight,getWindow,isScope,isWindow,jqLiteExtend,modules,rnumnonpx;modules=["Mac.Util"];try{angular.module("ngAnimate"),modules.push("ngAnimate")}catch(_error){}angular.module("Mac",modules),cssExpand=["Top","Right","Bottom","Left"],core_pnum=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,rnumnonpx=new RegExp("^("+core_pnum+")(?!px)[a-z%]+$","i"),getStyles=function(element){return window.getComputedStyle(element,null)},isWindow=function(obj){return obj&&obj.document&&obj.location&&obj.alert&&obj.setInterval},isScope=function(obj){return obj&&null!=obj.$evalAsync&&null!=obj.$watch},getWindow=function(element){return isWindow(element)?element:9===element.nodeType&&element.defaultView},augmentWidthOrHeight=function(element,name,extra,isBorderBox,styles){var i,start,_i;if(extra===(isBorderBox?"border":"content"))return 0;for(start="Width"===name?1:0,i=_i=start;3>=_i;i=_i+=2)"margin"===extra&&(val+=parseFloat(styles[""+extra+cssExpand[i]])),isBorderBox?("content"===extra&&(val-=parseFloat(styles["padding"+cssExpand[i]])),"margin"!==extra&&(val-=parseFloat(styles["border"+cssExpand[i]]))):(val+=parseFloat(styles["padding"+cssExpand[i]]),"padding"!==extra&&(val+=parseFloat(styles["border"+cssExpand+"Width"])));return val},getWidthOrHeight=function(type,prefix,element){return function(margin){var defaultExtra,doc,extra,isBorderBox,name,styles,value,valueIsBorderBox;if(defaultExtra=function(){switch(prefix){case"inner":return"padding";case"outer":return"";default:return"content"}}(),extra=defaultExtra||(margin===!0?"margin":"border"),isWindow(element))return element.document.documentElement["client"+type];if(9===element.nodeType)return doc=element.documentElement,Math.max(element.body["scroll"+type],doc["scroll"+type],element.body["offset"+type],doc["offset"+type],doc["client"+type]);if(valueIsBorderBox=!0,styles=getStyles(element),name=type.toLowerCase(),value="Height"===type?element.offsetHeight:element.offsetWidth,isBorderBox="border-box"===element.style.boxSizing,0>=value||null===value){if(value=styles[name],(0>value||null===value)&&(value=element.style[name]),rnumnonpx.test(value))return value;valueIsBorderBox=isBorderBox,value=parseFloat(value)||0}return value+augmentWidthOrHeight(element,type,extra||(isBorderBox?"border":"content"),valueIsBorderBox,styles)}},jqLiteExtend={height:function(element){return getWidthOrHeight("Height","",element)()},width:function(element){return getWidthOrHeight("Width","",element)()},outerHeight:function(element,margin){return getWidthOrHeight("Height","outer",element)(margin)},outerWidth:function(element,margin){return getWidthOrHeight("Width","outer",element)(margin)},offset:function(element){var box,doc,docElem,win;return box={top:0,left:0},(doc=element&&element.ownerDocument)?(docElem=doc.documentElement,null!=element.getBoundingClientRect&&(box=element.getBoundingClientRect()),win=getWindow(doc),{top:box.top+win.pageYOffset-docElem.clientTop,left:box.left+win.pageXOffset-docElem.clientLeft}):void 0},scrollTop:function(element,value){var win;return win=getWindow(element),null==value?win?win.pageYOffset:element.scrollTop:win?win.scrollTo(window.pageYOffset,value):element.scrollTop=value},scrollLeft:function(element,value){var win;return win=getWindow(element),null==value?win?win.pageXOffset:element.scrollLeft:win?win.scrollTo(window.pageXOffset,value):element.scrollLeft=value}},(extendjQuery=function(){var jqLite;if(null==window.jQuery||null==angular.element.prototype.offset)return jqLite=angular.element,angular.forEach(jqLiteExtend,function(fn,name){return jqLite.prototype[name]=function(arg1,arg2){return this.length?fn(this[0],arg1,arg2):void 0}})})();var __hasProp={}.hasOwnProperty;angular.module("Mac.Util",[]).factory("util",["$filter",function($filter){return{_inflectionConstants:{uncountables:["sheep","fish","moose","series","species","money","rice","information","info","equipment","min"],irregulars:{child:"children",man:"men",woman:"women",person:"people",ox:"oxen",goose:"geese"},pluralizers:[[/(quiz)$/i,"$1zes"],[/([m|l])ouse$/i,"$1ice"],[/(matr|vert|ind)(ix|ex)$/i,"$1ices"],[/(x|ch|ss|sh)$/i,"$1es"],[/([^aeiouy]|qu)y$/i,"$1ies"],[/(?:([^f])fe|([lr])f)$/i,"$1$2ves"],[/sis$/i,"ses"],[/([ti])um$/i,"$1a"],[/(buffal|tomat)o$/i,"$1oes"],[/(bu)s$/i,"$1ses"],[/(alias|status)$/i,"$1es"],[/(octop|vir)us$/i,"$1i"],[/(ax|test)is$/i,"$1es"],[/x$/i,"xes"],[/s$/i,"s"],[/$/,"s"]]},pluralize:function(string,count,includeCount){var irregulars,isUppercase,lowercaseWord,pluralizedString,pluralizedWord,pluralizer,pluralizers,uncountables,word,_i,_len,_ref;if(null==string&&(string=""),null==includeCount&&(includeCount=!1),!angular.isString(string)||0===this.trim(string).length)return string;if(includeCount&&isNaN(+count))return"";if(null==count&&(count=2),_ref=this._inflectionConstants,pluralizers=_ref.pluralizers,uncountables=_ref.uncountables,irregulars=_ref.irregulars,word=string.split(/\s/).pop(),isUppercase=word.toUpperCase()===word,lowercaseWord=word.toLowerCase(),pluralizedWord=1===count||uncountables.indexOf(lowercaseWord)>=0?word:null,null==pluralizedWord&&null!=irregulars[lowercaseWord]&&(pluralizedWord=irregulars[lowercaseWord]),null==pluralizedWord)for(_i=0,_len=pluralizers.length;_len>_i;_i++)if(pluralizer=pluralizers[_i],pluralizer[0].test(lowercaseWord)){pluralizedWord=word.replace(pluralizer[0],pluralizer[1]);break}return pluralizedWord||(pluralizedWord=word),isUppercase&&(pluralizedWord=pluralizedWord.toUpperCase()),pluralizedString=string.slice(0,-word.length)+pluralizedWord,includeCount?""+$filter("number")(count)+" "+pluralizedString:pluralizedString},trim:function(string){var str;return str=String(string)||"",null!=String.prototype.trim?str.trim():str.replace(/^\s+|\s+$/gm,"")},capitalize:function(string){var str;return str=String(string)||"",str.charAt(0).toUpperCase()+str.substring(1)},uncapitalize:function(string){var str;return str=String(string)||"",str.charAt(0).toLowerCase()+str.substring(1)},toCamelCase:function(string){return null==string&&(string=""),this.trim(string).replace(/[-_\s]+(.)?/g,function(match,c){return c.toUpperCase()})},toSnakeCase:function(string){return null==string&&(string=""),this.trim(string).replace(/([a-z\d])([A-Z]+)/g,"$1_$2").replace(/[-\s]+/g,"_").toLowerCase()},convertKeysToCamelCase:function(object){var key,result,value;result={};for(key in object)__hasProp.call(object,key)&&(value=object[key],key=this.toCamelCase(key),"object"==typeof value&&(null!=value?value.constructor:void 0)!==Array&&(value=this.convertKeysToCamelCase(value)),result[key]=value);return result},convertKeysToSnakeCase:function(object){var key,result,value;result={};for(key in object)__hasProp.call(object,key)&&(value=object[key],key=this.toSnakeCase(key),"object"==typeof value&&(null!=value?value.constructor:void 0)!==Array&&(value=this.convertKeysToSnakeCase(value)),result[key]=value);return result},pyth:function(a,b){return Math.sqrt(a*a+b*b)},degrees:function(radian){return 180*radian/Math.PI},radian:function(degrees){return degrees*Math.PI/180},hex2rgb:function(hex){var color,rgb,value;0===hex.indexOf("#")&&(hex=hex.substring(1)),hex=hex.toLowerCase(),rgb={},3===hex.length?(rgb.r=hex.charAt(0)+hex.charAt(0),rgb.g=hex.charAt(1)+hex.charAt(1),rgb.b=hex.charAt(2)+hex.charAt(2)):(rgb.r=hex.substring(0,2),rgb.g=hex.substring(2,4),rgb.b=hex.substring(4));for(color in rgb)value=rgb[color],rgb[color]=parseInt(value,16);return rgb},timeRegex:/^(0?[1-9]|1[0-2]):([0-5][0-9])[\s]([AP]M)$/,_urlRegex:/(?:(http[s]?):\/\/)?(?:(www|[\d\w\-]+)\.)?([\d\w\-]+)\.([A-Za-z]{2,6})(:[\d]*)?([:\/?#\[\]@!$&'()*+,;=\w\d-._~%\\]*)?/i,_emailRegex:/^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/,validateUrl:function(url){var match;return match=this._urlRegex.exec(url),null!=match&&(match={url:match[0],protocol:match[1]||"http",subdomain:match[2],name:match[3],domain:match[4],port:match[5],path:match[6]||"/"},match.url=match.url),match},validateEmail:function(email){return this._emailRegex.test(email)},getQueryString:function(url,name){var regex,regexS,results;return null==name&&(name=""),name=name.replace(/[[]/,"[").replace(/[]]/,"]"),regexS="[?&]"+name+"=([^&#]*)",regex=new RegExp(regexS),results=regex.exec(url),null!=results?results[1]:""},parseUrlPath:function(fullPath){var path,pathComponents,queries,queryString,queryStrings,urlComponents,values,verb,_i,_len,_ref;if(urlComponents=fullPath.split("?"),pathComponents=urlComponents[0].split("/"),path=pathComponents.slice(0,pathComponents.length-1).join("/"),verb=pathComponents[pathComponents.length-1],queries={},urlComponents.length>1)for(queryStrings=urlComponents[urlComponents.length-1],_ref=queryStrings.split("&"),_i=0,_len=_ref.length;_len>_i;_i++)queryString=_ref[_i],values=queryString.split("="),queries[values[0]]=null!=values[1]?values[1]:"";return{fullPath:fullPath,path:path,pathComponents:pathComponents,verb:verb,queries:queries}},extendAttributes:function(prefix,defaults,attributes){var altKey,key,macKey,output,value,_ref,_ref1;null==prefix&&(prefix=""),output={};for(key in defaults)__hasProp.call(defaults,key)&&(value=defaults[key],altKey=prefix?this.capitalize(key):key,macKey=""+prefix+altKey,output[key]=null!=attributes[macKey]?attributes[macKey]||!0:value,"true"===(_ref=output[key])||"false"===_ref?output[key]="true"===output[key]:(null!=(_ref1=output[key])?_ref1.length:void 0)>0&&!isNaN(+output[key])&&(output[key]=+output[key]));return output}}}]),angular.module("Mac").factory("keys",function(){return{CANCEL:3,HELP:6,BACKSPACE:8,TAB:9,CLEAR:12,ENTER:13,RETURN:13,SHIFT:16,CONTROL:17,ALT:18,PAUSE:19,CAPS_LOCK:20,ESCAPE:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,PRINT_SCREEN:44,INSERT:45,DELETE:46,ZERO:48,ONE:49,TWO:50,THREE:51,FOUR:52,FIVE:53,SIX:54,SEVEN:55,EIGHT:56,NINE:57,SEMICOLON:59,EQUALS:61,COMMAND:91,A:65,B:66,C:67,D:68,E:69,F:70,G:71,H:72,I:73,J:74,K:75,L:76,M:77,N:78,O:79,P:80,Q:81,R:82,S:83,T:84,U:85,V:86,W:87,X:88,Y:89,Z:90,CONTEXT_MENU:93,NUMPAD0:96,NUMPAD1:97,NUMPAD2:98,NUMPAD3:99,NUMPAD4:100,NUMPAD5:101,NUMPAD6:102,NUMPAD7:103,NUMPAD8:104,NUMPAD9:105,MULTIPLY:106,ADD:107,SEPARATOR:108,SUBTRACT:109,DECIMAL:110,DIVIDE:111,F1:112,F2:113,F3:114,F4:115,F5:116,F6:117,F7:118,F8:119,F9:120,F10:121,F11:122,F12:123,F13:124,F14:125,F15:126,F16:127,F17:128,F18:129,F19:130,F20:131,F21:132,F22:133,F23:134,F24:135,NUM_LOCK:144,SCROLL_LOCK:145,COMMA:188,PERIOD:190,SLASH:191,BACK_QUOTE:192,OPEN_BRACKET:219,BACK_SLASH:220,CLOSE_BRACKET:221,QUOTE:222,META:224}});var key,_fn,_i,_len,_ref;for(_ref=["Enter","Escape","Space","Left","Up","Right","Down"],_fn=function(key){return angular.module("Mac").directive("macKeydown"+key,["$parse","keys",function($parse,keys){return{restrict:"A",link:function(scope,element,attributes){var expression;return expression=$parse(attributes["macKeydown"+key]),element.bind("keydown",function($event){return $event.which===keys[""+key.toUpperCase()]?($event.preventDefault(),scope.$apply(function(){return expression(scope,{$event:$event})})):void 0})}}}])},_i=0,_len=_ref.length;_len>_i;_i++)key=_ref[_i],_fn(key);angular.module("Mac").directive("macPauseTyping",["$parse","$timeout",function($parse,$timeout){return{restrict:"A",link:function(scope,element,attributes){var delay,expression,keyupTimer;return expression=$parse(attributes.macPauseTyping),delay=scope.$eval(attributes.macPauseTypingDelay)||800,keyupTimer=null,element.bind("keyup",function($event){return null!=keyupTimer&&$timeout.cancel(keyupTimer),keyupTimer=$timeout(function(){return expression(scope,{$event:$event})},delay)})}}}]),angular.module("Mac").directive("macWindowResize",["$parse","$window",function($parse,$window){return{restrict:"A",link:function($scope,element,attrs){var handler;return handler=function($event){var callbackFn;return callbackFn=$parse(attrs.macWindowResize),$scope.$apply(function(){return callbackFn($scope,{$event:$event})}),!0},angular.element($window).bind("resize",handler),$scope.$on("destroy",function(){return angular.element($window).unbind("resize",handler)})}}}]),angular.module("Mac").directive("macAutocomplete",["$animate","$compile","$filter","$http","$parse","$rootScope","$timeout","keys",function($animate,$compile,$filter,$http,$parse,$rootScope,$timeout,keys){return{restrict:"EA",template:'<input type="text"/>',transclude:!0,replace:!0,require:"ngModel",link:function($scope,element,attrs,ctrl,transclude){var $menuScope,appendMenu,autocompleteUrl,blurHandler,currentAutocomplete,delay,disabled,getData,inside,isMenuAppended,labelGetter,labelKey,menuEl,onError,onSelect,onSuccess,positionMenu,preventParser,queryData,queryKey,reset,source,timeoutId,updateItem;return labelKey=attrs.macAutocompleteLabel||"name",labelGetter=$parse(labelKey),queryKey=attrs.macAutocompleteQuery||"q",delay=+(attrs.macAutocompleteDelay||800),inside=null!=attrs.macAutocompleteInside,autocompleteUrl=$parse(attrs.macAutocompleteUrl),onSelect=$parse(attrs.macAutocompleteOnSelect),onSuccess=$parse(attrs.macAutocompleteOnSuccess),onError=$parse(attrs.macAutocompleteOnError),source=$parse(attrs.macAutocompleteSource),disabled=$parse(attrs.macAutocompleteDisabled),currentAutocomplete=[],timeoutId=null,isMenuAppended=!1,preventParser=!1,$menuScope=$scope.$new(),$menuScope.items=[],$menuScope.index=0,$menuScope.select=function(index){var label,selected;
return selected=currentAutocomplete[index],onSelect($scope,{selected:selected}),label=$menuScope.items[index].label||"",preventParser=!0,null!=attrs.ngModel&&(ctrl.$setViewValue(label),ctrl.$render()),reset()},menuEl=angular.element(document.createElement("mac-menu")),menuEl.attr({"ng-class":attrs.macMenuClass||null,"mac-menu-items":"items","mac-menu-select":"select(index)","mac-menu-index":"index"}),transclude($menuScope,function(clone){return menuEl.append(clone)}),$compile(menuEl)($menuScope),ctrl.$parsers.push(function(value){return!value||disabled($scope)||preventParser?reset():(null!=timeoutId&&$timeout.cancel(timeoutId),delay>0?timeoutId=$timeout(function(){return queryData(value)},delay):queryData(value)),preventParser=!1,value}),blurHandler=function(){return $scope.$apply(function(){return reset()})},appendMenu=function(callback){return isMenuAppended||(element.bind("blur",blurHandler),menuEl.on("mousedown",function(event){return event.preventDefault()})),isMenuAppended=!0,inside?$animate.enter(menuEl,void 0,element,callback):$animate.enter(menuEl,angular.element(document.body),void 0,callback)},reset=function(){$animate.leave(menuEl,function(){return $menuScope.index=0,$menuScope.items.length=0,menuEl[0].style.top="",menuEl[0].style.left="",isMenuAppended=!1,element.unbind("blur",blurHandler)})},positionMenu=function(){var offset,parentElement,parentStyles;return parentElement=inside?element[0]:document.body,parentStyles=window.getComputedStyle(parentElement),offset=element.offset(),offset.left-=parseInt(parentStyles.marginLeft),offset.top+=element.outerHeight()-parseInt(parentStyles.marginTop),offset.minWidth=element.outerWidth(),angular.forEach(offset,function(value,key){return!isNaN(+value)&&angular.isNumber(+value)&&(value=""+value+"px"),menuEl[0].style[key]=value})},updateItem=function(data){return(null!=data?data.length:void 0)>0?(currentAutocomplete=data,$menuScope.items=data.map(function(item){return angular.isObject(item)?(null==item.value&&(item.value=labelGetter(item)||""),null==item.label&&(item.label=labelGetter(item)||""),item):{label:item,value:item}}),appendMenu(positionMenu)):reset()},getData=function(url,query){var options;return options={method:"GET",url:url,params:{}},options.params[queryKey]=query,$http(options).success(function(data,status,headers){var dataList;return dataList=onSuccess($scope,{data:data,status:status,headers:headers}),null==dataList&&(dataList=data.data),updateItem(dataList)}).error(function(data,status,headers){return onError($scope,{data:data,status:status,headers:headers})})},queryData=function(query){var sourceData,url;return url=autocompleteUrl($scope),url?getData(url,query):(sourceData=source($scope),angular.isArray(sourceData)?updateItem($filter("filter")(sourceData,query)):angular.isString(sourceData)?getData(sourceData,query):angular.isFunction(sourceData)?sourceData(query,updateItem):void 0)},element.bind("keydown",function(event){if(0===$menuScope.items.length)return!0;switch(event.which){case keys.DOWN:$scope.$apply(function(){return $menuScope.index=($menuScope.index+1)%$menuScope.items.length,event.preventDefault()});break;case keys.UP:$scope.$apply(function(){return $menuScope.index=($menuScope.index?$menuScope.index:$menuScope.items.length)-1,event.preventDefault()});break;case keys.ENTER:$scope.$apply(function(){return $menuScope.select($menuScope.index),event.preventDefault()});break;case keys.ESCAPE:$scope.$apply(function(){return reset(),event.preventDefault()})}return!0}),$scope.$on("$destroy",function(){return $menuScope.$destroy(),reset()}),$scope.$on("reset-mac-autocomplete",function(){return reset()})}}}]),angular.module("Mac").directive("macFocusOnEvent",["$timeout",function($timeout){return function(scope,element,attributes){return scope.$on(attributes.macFocusOnEvent,function(){return $timeout(function(){var x,y;return element.focus(),attributes.macFocusOnEventScroll?(x=window.scrollX,y=window.scrollY,window.scrollTo(x,y)):void 0},0,!1)})}}]),angular.module("Mac").directive("macMenu",[function(){return{restrict:"EA",replace:!0,template:'<div ng-style="style" class="mac-menu"><ul><li mac-menu-transclude="mac-menu-transclude" ng-repeat="item in items" ng-click="selectItem($index)" ng-class="{\'active\': $index == index}" ng-mouseenter="setIndex($index)" class="mac-menu-item"></li></ul></div>',transclude:!0,controller:angular.noop,scope:{items:"=macMenuItems",style:"=macMenuStyle",select:"&macMenuSelect",pIndex:"=macMenuIndex"},link:function($scope,element,attrs){return $scope.selectItem=function(index){return $scope.select({index:index})},$scope.setIndex=function(index){return $scope.index=index,null!=attrs.macMenuIndex?$scope.pIndex=parseInt(index):void 0},null!=attrs.macMenuIndex&&$scope.$watch("pIndex",function(value){return $scope.index=parseInt(value)}),$scope.$watch("items.length",function(value){return value?attrs.$addClass("visible"):attrs.$removeClass("visible")})}}}]).directive("macMenuTransclude",["$compile",function($compile){return{link:function($scope,element,attrs,ctrls,transclude){return transclude($scope,function(clone){return element.empty(),0===clone.length&&(clone=$compile("<span>{{item.label}}</span>")($scope)),element.append(clone)})}}}]),angular.module("Mac").service("modal",["$rootScope","$animate","$templateCache","$compile","$http","$controller","modalViews","keys",function($rootScope,$animate,$templateCache,$compile,$http,$controller,modalViews,keys){return{registered:modalViews.registered,waiting:null,opened:null,modalTemplate:'<div class="mac-modal-overlay hide">\n  <div class="mac-modal">\n    <a mac-modal-close class="mac-close-modal"></a>\n    <div class="mac-modal-content-wrapper"></div>\n  </div>\n</div>',show:function(id,triggerOptions){var modalObject,options,path,renderModal,showModal,showOptions,template;if(null==triggerOptions&&(triggerOptions={}),null!=this.registered[id]&&null!=this.opened)return this.hide();if(null==this.registered[id])return this.waiting={id:id,options:triggerOptions};if(modalObject=this.registered[id],options=modalObject.options,showOptions={},angular.extend(showOptions,options,triggerOptions),showModal=function(_this){return function(element){return showOptions.beforeShow(element.scope()),$animate.removeClass(element,"hide",function(){return $animate.addClass(element,"visible",function(){return _this.opened={id:id,element:element,options:showOptions},_this.resize(_this.opened),_this.bindingEvents(),showOptions.open(element.scope()),showOptions.afterShow(element.scope()),$rootScope.$broadcast("modalWasShown",id),_this.clearWaiting()})})}}(this),null!=showOptions.moduleMethod){if(renderModal=function(_this){return function(template){var element,viewScope,wrapper;return isScope(showOptions.scope)?viewScope=showOptions.scope:(viewScope=$rootScope.$new(!0),angular.isObject(showOptions.scope)&&angular.extend(viewScope,showOptions.scope)),angular.extend(showOptions.attributes,{id:id}),element=angular.element(_this.modalTemplate).attr(showOptions.attributes),wrapper=angular.element(element[0].getElementsByClassName("mac-modal-content-wrapper")),wrapper.html(template),showOptions.overlayClose&&element.bind("click",function($event){return angular.element($event.target).hasClass("mac-modal-overlay")?viewScope.$apply(function(){return _this.hide()}):void 0}),showOptions.controller&&$controller(showOptions.controller,{$scope:viewScope,$element:element,macModalOptions:showOptions}),$animate.enter(element,angular.element(document.body)),$compile(element)(viewScope),showModal(element)}}(this),path=showOptions.templateUrl)return template=$templateCache.get(path),template?renderModal(template):$http.get(path).then(function(resp){return $templateCache.put(path,resp.data),renderModal(resp.data)},function(){throw Error("Failed to load template: "+path)});if(template=showOptions.template)return renderModal(template)}else if(null!=modalObject.element)return showModal(modalObject.element)},resize:function(modalObject){var css,element,height,modal,options,width;return null==modalObject&&(modalObject=this.opened),null!=modalObject&&(element=modalObject.element,options=modalObject.options,options.position)?(modal=angular.element(element[0].getElementsByClassName("mac-modal")).attr("style",""),height=modal.outerHeight(),width=modal.outerWidth(),css=angular.element(window).height()>height?{marginTop:-height/2}:{top:options.topOffset},css.marginLeft=-width/2,angular.forEach(css,function(value,key){return!isNaN(+value)&&angular.isNumber(+value)&&(value=""+value+"px"),modal.css(key,value)})):void 0},hide:function(callback){var element,id,options,_ref;if(null!=this.opened)return _ref=this.opened,id=_ref.id,options=_ref.options,element=_ref.element,options.beforeHide(element.scope()),$animate.removeClass(element,"visible",function(_this){return function(){return _this.bindingEvents("unbind"),_this.opened=null,options.moduleMethod?(isScope(options.scope)||element.scope().$destroy(),$animate.leave(element)):$animate.addClass(element,"hide"),options.afterHide(element.scope()),$rootScope.$broadcast("modalWasHidden",id),callback&&callback()}}(this))},bindingEvents:function(action){var escapeKeyHandler,options,resizeHandler;return null==action&&(action="bind"),"bind"!==action&&"unbind"!==action||null==this.opened?void 0:(escapeKeyHandler=function(_this){return function(event){return event.which===keys.ESCAPE?_this.hide():void 0}}(this),resizeHandler=function(_this){return function(){return _this.resize()}}(this),options=this.opened.options,options.keyboard&&angular.element(document)[action]("keydown",escapeKeyHandler),options.resize?angular.element(window)[action]("resize",resizeHandler):void 0)},register:function(id,element,options){var modalOpts;if(null!=this.registered[id])throw new Error("Modal "+id+" already registered");return modalOpts={},angular.extend(modalOpts,modalViews.defaults,options),this.registered[id]={id:id,element:element,options:modalOpts},null!=this.waiting&&this.waiting.id===id?this.show(id,this.waiting.options):void 0},unregister:function(id){var _ref;if(null==this.registered[id])throw new Error("Modal "+id+" is not registered");return(null!=(_ref=this.opened)?_ref.id:void 0)===id&&this.hide(),this.clearWaiting(id),delete this.registered[id]},clearWaiting:function(id){var _ref;if(null==id||(null!=(_ref=this.waiting)?_ref.id:void 0)===id)return this.waiting=null}}}]).provider("modalViews",function(){return this.registered={},this.defaults={keyboard:!1,overlayClose:!1,resize:!0,position:!0,open:angular.noop,topOffset:20,attributes:{},beforeShow:angular.noop,afterShow:angular.noop,beforeHide:angular.noop,afterHide:angular.noop},this.$get=function(){return this},this}).config(["modalViewsProvider",function(modalViews){return angular.module("Mac").modal=function(id,modalOptions){var options;return null==modalViews.registered[id]?(options={},angular.extend(options,modalViews.defaults,modalOptions,{moduleMethod:!0}),modalViews.registered[id]={id:id,options:options}):void 0}}]),angular.module("Mac").provider("popoverViews",function(){return this.registered={},this.defaults={fixed:!1,childPopover:!1,offsetY:0,offsetX:0,trigger:"click"},this.popoverDefaults={footer:!1,header:!1,title:"",direction:"above left"},this.template='<div class="mac-popover" ng-class="macPopoverClasses">\n  <div class="tip"></div>\n  <div class="popover-header">\n    <div class="title">{{macPopoverTitle}}</div>\n  </div>\n  <div mac-popover-fill-content></div>\n</div>',this.$get=function(){return this},this}).service("popover",["$animate","$compile","$controller","$http","$rootScope","$templateCache","$timeout","popoverViews",function($animate,$compile,$controller,$http,$rootScope,$templateCache,$timeout,popoverViews){var service;return service={popoverList:[],registered:popoverViews.registered,last:function(){return this.popoverList[this.popoverList.length-1]},register:function(id,options){var exist;return(exist=null!=this.registered[id])||(this.registered[id]=options),!exist},unregister:function(id){var exist;return(exist=null!=this.registered[id])&&delete this.registered[id],exist},add:function(id,popover,element,options){var newObject;return newObject={id:id,popover:popover,element:element,options:options},this.popoverList.push(newObject),newObject},pop:function(){return this.popoverList.pop()},show:function(id,element,options){var addPopover,popoverOptions;return null==options&&(options={}),(popoverOptions=this.registered[id])?(addPopover=function(){var path,showPopover,template;return showPopover=function(template){var popover,popoverObj,viewScope;return isScope(options.scope)?viewScope=options.scope.$new():(viewScope=$rootScope.$new(!0),angular.isObject(options.scope)&&angular.extend(viewScope,options.scope)),popoverOptions.refreshOn&&viewScope.$on(popoverOptions.refreshOn,function(){return service.resize(id)}),popoverOptions.controller&&$controller(popoverOptions.controller,{$scope:viewScope}),angular.extend(viewScope,{macPopoverClasses:{footer:popoverOptions.footer||!1,header:popoverOptions.header||!!popoverOptions.title||!1,fixed:popoverOptions.fixed||!1},macPopoverTitle:popoverOptions.title||"",macPopoverTemplate:template}),popover=$compile(popoverViews.template)(viewScope),popover.attr({id:id,direction:popoverOptions.direction||"below left"}),popoverObj=service.add(id,popover,element,options),$animate.addClass(element,"active"),$rootScope.$broadcast("popoverWasShown",id),$animate.enter(popover,angular.element(document.body),null,function(){return service.resize(popoverObj)})},(template=popoverOptions.template)?showPopover(template):(path=popoverOptions.templateUrl)?(template=$templateCache.get(path),template?showPopover(template):$http.get(path).then(function(resp){return $templateCache.put(path,resp.data),showPopover(resp.data)},function(){throw new Error("Failed to load template: #{path}")})):void 0},service.popoverList.length&&!options.childPopover?service.hide(addPopover):addPopover(),!0):!1},getById:function(id,element){var item,sameTrigger,_i,_len,_ref;for(_ref=this.popoverList,_i=0,_len=_ref.length;_len>_i;_i++)if(item=_ref[_i],sameTrigger=null==element||item.element===element,item.id===id&&sameTrigger)return item},resize:function(popoverObj){var $window,action,current,currentPopover,diff,left,leftScroll,offset,options,position,relative,relativeElement,setOverflowPosition,top,topScroll,updateOffset;return angular.isString(popoverObj)&&(popoverObj=service.getById(popoverObj)),null!=popoverObj?(currentPopover=popoverObj.popover,relativeElement=popoverObj.element,options=popoverObj.options,$window=angular.element(window),offset=relativeElement.offset(),options.fixed&&(offset.top=relativeElement.position().top),relative={height:relativeElement.outerHeight(),width:relativeElement.outerWidth()},current={height:currentPopover.outerHeight(),width:currentPopover.outerWidth()},top=0,left=0,position=(currentPopover.attr("direction")||"top left").trim(),setOverflowPosition=function(offset){var tip,tipOffset;return null==offset&&(offset=0),tip=angular.element(currentPopover[0].getElementsByClassName("tip")),top-=offset,tipOffset=+tip.css("margin-top").replace("px",""),tip.css("margin-top",tipOffset+offset)},updateOffset=function(){switch(position){case"above left":return top=-(current.height+10),left=-25+relative.width/2;case"above right":return top=-(current.height+10),left=25+relative.width/2-current.width;case"below left":return top=relative.height+10,left=-25+relative.width/2;case"below right":return top=relative.height+10,left=25+relative.width/2-current.width;case"middle right":return top=relative.height/2-current.height/2,left=relative.width+10;case"middle left":return top=relative.height/2-current.height/2,left=-(current.width+10)}},updateOffset(),topScroll=options.fixed?0:$window.scrollTop(),leftScroll=options.fixed?0:$window.scrollLeft(),action={},-1===position.indexOf("middle")?offset.top+top-topScroll<0?action={remove:"above",add:"below"}:offset.top+top+current.height-topScroll>$window.height()&&(action={remove:"below",add:"above"}):(diff=offset.top+top-topScroll)<0?setOverflowPosition(diff):(diff=offset.top+top+currentPopover.outerHeight()-topScroll-$window.height())>0&&setOverflowPosition(diff),action.remove&&action.add&&(position=position.replace(action.remove,action.add)),action={},offset.left+left-leftScroll<0?action={remove:"right",add:"left"}:offset.left+left+currentPopover.outerWidth()-leftScroll>$window.width()&&(action={remove:"left",add:"right"}),action.remove&&action.add&&(position=position.replace(action.remove,action.add)),updateOffset(),offset.top+=top,offset.left+=left,null!=options.offsetX&&(offset.left+=options.offsetX),null!=options.offsetY&&(offset.top+=options.offsetY),angular.forEach(offset,function(value,key){return isNaN(+value)||(value=""+value+"px"),currentPopover.css(key,value)}),currentPopover.addClass("visible "+position)):void 0},hide:function(selector,callback){var comparator,i,index,popoverObj,removeScope,_i,_ref;if(!this.popoverList.length)return"function"==typeof callback?callback():void 0;if(angular.isFunction(selector)&&(callback=selector,selector=null),null!=selector){for(comparator=angular.isString(selector)?function(item){return item.id===selector}:angular.isElement(selector)?function(item){return item.element===selector}:void 0,index=-1,i=_i=_ref=this.popoverList.length-1;_i>=0;i=_i+=-1)if(comparator(this.popoverList[i])){popoverObj=this.popoverList[i],index=i;break}index>-1&&this.popoverList.splice(index,1)}else popoverObj=this.pop();return null!=popoverObj?($rootScope.$broadcast("popoverBeforeHide",popoverObj.id),removeScope=popoverObj.popover.scope(),$animate.leave(popoverObj.popover,function(){return $animate.removeClass(popoverObj.element,"active"),$rootScope.$broadcast("popoverWasHidden",popoverObj.id),removeScope.$destroy(),"function"==typeof callback?callback():void 0})):void 0},hideAll:function(){for(;this.popoverList.length;)this.hide()}}}]).config(["popoverViewsProvider",function(popoverViews){return angular.module("Mac").popover=function(name,options){var opts;return null==popoverViews.registered[name]?(opts={},angular.extend(opts,popoverViews.popoverDefaults,options,{id:name}),popoverViews.registered[name]=opts):void 0}}]),angular.module("Mac").directive("macModal",["$parse","modal","modalViews","util",function($parse,modal,modalViews,util){return{restrict:"E",template:modal.modalTemplate,replace:!0,transclude:!0,link:function($scope,element,attrs,controller,transclude){var callback,key,opts,regId,registerModal,_i,_len,_ref;for(transclude($scope,function(clone){return angular.element(element[0].getElementsByClassName("mac-modal-content-wrapper")).replaceWith(clone)}),opts=util.extendAttributes("macModal",modalViews.defaults,attrs),regId=null,opts.overlayClose&&element.on("click",function($event){return angular.element($event.target).hasClass("mac-modal-overlay")?$scope.$apply(function(){return modal.hide()}):void 0}),_ref=["beforeShow","afterShow","beforeHide","afterHide","open"],_i=0,_len=_ref.length;_len>_i;_i++)callback=_ref[_i],key="macModal"+util.capitalize(callback),opts[callback]=$parse(attrs[key])||angular.noop;return registerModal=function(id){return null!=id&&id?(regId=id,modal.register(id,element,opts)):void 0},attrs.id?registerModal(attrs.id):attrs.$observe("macModal",function(id){return registerModal(id)}),$scope.$on("$destroy",function(){return regId?modal.unregister(regId):void 0})}}}]).directive("macModal",["$parse","modal",function($parse,modal){return{restrict:"A",link:function($scope,element,attrs){attrs.macModal&&element.bind("click",function(){return $scope.$apply(function(){var data;return data=$parse(attrs.macModalData)($scope)||{},modal.show(attrs.macModal,{data:data,scope:$scope})})})}}}]).directive("macModalClose",["modal",function(modal){return{restrict:"A",link:function($scope,element){return element.bind("click",function(){return $scope.$apply(function(){return modal.hide()})})}}}]);var __indexOf=[].indexOf||function(item){for(var i=0,l=this.length;l>i;i++)if(i in this&&this[i]===item)return i;return-1};angular.module("Mac").directive("macPopover",["$timeout","popover","util","popoverViews",function($timeout,popover,util,popoverViews){return{restrict:"A",link:function(scope,element,attrs){var clearDelays,closeDelayId,delayId,exclude,excludeList,hide,options,show;return options=util.extendAttributes("macPopover",popoverViews.defaults,attrs),exclude=attrs.macPopoverExclude||"",excludeList=exclude?exclude.split(","):[],delayId=null,closeDelayId=null,clearDelays=function(){return null!=delayId&&$timeout.cancel(delayId),null!=closeDelayId?$timeout.cancel(closeDelayId):void 0},show=function(id,delay){return null==delay&&(delay=0),clearDelays(),delayId=$timeout(function(){var last,_ref;return last=popover.last(),null!=last&&(!excludeList.length||(_ref=last.id,__indexOf.call(excludeList,_ref)>=0)||last.id===id)&&(popover.hide(),element[0]===last.element[0])?!0:(options.scope=scope,popover.show(id,element,options))},delay),!0},hide=function(element,delay){return null==delay&&(delay=0),clearDelays(),closeDelayId=$timeout(function(){return popover.hide(element)},delay)},attrs.$observe("macPopover",function(id){var hideEvent,showEvent;if(id)return"click"===options.trigger?element.bind("click",function(){return show(id,0)}):(showEvent="focus"===options.trigger?"focusin":"mouseenter",hideEvent="focus"===options.trigger?"focusout":"mouseleave",element.bind(showEvent,function(){return show(id,400)}),element.bind(hideEvent,function(){return hide(element,500)}))})}}}]).directive("macPopover",["popover","popoverViews","util",function(popover,popoverViews,util){return{restrict:"E",compile:function(element,attrs){var opts;if(!attrs.id)throw Error("macPopover: Missing id");return opts=util.extendAttributes("macPopover",popoverViews.popoverDefaults,attrs),angular.extend(opts,{template:element.html()}),element.replaceWith(document.createComment("macPopover: "+attrs.id)),function($scope,element,attrs){return attrs.$observe("id",function(value){return popover.register(value,opts)})}}}}]).directive("macPopoverFillContent",["$compile",function($compile){return{restrict:"A",link:function($scope,element){return element.html($scope.macPopoverTemplate),$compile(element.contents())($scope)}}}]),angular.module("Mac").directive("macPlaceholder",function(){return{restrict:"A",link:function($scope,element,attrs){return $scope.$watch(attrs.macPlaceholder,function(value){return attrs.$set("placeholder",value)})}}}),angular.module("Mac").service("scrollSpy",[function(){return{registered:[],active:{},listeners:[],register:function(id,element){var anchor,i,registered,top,_i,_len,_ref;for(registered=!1,top=element.offset().top,_ref=this.registered,i=_i=0,_len=_ref.length;_len>_i;i=++_i)if(anchor=_ref[i],anchor.id===id){this.registered[i]={id:id,element:element,top:top},registered=!0;break}return registered||this.registered.push({id:id,element:element,top:top}),this.registered.sort(function(a,b){return a.top>b.top?1:a.top<b.top?-1:0})},unregister:function(id){var anchor,i,_i,_len,_ref,_ref1,_results;for(_ref=this.registered,_results=[],i=_i=0,_len=_ref.length;_len>_i;i=++_i)if(anchor=_ref[i],anchor.id===id){[].splice.apply(this.registered,[i,i-i+1].concat(_ref1=[])),_ref1;break}return _results},last:function(){return this.registered[this.registered.length-1]},setActive:function(anchor){var listener,_i,_len,_ref,_results;for(this.active=anchor,_ref=this.listeners,_results=[],_i=0,_len=_ref.length;_len>_i;_i++)listener=_ref[_i],_results.push(listener(anchor));return _results},addListener:function(fn){return this.listeners.push(fn)},removeListener:function(fn){var index,_ref;return index=this.listeners.indexOf(fn),-1!==index?([].splice.apply(this.listeners,[index,index-index+1].concat(_ref=[])),_ref):void 0}}}]).constant("scrollSpyDefaults",{offset:0}),angular.module("Mac").directive("macScrollSpy",["$window","scrollSpy","scrollSpyDefaults","util",function($window,scrollSpy,defaults,util){return{link:function($scope,element,attrs){var options,spyElement;return options=util.extendAttributes("macScrollSpy",defaults,attrs),spyElement="BODY"===element[0].tagName?angular.element($window):element,spyElement.bind("scroll",function(){var anchors,i,maxScroll,scrollHeight,scrollTop,_i,_ref;if(scrollTop=spyElement.scrollTop()+options.offset,scrollHeight=this.scrollHeight||element[0].scrollHeight,maxScroll=scrollHeight-spyElement.height(),!scrollSpy.registered.length)return!0;if(scrollTop>=maxScroll)return scrollSpy.setActive(scrollSpy.last());for(i=_i=0,_ref=scrollSpy.registered.length-1;_ref>=0?_ref>=_i:_i>=_ref;i=_ref>=0?++_i:--_i)if(anchors=scrollSpy.registered,scrollSpy.active.id!==anchors[i].id&&scrollTop>=anchors[i].top&&(!anchors[i+1]||scrollTop<=anchors[i+1].top))return $scope.$apply(function(){return scrollSpy.setActive(anchors[i])}),!0})}}}]).directive("macScrollSpyAnchor",["scrollSpy",function(scrollSpy){return{link:function($scope,element,attrs){var id,observeKey,registered,registering;if(id=attrs.id||attrs.macScrollSpyAnchor,registered=!1,!id)throw new Error("Missing scroll spy anchor id");return registering=function(){return scrollSpy.register(id,element),registered||$scope.$on("$destroy",function(){return scrollSpy.unregister(id)}),registered=!0},$scope.$on("refresh-scroll-spy",registering),/{{(.*)}}/.test(id)?(observeKey=attrs.id?"id":"macScrollSpyAnchor",attrs.$observe(observeKey,function(value){return null!=value&&value?(id=value,registering()):void 0})):registering()}}}]).directive("macScrollSpyTarget",["scrollSpy",function(scrollSpy){return{link:function($scope,element,attrs){var highlightClass,register,registered,target;if(target=attrs.macScrollSpyTarget,highlightClass=attrs.macScrollSpyTargetClass||"active",registered=!1,!target)throw new Error("Missing scroll spy target name");return register=function(id){var callback;if(id)return callback=function(active){var action;return action=id===active.id?"addClass":"removeClass",element[action](highlightClass)},null!=scrollSpy.active&&callback(scrollSpy.active),registered?void 0:(scrollSpy.addListener(callback),$scope.$on("$destroy",function(){return scrollSpy.removeListener(callback)}))},/{{(.*)}}/.test(target)?attrs.$observe("macScrollSpyTarget",function(value){return register(value)}):register(target)}}}]),angular.module("Mac").directive("macAffix",["$document","$window",function($document,$window){return{link:function($scope,element,attrs){var defaults,disabled,getPinnedOffset,lastAffix,offset,pinnedOffset,scrollEvent,setOffset,unpin,windowEl;return defaults={top:0,bottom:0,disabled:!1,classes:"affix affix-top affix-bottom"},offset={top:defaults.top,bottom:defaults.bottom},disabled=defaults.disabled,lastAffix=null,unpin=null,pinnedOffset=null,windowEl=angular.element($window),setOffset=function(key,value,useDefault){return null==useDefault&&(useDefault=!1),useDefault&&null==value&&(value=defaults[key]),null==value||isNaN(+value)?void 0:offset[key]=+value},null!=attrs.macAffixTop&&(setOffset("top",$scope.$eval(attrs.macAffixTop),!0),$scope.$watch(attrs.macAffixTop,function(value){return setOffset("top",value)})),null!=attrs.macAffixBottom&&(setOffset("bottom",$scope.$eval(attrs.macAffixBottom),!0),$scope.$watch(attrs.macAffixBottom,function(value){return setOffset("bottom",value)})),getPinnedOffset=function(){var scrollHeight;return null!=pinnedOffset?pinnedOffset:(element.removeClass(defaults.classes).addClass("affix"),scrollHeight=$document.height(),pinnedOffset=scrollHeight-element.outerHeight()-offset.bottom)},scrollEvent=function(){var affix,curOffset,elementHeight,position,scrollHeight,scrollTop;if(!(element[0].offsetHeight<=0&&element[0].offsetWidth<=0)&&(position=element.offset(),scrollTop=windowEl.scrollTop(),scrollHeight=$document.height(),elementHeight=element.outerHeight(),affix=null!=unpin&&unpin>=scrollTop?!1:null!=offset.bottom&&scrollTop>scrollHeight-elementHeight-offset.bottom?"bottom":null!=offset.top&&scrollTop<=offset.top?"top":!1,affix!==lastAffix))return unpin&&element.css("top",""),lastAffix=affix,unpin="bottom"===affix?getPinnedOffset():null,element.removeClass(defaults.classes).addClass("affix"+(affix?"-"+affix:"")),"bottom"===affix&&(curOffset=element.offset(),element.css("top",unpin-curOffset.top)),!0},null!=attrs.macAffixDisabled&&(disabled=$scope.$eval(attrs.macAffixDisabled)||defaults.disabled,$scope.$watch(attrs.macAffixDisabled,function(value){var action;if(null!=value&&value!==disabled)return disabled=value,action=value?"unbind":"bind",windowEl[action]("scroll",scrollEvent),disabled?(lastAffix=null,unpin=null,element.css("top","").removeClass(defaults.classes)):scrollEvent()})),disabled||windowEl.bind("scroll",scrollEvent),$scope.$on("refresh-mac-affix",function(){var position;return position=element.offset()}),$scope.$on("$destroy",function(){return windowEl.unbind("scroll",scrollEvent)})}}}]),angular.module("Mac").directive("macSpinner",["util",function(util){return{restrict:"E",replace:!0,template:'<div class="mac-spinner"></div>',compile:function(element){var animateCss,bar,degree,delay,i,prefixes,styl,transformCss,vendor,_i;for(prefixes=["webkit","Moz","ms","O"],vendor=function(el,name){var prefix,_i,_len;for(name=util.capitalize(name),_i=0,_len=prefixes.length;_len>_i;_i++)if(prefix=prefixes[_i],null!=el.style[prefix+name])return prefix+name;return name},animateCss=vendor(element[0],"animation"),transformCss=vendor(element[0],"transform"),i=_i=0;9>=_i;i=++_i)delay=.1*i-1+!i,degree=36*i,styl={},bar=angular.element('<div class="bar"></div>'),styl[animateCss]="fade 1s linear infinite "+delay+"s",styl[transformCss]="rotate("+degree+"deg) translate(0, 130%)",bar.css(styl),element.append(bar);return function($scope,element,attrs){var bars,defaults,setSpinnerSize;return defaults={size:16,zIndex:"inherit",color:"#2f3035"},bars=angular.element(element[0].getElementsByClassName("bar")),setSpinnerSize=function(size){return bars.css({height:.32*size+"px",left:.445*size+"px",top:.37*size+"px",width:.13*size+"px",borderRadius:.32*size*2+"px",position:"absolute"}),!isNaN(+size)&&angular.isNumber(+size)&&(size=""+size+"px"),element.css({height:size,width:size})},null!=attrs.macSpinnerSize?attrs.$observe("macSpinnerSize",function(value){return null!=value&&value?setSpinnerSize(value):void 0}):setSpinnerSize(defaults.size),attrs.$observe("macSpinnerZIndex",function(value){return null!=value&&value?element.css("z-index",value):void 0}),null!=attrs.macSpinnerColor?attrs.$observe("macSpinnerColor",function(value){return null!=value&&value?bars.css("background",value):void 0}):bars.css("background",defaults.color)}}}}]);var __indexOf=[].indexOf||function(item){for(var i=0,l=this.length;l>i;i++)if(i in this&&this[i]===item)return i;return-1};angular.module("Mac").directive("macTagAutocomplete",["$parse","$timeout","keys","util",function($parse,$timeout,keys,util){return{restrict:"E",template:'<div ng-click="focusTextInput()" class="mac-tag-autocomplete"><ul class="mac-tag-list"><li ng-repeat="tag in selected" class="mac-tag mac-label"><div ng-click="selected.splice($index, 1)" class="mac-tag-close">&times;</div><span class="tag-label">{{getTagLabel(tag)}}</span></li><li ng-class="{\'fullwidth\': !selected.length}" class="mac-tag mac-input-tag"><mac-autocomplete ng-model="textInput" mac-autocomplete-disabled="disabled" mac-autocomplete-on-select="onSelect(selected)" mac-autocomplete-on-success="onSuccess(data)" mac-placeholder="autocompletePlaceholder" ng-keydown="onKeyDown($event)" class="text-input mac-autocomplete"></mac-autocomplete></li></ul></div>',replace:!0,priority:800,scope:{url:"=macTagAutocompleteUrl",placeholder:"=macTagAutocompletePlaceholder",selected:"=macTagAutocompleteSelected",source:"=macTagAutocompleteSource",disabled:"=macTagAutocompleteDisabled",model:"=macTagAutocompleteModel",onEnter:"&macTagAutocompleteOnEnter",onKeydown:"&macTagAutocompleteOnKeydown"},compile:function(element,attrs){var attrsObject,delay,labelGetter,labelKey,queryKey,textInput,useSource,valueGetter,valueKey;
return valueKey=attrs.macTagAutocompleteValue,null==valueKey&&(valueKey="id"),valueGetter=$parse(valueKey),labelKey=attrs.macTagAutocompleteLabel,null==labelKey&&(labelKey="name"),labelGetter=$parse(labelKey),queryKey=attrs.macTagAutocompleteQuery||"q",delay=+attrs.macTagAutocompleteDelay||800,useSource=!1,textInput=angular.element(element[0].getElementsByClassName("mac-autocomplete")),attrsObject={"mac-autocomplete-label":labelKey,"mac-autocomplete-query":queryKey,"mac-autocomplete-delay":delay},null!=attrs.macTagAutocompleteUrl?attrsObject["mac-autocomplete-url"]="url":(useSource=null!=attrs.macTagAutocompleteSource)&&(attrsObject["mac-autocomplete-source"]="autocompleteSource"),textInput.attr(attrsObject),function($scope,element,attrs){var updateAutocompleteSource,watchFn;return $scope.textInput="",$scope.autocompleteSource=angular.isArray($scope.source)?[]:$scope.source,null!=attrs.macTagAutocompleteModel&&($scope.$watch("textInput",function(value){return $scope.model=value}),$scope.$watch("model",function(value){return $scope.textInput=value})),$scope.focusTextInput=function(){var textInputDOM;return textInputDOM=element[0].getElementsByClassName("mac-autocomplete"),textInputDOM[0].focus()},$scope.getTagLabel=function(tag){return labelKey?labelGetter(tag):tag},$timeout(function(){var capitalized,eventFn,events,name,_i,_len,_ref,_results;if(events=attrs.macTagAutocompleteEvents){for(textInput=angular.element(element[0].getElementsByClassName("text-input")),_ref=events.split(","),_results=[],_i=0,_len=_ref.length;_len>_i;_i++)name=_ref[_i],name=util.trim(name),capitalized=util.capitalize(name),eventFn=attrs["macTagAutocompleteOn"+capitalized],eventFn&&"keydown"!==name&&_results.push(function(name,eventFn){return textInput.bind(name,function($event){var expression;return expression=$parse(eventFn),$scope.$apply(function(){return expression($scope.$parent,{$event:$event,item:$scope.textInput})})})}(name,eventFn));return _results}},0,!1),updateAutocompleteSource=function(){var difference,item,selectedValues,sourceValues,_ref;return $scope.autocompletePlaceholder=(null!=(_ref=$scope.selected)?_ref.length:void 0)?"":$scope.placeholder,useSource&&angular.isArray($scope.source)?(sourceValues=function(){var _i,_len,_ref1,_results;for(_ref1=$scope.source||[],_results=[],_i=0,_len=_ref1.length;_len>_i;_i++)item=_ref1[_i],_results.push(valueGetter(item));return _results}(),selectedValues=function(){var _i,_len,_ref1,_results;for(_ref1=$scope.selected||[],_results=[],_i=0,_len=_ref1.length;_len>_i;_i++)item=_ref1[_i],_results.push(valueGetter(item));return _results}(),difference=function(){var _i,_len,_results;for(_results=[],_i=0,_len=sourceValues.length;_len>_i;_i++)item=sourceValues[_i],__indexOf.call(selectedValues,item)<0&&_results.push(item);return _results}(),$scope.autocompleteSource=function(){var _i,_len,_ref1,_ref2,_results;for(_ref1=$scope.source||[],_results=[],_i=0,_len=_ref1.length;_len>_i;_i++)item=_ref1[_i],_ref2=valueGetter(item),__indexOf.call(difference,_ref2)>=0&&_results.push(item);return _results}()):void($scope.autocompleteSource=$scope.source)},useSource&&(watchFn=angular.isArray($scope.source)?"$watchCollection":"$watch",$scope[watchFn]("source",updateAutocompleteSource)),$scope.$watchCollection("selected",updateAutocompleteSource),$scope.onKeyDown=function($event){var stroke,_base;switch(stroke=$event.which||$event.keyCode){case keys.BACKSPACE:$scope.textInput||"function"==typeof(_base=$scope.selected).pop&&_base.pop();break;case keys.ENTER:$scope.textInput.length>0&&$scope.disabled&&$scope.onSelect($scope.textInput)}return null!=attrs.macTagAutocompleteOnKeydown&&"function"==typeof $scope.onKeydown&&$scope.onKeydown({$event:$event,value:$scope.textInput}),!0},$scope.onSuccess=function(data){var existingValues,item;return existingValues=function(){var _i,_len,_ref,_results;for(_ref=$scope.selected||[],_results=[],_i=0,_len=_ref.length;_len>_i;_i++)item=_ref[_i],_results.push(valueGetter(item));return _results}(),function(){var _i,_len,_ref,_ref1,_results;for(_ref=data.data,_results=[],_i=0,_len=_ref.length;_len>_i;_i++)item=_ref[_i],_ref1=valueGetter(item)||item,__indexOf.call(existingValues,_ref1)<0&&_results.push(item);return _results}()},$scope.onSelect=function(item){return null!=attrs.macTagAutocompleteOnEnter&&(item=$scope.onEnter({item:item})),item&&$scope.selected.push(item),$timeout(function(){return $scope.textInput=""},0)},$scope.$on("mac-tag-autocomplete-clear-input",function(){return $scope.textInput=""})}}}}]),angular.module("Mac").directive("macTime",["$filter","$timeout","keys","util",function($filter,$timeout,keys,util){var defaults;return defaults={"default":"12:00 AM"},{restrict:"E",require:"ngModel",replace:!0,template:'<input type="text" maxlength="8" class="mac-date-time"/>',link:function($scope,element,attrs,ngModelCtrl){var getSelection,incrementHour,incrementMinute,initializeTime,opts,selectHours,selectMeridian,selectMinutes,selectNextSection,selectPreviousSection,selectRange,setMeridian,time,timeValidator,toggleMeridian,updateInput,updateTime;return opts=util.extendAttributes("macTime",defaults,attrs),time=null,attrs.placeholder||attrs.$set("placeholder","--:--"),timeValidator=function(value){return!value||util.timeRegex.exec(value)?(ngModelCtrl.$setValidity("time",!0),value):void ngModelCtrl.$setValidity("time",!1)},ngModelCtrl.$formatters.push(timeValidator),ngModelCtrl.$parsers.push(timeValidator),(initializeTime=function(){var currentDate;return currentDate=(new Date).toDateString(),time=new Date(currentDate+" "+opts["default"]),isNaN(time.getTime())?time=new Date(currentDate+" "+defaults["default"]):void 0})(),getSelection=function(){var start;switch(start=element[0].selectionStart,!1){case!(start>=0&&3>start):return"hour";case!(start>=3&&6>start):return"minute";case!(start>=6&&9>start):return"meridian"}},selectRange=function(start,end){return $timeout(function(){return element[0].setSelectionRange(start,end)},0,!1)},selectHours=function(){return selectRange(0,2)},selectMinutes=function(){return selectRange(3,5)},selectMeridian=function(){return selectRange(6,8)},selectNextSection=function(){switch(getSelection()){case"hour":return selectMinutes();case"minute":case"meridian":return selectMeridian()}},selectPreviousSection=function(){switch(getSelection()){case"hour":case"minute":return selectHours();case"meridian":return selectMinutes()}},setMeridian=function(meridian){var hours;return hours=time.getHours(),hours>=12&&"AM"===meridian&&(hours-=12),12>hours&&"PM"===meridian&&(hours+=12),time.setHours(hours)},toggleMeridian=function(){var hours;return hours=time.getHours(),time.setHours((hours+12)%24)},incrementHour=function(change){return time.setHours(time.getHours()+change)},incrementMinute=function(change){return time.setMinutes(time.getMinutes()+change)},updateInput=function(){var displayTime;return displayTime=$filter("date")(time.getTime(),"hh:mm a"),displayTime!==ngModelCtrl.$viewValue?(ngModelCtrl.$setViewValue(displayTime),ngModelCtrl.$render()):void 0},updateTime=function(){var hours,meridian,minutes,timeMatch;return(timeMatch=util.timeRegex.exec(ngModelCtrl.$modelValue))?(hours=+timeMatch[1],minutes=+timeMatch[2],meridian=timeMatch[3],"PM"===meridian&&12!==hours&&(hours+=12),"AM"===meridian&&12===hours&&(hours=0),time.setHours(hours,minutes)):void 0},element.on("blur",function(){return $scope.$apply(function(){return updateInput()})}),element.on("click",function(){return $scope.$apply(function(){switch(updateTime(),updateInput(),getSelection()){case"hour":return selectHours();case"minute":return selectMinutes();case"meridian":return selectMeridian()}})}),element.on("keydown",function(event){var key;return key=event.which,key!==keys.UP&&key!==keys.DOWN&&key!==keys.LEFT&&key!==keys.RIGHT&&key!==keys.A&&key!==keys.P?!0:(event.preventDefault(),$scope.$apply(function(){var change,meridianSelected;switch(key){case keys.UP:case keys.DOWN:switch(change=key===keys.UP?1:-1,getSelection()){case"hour":incrementHour(change),selectHours();break;case"minute":incrementMinute(change),selectMinutes();break;case"meridian":toggleMeridian(),selectMeridian()}return updateInput();case keys.LEFT:case keys.RIGHT:switch(key){case keys.LEFT:selectPreviousSection();break;case keys.RIGHT:selectNextSection()}return updateInput();case keys.A:case keys.P:switch(meridianSelected="meridian"===getSelection(),!1){case!(meridianSelected&&key===keys.A):setMeridian("AM");break;case!(meridianSelected&&key===keys.P):setMeridian("PM")}return updateInput(),selectMeridian()}}))}),element.on("keyup",function(event){var key;return key=event.which,keys.NUMPAD0<=key&&key<=keys.NUMPAD9||keys.ZERO<=key&&key<=keys.NINE||event.preventDefault(),$scope.$apply(function(){return updateTime()})})}}}]),angular.module("Mac").directive("macTooltip",["$timeout","util",function($timeout,util){return{restrict:"A",link:function(scope,element,attrs){var defaults,disabled,enabled,opts,removeTip,showTip,text,toggle,tooltip;return tooltip=null,text="",enabled=!1,disabled=!1,defaults={direction:"top",trigger:"hover",inside:!1},opts=util.extendAttributes("macTooltip",defaults,attrs),showTip=function(){var elementSize,offset,tip,tooltipSize;if(disabled||!text)return!0;switch(tip=opts.inside?element:angular.element(document.body),removeTip(0),tooltip=angular.element('<div class="mac-tooltip '+opts.direction+'"><div class="tooltip-message">'+text+"</div></div>"),tip.append(tooltip),offset=opts.inside?{top:0,left:0}:element.offset(),elementSize={width:element.outerWidth(),height:element.outerHeight()},tooltipSize={width:tooltip.outerWidth(),height:tooltip.outerHeight()},opts.direction){case"bottom":case"top":offset.left+=elementSize.width/2-tooltipSize.width/2;break;case"left":case"right":offset.top+=elementSize.height/2-tooltipSize.height/2}switch(opts.direction){case"bottom":offset.top+=elementSize.height;break;case"top":offset.top-=tooltipSize.height;break;case"left":offset.left-=tooltipSize.width;break;case"right":offset.left+=elementSize.width}return offset.top=Math.max(0,offset.top),offset.left=Math.max(0,offset.left),angular.forEach(offset,function(value,key){return!isNaN(+value)&&angular.isNumber(+value)&&(value=""+value+"px"),tooltip.css(key,value)}),tooltip.addClass("visible"),!0},removeTip=function(delay){return null==delay&&(delay=100),null!=tooltip&&(tooltip.removeClass("visible"),$timeout(function(){return null!=tooltip&&tooltip.remove(),tooltip=null},delay,!1)),!0},toggle=function(){return null!=tooltip?removeTip():showTip()},attrs.$observe("macTooltip",function(value){var _ref;if(null!=value&&(text=value,!enabled)){if("hover"!==(_ref=opts.trigger)&&"click"!==_ref)throw"Invalid trigger";switch(opts.trigger){case"click":element.bind("click",toggle);break;case"hover":element.bind("mouseenter",showTip),element.bind("mouseleave click",function(){return removeTip()})}return enabled=!0}}),null!=attrs.macTooltipDisabled&&scope.$watch(attrs.macTooltipDisabled,function(value){return disabled=value}),scope.$on("$destroy",function(){return null!=tooltip?removeTip(0):void 0})}}}])}(window,window.angular);var wonderlandApp=angular.module("wonderlandApp",["Mac","masonry","oc.modal"]);wonderlandApp.config(["$provide",function($provide){$provide.decorator("$rootScope",["$delegate",function($delegate){return Object.defineProperty($delegate.constructor.prototype,"$onRootScope",{value:function(name,listener){var unsubscribe=$delegate.$on(name,listener);return this.$on("$destroy",unsubscribe),unsubscribe},enumerable:!1}),$delegate}])}]),wonderlandApp.run(["$rootScope","$ocModal","$window",function($rootScope,$ocModal,$window){$rootScope.currentPageUrl=$window.location.href,$rootScope.openPageModal=function(partial,modalId,initVars){if(partial){var modal={url:partial,init:initVars};modalId&&(modal.id=modalId),$ocModal.open(modal)}},$rootScope.closePageModal=function(){$ocModal.close()},moment.fn.toASP=function(){return"/Date("+ +this+")/"}}]),wonderlandApp.controller("FaqsCtrl",["$scope",function($scope){$scope.toggleFaq=function(target){$scope[target]=!$scope[target]}}]),wonderlandApp.controller("PageCtrl",["debounce","paf","$rootScope","$scope","$timeout","$window",function(debounce,paf,$rootScope,$scope,$timeout,$window){$scope.pageHeaderCompress=!1,$scope.pageShowingSideNavMenu=!1,$scope.pageShowingSideAccountMenu=!1,$scope.pageProfile={image:null},$scope.pageFeedback={profileImageProcessing:!1,profileImageShowSuccess:!1,profileImageShowError:!1};var scrollCheckLimit=50,runScrollCheck=function(){var diff=angular.element($window).scrollTop()>scrollCheckLimit&&!$scope.pageHeaderCompress||angular.element($window).scrollTop()<=scrollCheckLimit&&$scope.pageHeaderCompress;diff&&($scope.$$phase?updateCompressValue():$scope.$apply(updateCompressValue))},updateCompressValue=function(){$scope.pageHeaderCompress=angular.element($window).scrollTop()>scrollCheckLimit};runScrollCheck(),angular.element($window).bind("scroll",runScrollCheck),$scope.onPageLoadProfileImage=function(profileImageData){$scope.pageProfile.image=angular.fromJson(profileImageData)},$scope.$onRootScope("profileImageUploadStart",function(){$timeout(function(){$scope.pageFeedback.profileImageProcessing=!0})}),$scope.$onRootScope("profileImageUpdated",function(event,response){$timeout(function(){$scope.pageFeedback.profileImageProcessing=!1,response&&response.Success===!0?($scope.pageProfile.image=angular.fromJson(response.Message),$scope.pageFeedback.profileImageShowSuccess=!0):$scope.pageFeedback.profileImageShowError=!0,$timeout(function(){$scope.pageFeedback.profileImageShowSuccess=!1,$scope.pageFeedback.profileImageShowError=!1},5e3)})}),$scope.isExternalLink=function(url){return 0===url.indexOf("http")},$scope.$on("formToken",function(event,token){$scope.$broadcast("requestVerificationToken",token)}),$rootScope.hardcodedFundraisingTargets=[{imageUrl:"/img/sunnies.png",title:"Raise £180 or more",info:"Sunglasses are essential Wonderland accessories - look cool as an alpine stream!"},{imageUrl:"/img/tee.png",title:"Raise £250 or more",info:"Also get a T-Shirt, specifically designed for Macmillan's Wonderland."},{imageUrl:"/img/mystery.png",title:"Raise £400 or more",info:"On top of the sunnies and t-shirt, be entered into the prize draw to win a ski-tastic prize."}]}]),wonderlandApp.controller("PartyCtrl",["$filter","$ocModal","$rootScope","$sce","$scope","$timeout",function($filter,$ocModal,$rootScope,$sce,$scope,$timeout){$scope.partyCopyData=null,$scope.partyCopyDataForForm=null,$scope.partyCopyDataFeedback={},$scope.partyCopyDataInit=function(partyCopyData){$scope.partyCopyData=partyCopyData,$scope.partyCopyDataForForm=angular.copy($scope.partyCopyData),$scope.partyCopyData.CopyHtmlSafe=$sce.trustAsHtml($scope.partyCopyData.Copy)},$scope.$onRootScope("partyCopyDataUpdated",function(event,response,dataObject){$scope.partyCopyDataFeedback.processing=!1,$scope.partyCopyDataInit(dataObject),$ocModal.close("partyCopyModal")}),$scope.$onRootScope("partyCopyDataErrored",function(){$scope.partyCopyDataFeedback.processing=!1,$scope.partyCopyDataFeedback.showNetworkError=!0,$timeout(function(){$scope.partyCopyDataFeedback.showNetworkError=!1},5e3)}),$scope.partyDetailsData=null,$scope.partyDetailsFormattedAddress=null,$scope.partyDetailsDataForForm=null,$scope.partyDetailsDataFeedback={},$scope.partyDetailsDataInit=function(partyDetailsData){angular.forEach(partyDetailsData,function(value,key){partyDetailsData[key]="null"===value?null:value}),partyDetailsData&&partyDetailsData.PartyDateTime&&(partyDetailsData.PartyDateTime=moment(partyDetailsData.PartyDateTime).format("YYYY/MM/DD HH:mm:SS"));var address=[];partyDetailsData.Address1&&address.push(partyDetailsData.Address1),partyDetailsData.Address2&&address.push(partyDetailsData.Address2),partyDetailsData.TownCity&&address.push(partyDetailsData.TownCity),partyDetailsData.Postcode&&address.push(partyDetailsData.Postcode),$scope.partyDetailsFormattedAddress=$filter("addressJoiner")(address.join(":~:"),":~:"),$scope.partyDetailsData=partyDetailsData,$scope.partyDetailsDataForForm=angular.copy($scope.partyDetailsData)},$scope.$onRootScope("partyDetailsDataUpdated",function(event,response,dataObject){$scope.partyDetailsDataFeedback.processing=!1,response&&response.Success===!0?(dataObject.error=null,$scope.partyDetailsDataInit(dataObject),$ocModal.close("partyDetailsModal")):response.Errors&&($scope.partyDetailsDataFeedback.error=response.Errors[0].ErrorMessages[0])}),$scope.$onRootScope("partyDetailsDataError",function(){$scope.partyDetailsDataFeedback.processing=!1,$scope.partyDetailsDataFeedback.showNetworkError=!0,$timeout(function(){$scope.partyDetailsDataFeedback.showNetworkError=!1},5e3)}),$scope.suggestedDonationData=null,$scope.suggestedDonationDataForForm=null,$scope.suggestedDonationDataFeedback={},$scope.suggestedDonationDataInit=function(suggestedDonationData){$scope.suggestedDonationData=suggestedDonationData,$scope.suggestedDonationDataForForm=angular.copy($scope.suggestedDonationData)},$scope.$onRootScope("suggestedDonationDataUpdated",function(event,response,dataObject){$scope.suggestedDonationDataFeedback.processing=!1,$scope.suggestedDonationDataInit(dataObject),$ocModal.close("suggestedDonationModal")}),$scope.$onRootScope("suggestedDonationDataError",function(){$scope.suggestedDonationDataFeedback.processing=!1,$scope.suggestedDonationDataFeedback.showNetworkError=!0,$timeout(function(){$scope.suggestedDonationDataFeedback.showNetworkError=!1},5e3)}),$scope.fundraisingTargetData=null,$scope.fundraisingTargetDataForForm=null,$scope.fundraisingTargetDataFeedback={};var fundraisingTargetFirstSet=!0;$scope.fundraisingTargetDataInit=function(fundraisingTargetData){$timeout(function(){$scope.fundraisingTargetData=fundraisingTargetData,$scope.fundraisingTargetDataForForm=angular.copy($scope.fundraisingTargetData),fundraisingTargetFirstSet&&(fundraisingTargetFirstSet=!1,fundraisingTargetData.FundraisingTarget<=0&&$rootScope.openPageModal("partials/fundraisingTargetForm.html","suggestedDonationModal",{fundraisingTargetData:$scope.fundraisingTargetDataForForm}))})},$scope.$onRootScope("fundraisingTargetDataUpdated",function(event,response,dataObject){$scope.fundraisingTargetDataFeedback.processing=!1,$scope.fundraisingTargetDataInit(dataObject),$ocModal.close("fundraisingTargetDataModal")}),$scope.$onRootScope("fundraisingTargetDataError",function(){$scope.fundraisingTargetDataFeedback.processing=!1,$scope.fundraisingTargetDataFeedback.showNetworkError=!0,$timeout(function(){$scope.fundraisingTargetDataFeedback.showNetworkError=!1},5e3)});var initUrl=null;$scope.partyImageData={},$scope.partyImageDefaultData=null,$scope.partyImageDataForForm=null,$scope.partyImageDataFeedback={},$scope.partyCustomImage={image:null,feedback:{}},$scope.partyImageDefaultDataInit=function(defaultImages){$scope.partyImageDefaultData=defaultImages;var isCustom=!0;initUrl&&angular.forEach(defaultImages,function(value){isCustom=value.id===initUrl.id?!1:isCustom}),isCustom&&($scope.partyCustomImage.image=initUrl)},$scope.$onRootScope("partyImageUpdated",function(){$scope.partyImageDataFeedback.processing=!1,$scope.partyImageData.PartyImage=$scope.partyImageDataForForm.PartyImage,$ocModal.close("partyImageModal")}),$scope.$onRootScope("partyImageUpdateError",function(){$scope.partyImageDataFeedback.processing=!1,$scope.partyImageDataFeedback.showNetworkError=!0,$timeout(function(){$scope.partyImageDataFeedback.showNetworkError=!1},5e3)}),$scope.$onRootScope("partyImageCustomUrlUploaded",function(event,response){$timeout(function(){if($scope.partyCustomImage.feedback.processing=!1,response&&response.Success===!0&&response.Message){var newImage=angular.fromJson(response.Message);$scope.partyCustomImage.feedback.showSuccess=!0,newImage&&($scope.partyCustomImage.image=newImage,$scope.partyImageDataForForm.PartyImage=newImage)}else $scope.partyCustomImage.feedback.showError=!0}),$timeout(function(){$scope.partyCustomImage.feedback.showSuccess=!1,$scope.partyCustomImage.feedback.showError=!1},5e3)}),$scope.hardCodedCurrentPartyImageUrlInit=function(imageData){imageData&&(initUrl=angular.fromJson(imageData)),$scope.partyImageData.PartyImage=initUrl,$scope.partyImageDataForForm=angular.copy($scope.partyImageData)}}]),wonderlandApp.controller("PartyDetailsFormCtrl",["$scope",function($scope){var hasSetInitialDate=!1,minute=[0,30];$scope.tempModel={partyDate:null,partyTime:null,times:[]};for(var funcValueMinute=function(valueMinute){var t=(10>i?"0":"")+i+":"+(10>valueMinute?"0":"")+valueMinute;$scope.tempModel.times.push(t)},i=0;24>i;i++)angular.forEach(minute,funcValueMinute);$scope.$watch("partyDetailsData.PartyDateTime",function(newVal){if(!hasSetInitialDate){hasSetInitialDate=!0;var mom=moment(newVal);mom.isValid()&&($scope.tempModel.partyDate=mom,$scope.tempModel.partyTime=$scope.tempModel.times[$scope.tempModel.times.indexOf(mom.format("HH:mm"))])}}),$scope.$watch("tempModel.partyDate + tempModel.partyTime",function(){$scope.tempModel.partyDate&&$scope.tempModel.partyTime&&($scope.partyDetailsData.PartyDateTime=moment($scope.tempModel.partyDate.format("YYYY/MM/DD")+" "+$scope.tempModel.partyTime).format("YYYY/MM/DD HH:mm:SS"))},!0)}]),wonderlandApp.controller("ProfileCtrl",["$scope","$timeout",function($scope,$timeout){$scope.feedback={profileNameProcessing:!1,profileNameShowSuccess:!1,profileNameShowError:!1,profileBillingAddressProcessing:!1,profileBillingAddressShowSuccess:!1,profileBillingAddressShowError:!1,profilePasswordProcessing:!1,profilePasswordShowSuccess:!1,profilePasswordShowError:!1,profileShirtProcessing:!1,profileShirtShowSuccess:!1,profileShirtShowError:!1},$scope.$onRootScope("profileNameDataUpdated",function(event,response,dataObject){$timeout(function(){$scope.feedback.profileNameProcessing=!1,response&&response.Success===!0?($scope.pageProfile.firstName=dataObject.FirstName,$scope.feedback.profileNameShowSuccess=!0):$scope.feedback.profileNameShowError=!0,$timeout(function(){$scope.feedback.profileNameShowSuccess=!1,$scope.feedback.profileNameShowError=!1},5e3)})}),$scope.$onRootScope("profileBillingAddressDataUpdated",function(event,response){$timeout(function(){$scope.feedback.profileBillingAddressProcessing=!1,response&&response.Success===!0?$scope.feedback.profileBillingAddressShowSuccess=!0:$scope.feedback.profileBillingAddressShowError=!0,$timeout(function(){$scope.feedback.profileBillingAddressShowSuccess=!1,$scope.feedback.profileBillingAddressShowError=!1},5e3)})}),$scope.$onRootScope("profilePasswordUpdated",function(event,response){$timeout(function(){$scope.feedback.profilePasswordProcessing=!1,response&&response.Success===!0?($scope.profilePasswordData=null,$scope.feedback.profilePasswordShowSuccess=!0):$scope.feedback.profilePasswordShowError=!0,$timeout(function(){$scope.feedback.profilePasswordShowSuccess=!1,$scope.feedback.profilePasswordShowError=!1},5e3)})}),$scope.$onRootScope("profileShirtUpdated",function(event,response){$timeout(function(){$scope.feedback.profileShirtProcessing=!1,response&&response.Success===!0?$scope.feedback.profileShirtShowSuccess=!0:$scope.feedback.profileShirtShowError=!0,$timeout(function(){$scope.feedback.profileShirtShowSuccess=!1,$scope.feedback.profileShirtShowError=!1},5e3)})})}]),wonderlandApp.controller("SuggestedDonationFormCtrl",["$scope",function($scope){$scope.hardcodedDonationSuggestions=[{amount:10,label:"Cheesy tunes"},{amount:15,label:"Deck the halls"},{amount:20,label:"Sauerkraut sizzle"},{amount:25,label:"Snowball bash"}]}]),wonderlandApp.controller("WallCtrl",["mHttp","$filter","$scope","$timeout",function(mHttp,$filter,$scope,$timeout){var wallFeed,partyGuid,wallDelete,deleteRequest,feedRequest,initialFormModel,hasSetInitialFormModel=!1;$scope.wall={feedback:{imageProcessing:!1,imageShowSuccess:!1,imageShowError:!1,messageProcessing:!1,messageShowSuccess:!1,messageShowError:!1,feedProcessingPost:!1,removeProcessingId:null},feed:null,feedLimit:10,feedLastDate:null,feedLastResponseCount:0,formModel:null,previewImageUrl:null,hasDoneFirstLoad:!1},$scope.init=function(baseWallFeed,basePartyGuid,baseWallFeedDelete){wallFeed=baseWallFeed,partyGuid=basePartyGuid,wallDelete=baseWallFeedDelete,$scope.getFeed()},$scope.getFeed=function(beforeDateTime){$timeout(function(){$scope.wall.feedback.feedProcessingPost=!0});var sendFormData={partyGuid:partyGuid,take:$scope.wall.feedLimit};beforeDateTime&&(sendFormData.beforeDateTime=beforeDateTime),feedRequest=mHttp.get(wallFeed,{data:sendFormData,dataType:"json"}),feedRequest.then(function(response){$scope.wall.feedback.feedProcessingPost=!1,response&&angular.forEach(response,function(value){Number(value.id<0)&&(value.isDonation=!0,value.text=$filter("mCurrency")(value.text,"£")),value.timeFormatted=moment(value.timestamp).fromNow(),value.text="null"==value.text?null:value.text,value.imageUrl=value.imageUrl&&value.imageUrl.indexOf("null")>=0?null:value.imageUrl}),response.length&&($scope.wall.feedLastResponseCount=response.length,$scope.wall.feedLastDate=response[response.length-1].timestamp),$scope.wall.hasDoneFirstLoad=!0,$scope.wall.feed=beforeDateTime?$scope.wall.feed.concat(response):response})},$scope.deleteFeedItem=function(messageId){!wallDelete||!messageId||0>messageId||($scope.wall.feedback.removeProcessingId=messageId,deleteRequest=mHttp.post(wallDelete+"?messageId="+messageId,{dataType:"json"}),deleteRequest.then(function(){var removeIndex=null;angular.forEach($scope.wall.feed,function(value,key){removeIndex=value.id===messageId?key:removeIndex}),removeIndex>=0&&$scope.wall.feed.splice(removeIndex,1),$scope.wall.feedback.removeProcessingId=null},function(){$scope.wall.feedback.removeProcessingId=null}))},$scope.wallFormModelInit=function(formModel){hasSetInitialFormModel||(hasSetInitialFormModel=!0,initialFormModel=formModel),$timeout(function(){$scope.wall.formModel=angular.copy(formModel),$scope.wall.previewImageUrl=null,$scope.wall.feedback.imageProcessing=!1,$scope.wall.feedback.messageProcessing=!1})},$scope.$onRootScope("wallMessagePosted",function(event,response){response&&response.Success===!0?($scope.wall.feedback.messageShowSuccess=!0,$scope.wallFormModelInit(initialFormModel),$scope.getFeed()):($scope.wall.feedback.messageProcessing=!1,$scope.wall.feedback.messageShowError=!0),$timeout(function(){$scope.wall.feedback.messageShowSuccess=!1,$scope.wall.feedback.messageShowError=!1},5e3)}),$scope.$onRootScope("wallMessagePostError",function(){$scope.wall.feedback.messageProcessing=!1,$scope.wall.feedback.messageShowError=!0,$timeout(function(){$scope.wall.feedback.messageShowSuccess=!1,$scope.wall.feedback.messageShowError=!1},5e3)}),$scope.$onRootScope("wallImageUploadStart",function(){$timeout(function(){$scope.wall.previewImageUrl=null,$scope.wall.formModel.PartyWallImage=null,$scope.wall.feedback.imageProcessing=!0})}),$scope.$onRootScope("wallImageUrlUploaded",function(event,response){$timeout(function(){if($scope.wall.feedback.imageProcessing=!1,response&&response.Success===!0&&response.Message){$scope.wall.feedback.imageShowSuccess=!0;var imageObject=angular.fromJson(response.Message);$scope.wall.previewImageUrl=imageObject,$scope.wall.formModel.PartyWallImage=imageObject.id}else $scope.wall.feedback.imageShowError=!0;$timeout(function(){$scope.wall.feedback.imageShowSuccess=!1,$scope.wall.feedback.imageShowError=!1},5e3)})})}]),function(){"use strict";angular.module("masonry",["ng"]).directive("masonry",function(){return{restrict:"AC",link:function(scope,elem,attrs){scope.items=[];var container=elem[0],options=angular.extend({itemSelector:".item"},JSON.parse(attrs.masonry));attrs.$observe("masonryFilterChange",function(newVal){angular.isString(newVal)&&scope.update()});var masonry=scope.masonry=new Masonry(container,options),debounceTimeout=0;scope.update=function(){debounceTimeout&&window.clearTimeout(debounceTimeout),debounceTimeout=window.setTimeout(function(){debounceTimeout=0,masonry.reloadItems(),masonry.layout(),elem.children(options.itemSelector).css("visibility","visible")},120)}}}}).directive("masonryTile",function(){return{restrict:"AC",link:function(scope,element){element.css("visibility","hidden");var master=element.parent("*[masonry]:first").scope(),update=master.update;imagesLoaded(element.find("img")[0],update),element.ready(update)}}})}(),wonderlandApp.directive("mAddressFinder",["paf","$timeout",function(paf,$timeout){return{scope:{postcode:"@mAddressFinder",m:"=mAddress"},template:'<div class="margin-bottom-medium"><div class="btn-secondary" m-radius-picker="small" ng-click="findAddressFromPostcode()">Find address</div></div><select ng-show="listOfAddresses" class="margin-bottom-large" ng-model="selectedAddress" ng-options="address.streetAddressField for address in listOfAddresses"><option value="">-- Select your address --</option></select><div class="errorred" ng-show="showErrorPostcode">That appears to be an invalid postcode, please try again</div><div class="errorred" ng-show="showErrorAddress">That addresses full details couldn\'t be loaded, try again</div><div class="successful" ng-show="showSuccess">Your address has been pre-filled!</div><div class="loader pos-static" ng-show="loading"></div>',link:function(scope,elements,attrs){scope.loading=!1,scope.selectedAddress=null,scope.listOfAddresses=null,scope.showSuccess=!1,scope.showErrorPostcode=!1,scope.showErrorAddress=!1;var pafPoscodeRequest,pafAddressRequest,triggerEvent=attrs.mTriggerEvent,getFullAddressFromId=function(){scope.loading=!0,pafAddressRequest=paf.getAddressFromIdField(scope.selectedAddress.idField),pafAddressRequest.then(function(response){scope.m.Address1=response.line1Field,scope.m.Address2=response.line2Field,scope.m.TownCity=response.postTownField,showFeedback("showSuccess"),clearData()},function(){showFeedback("showErrorAddress")})},showFeedback=function(message){scope[message]=!0,$timeout(function(){scope.showSuccess=!1,scope.showErrorPostcode=!1,scope.showErrorAddress=!1},5e3)},clearData=function(){scope.loading=!1,scope.selectedAddress=null,scope.listOfAddresses=null};scope.findAddressFromPostcode=function(){scope.loading=!0,pafPoscodeRequest=paf.getAddressFromPostcode(scope.postcode),pafPoscodeRequest.then(function(response){scope.loading=!1,scope.listOfAddresses=response},function(){showFeedback("showErrorPostcode"),clearData()})},scope.$watch("selectedAddress",function(newVal,oldVal){null!==newVal&&newVal!=oldVal&&getFullAddressFromId()}),triggerEvent&&scope.$onRootScope(triggerEvent,function(){$timeout(function(){scope.findAddressFromPostcode()})})}}}]),wonderlandApp.directive("mDateTimePicker",["$timeout",function($timeout){return{scope:{theDate:"=mDateTimePicker"},link:function(scope,element){var hasSetInitialValue=!1,pikaday=null;scope.$watch("theDate",function(newVal){if(!hasSetInitialValue){hasSetInitialValue=!0;var initialDate=null;moment(newVal).isValid()&&(initialDate=newVal),pikaday||createPicker(initialDate)}},!0);var createPicker=function(initialDate){var basePicka={field:element[0],firstDay:1,format:"dddd Do MMMM, YYYY",minDate:moment().toDate(),maxDate:new Date("2015-12-31"),yearRange:[2014,2015],onSelect:function(date){$timeout(function(){scope.theDate=moment(date)})}};initialDate&&angular.extend(basePicka,{defaultDate:initialDate.toDate(),setDefaultDate:!0}),pikaday=new Pikaday(basePicka)}}}}]),wonderlandApp.directive("mImageUpload",["fileUpload","$rootScope",function(fileUpload,$rootScope){return{scope:!0,link:function(scope,element,attrs){var onStartEvent=attrs.mOnStartEvent,onSuccessEvent=attrs.mOnSuccessEvent,resetInputValue=function(){element.find("input[type=file]").val(null)};scope.submitBlank=function(){resetInputValue(),scope.submit()},scope.submit=function(){scope.uploading=!0,onStartEvent&&$rootScope.$emit(onStartEvent),fileUpload.backgroundUpload(element.find("form")).then(function(response){scope.uploading=!1,onSuccessEvent&&$rootScope.$emit(onSuccessEvent,response),resetInputValue()})}}}}]),wonderlandApp.directive("onKeyEnterTrigger",["$rootScope",function($rootScope){return function(scope,element,attrs){var onEnterEvent=attrs.onKeyEnterTrigger;
element.bind("keydown",function(e){return 13===e.keyCode?(onEnterEvent&&$rootScope.$emit(onEnterEvent),e.preventDefault(),!1):void 0})}}]),wonderlandApp.directive("mFacebookLoginButton",["facebook","mHttp","$timeout","$window",function(facebook,mHttp,$timeout,$window){return{restrict:"A",replace:!0,scope:{label:"="},template:'<div><div class="btn-facebook-login radius-v2-small" ng-click="login()" ng-class="{\'disabled\': loading}" ng-bind="label"></div><div class="loader pos-static" ng-show="loading"></div><div class="successful" ng-show="formattedDetails">The user has logged in via Facebook! Hendy at this stage, we need to log the users in using their facebook app id.</div><div class="errorred" ng-show="showError" ng-bind="errorMessage"></div></div>',link:function(scope,element,attrs){scope.loading=!1,scope.formattedDetails=null,scope.showError=!1,scope.errorMessage=attrs.errorMessage||"Oops, something went wrong!";var requestVerificationToken=null,loginUrl=attrs.loginUrl,fbStatus=null,fbLogin=null,loginToServer=function(){if(loginUrl){var auth=facebook.authenticationDetails().authResponse,jsonData={accessToken:auth.accessToken,userId:auth.userID,signedRequest:auth.signedRequest},postHeaders={"Content-Type":"application/json"};null!==requestVerificationToken&&angular.extend(postHeaders,{__RequestVerificationToken:requestVerificationToken});var serverLogin=mHttp.post(loginUrl,{data:angular.toJson(jsonData),headers:postHeaders});serverLogin.then(function(response){response&&response.success===!0?"message"in response&&response.message.length>0?$window.location=response.message:$window.location.reload():(response&&"errors"in response&&response.errors.length>0&&(scope.errorMessage=response.errors[0].errorMessages[0]),scope.loading=!1,scope.showError=!0),$timeout(function(){scope.showError=!1},5e3)})}};scope.login=function(){scope.loading||(scope.loading=!0,fbStatus.then(function(status){"connected"!==status?(fbLogin=facebook.doLogin(),fbLogin.then(function(newStatus){"connected"!==newStatus?scope.loading=!1:loginToServer()})):loginToServer()}))},scope.$on("requestVerificationToken",function(event,token){requestVerificationToken=token}),fbStatus=facebook.getLoginStatus()}}}]),wonderlandApp.directive("mFileSelected",["$parse",function($parse){return{controller:function(){},link:function(scope,element,attrs){var fn=$parse(attrs.mFileSelected);element.on("change",function(){scope.$apply(function(){fn(scope)})})}}}]),wonderlandApp.directive("mFormTokenDispatcher",[function(){return{link:function(scope,element){var $token=$(element).find('input[name="__RequestVerificationToken"]');$token&&scope.$emit("formToken",$token[0].value)}}}]),wonderlandApp.directive("mHeightMatchWidth",["debounce","$window",function(debounce,$window){return{scope:!1,link:function(scope,element){var makeSquare=debounce(function(){element.css("height",element.width()+Number(element.css("padding-top").replace("px",""))+Number(element.css("padding-bottom").replace("px","")))},300);scope.myWidth=function(){return element.width()},scope.$watch("myWidth()",makeSquare),makeSquare(),angular.element($window).bind("resize",makeSquare)}}}]),wonderlandApp.directive("mImageLoadedBroadcaster",[function(){return{restrict:"A",link:function(scope){scope.$on("childImageLoaded",function(){scope.$broadcast("childImageLoadedBroadcast")})}}}]),wonderlandApp.directive("mImageLoadedNotifier",[function(){return{restrict:"A",link:function(scope,element){angular.element(element).bind("load",function(){angular.element(element).unbind("load"),scope.$emit("childImageLoaded")})}}}]),wonderlandApp.directive("mImgSvgReplacer",[function(){return{link:function(scope,element,attrs){Modernizr.svg||angular.element(element).attr("src",attrs.mImgSvgReplacer)}}}]),wonderlandApp.directive("mIosVersion",[function(){var iOS=parseFloat((""+(/CPU.*OS ([0-9_]{1,5})|(CPU like).*AppleWebKit.*Mobile/i.exec(navigator.userAgent)||[0,""])[1]).replace("undefined","3_2").replace("_",".").replace("_",""))||!1;return{restrict:"A",link:function(scope,element,attrs){var addClassName=attrs.mIosAddClass,removeClassName=attrs.mIosRemoveClass,applyClasses=function(){addClassName&&angular.element(element).addClass(addClassName),removeClassName&&angular.element(element).removeClass(removeClassName)};return iOS?void("mMinIos"in attrs&&parseInt(attrs.mMinIos,10)>iOS||"mMaxIos"in attrs&&parseInt(attrs.mMaxIos,10)<iOS||applyClasses()):void("mClassOnlyOnIos"in attrs||applyClasses())}}}]),wonderlandApp.directive("mPostOnSubmit",["mHttp","uniqueId","$parse","$rootScope","$timeout",function(mHttp,uniqueId,$parse,$rootScope,$timeout){var SAVED_CONFIRMATION_PERIOD=2e3;return{scope:!0,link:function(scope,element,attrs){function handleResponse(response,originalData){response&&response.data&&dataVar.assign(scope.$parent,response.data),response&&response.success===!1?(emitError(),setProgressState("ready")):(setProgressState("saved"),savedConfirmTimer=$timeout(function(){setProgressState("ready"),savedConfirmTimer=null},SAVED_CONFIRMATION_PERIOD),onSuccessEvent&&$rootScope.$emit(onSuccessEvent,response,angular.copy(originalData)))}function emitError(){onErrorEvent&&$rootScope.$emit(onErrorEvent)}function setProgressState(state){progressState=state,progressVar&&progressVar.assign(scope.$parent,state)}function prepareForSubmit(){mHttp.cancel(formSubmitRequest),savedConfirmTimer&&($timeout.cancel(savedConfirmTimer),savedConfirmTimer=null),"saved"===progressState&&setProgressState("in-progress")}var progressState,progressVar=attrs.mProgressVar&&$parse(attrs.mProgressVar),dataVar=$parse(attrs.mPostOnSubmit),formSubmitRequest=null,savedConfirmTimer=null,serialized=attrs.hasOwnProperty("mSerialized"),onSuccessEvent=attrs.mOnSuccessEvent,onErrorEvent=attrs.mOnErrorEvent,useLegacy=attrs.mUseLegacy===!0||"true"===attrs.mUseLegacy||!1;setProgressState("ready"),element.on("submit",function(){if(!serialized||!mHttp.isInProgress(formSubmitRequest)){prepareForSubmit(),setProgressState("in-progress");var originalData=dataVar(scope)||{},sendData=angular.copy(originalData);if(!useLegacy&&window.File&&window.FileReader)$timeout(function(){var ufprtElement=element.find("[name='ufprt']");ufprtElement&&ufprtElement.length&&(sendData.ufprt=ufprtElement[0].value);var rvtElement=element.find("[name='__RequestVerificationToken']");rvtElement&&rvtElement.length&&(sendData.__RequestVerificationToken=rvtElement[0].value),formSubmitRequest=mHttp.post(attrs.action+"?t="+(new Date).getTime(),{formData:sendData,dataType:"json"}),formSubmitRequest.then(function(response){handleResponse(response,originalData)},function(){emitError(),setProgressState("ready")})});else{var target="form_target_iframe_"+uniqueId(),$targetIframe=$("<iframe/>",{name:target,id:target,frameborder:"0"}).insertAfter(element).css({width:0,height:0}).load(function(){$timeout(function(){var response=$targetIframe.contents().find("body").html(),parsedJson=null;try{parsedJson=JSON.parse(response)}catch(er){}handleResponse(parsedJson,originalData)})}),$postForm=$("<form></form>",{target:target,method:"post",enctype:"multipart/form-data"}).insertAfter(element);$(element).contents().appendTo($postForm),$postForm.attr("action",attrs.action),$postForm.submit()}return!1}})}}}]),wonderlandApp.directive("mProfileImage",["$timeout",function($timeout){var MAIN_CLASS="profile-image",NOT_SET_CLASS="profile-image-notset",ALLOWED_EXTENSIONS=[".jpg",".jpeg",".png"];return{scope:{},link:function(scope,element,attrs){scope.hasBackgroundImage=!1,element.addClass(MAIN_CLASS);var loadImage=function(newImgSrc){var img=new Image;$(img).on("load",function(){element.css("background-image","url("+newImgSrc+")"),$timeout(function(){scope.hasBackgroundImage=!0})}),$(img).attr("src",newImgSrc)};attrs.$observe("mProfileImage",function(newVal){for(var hasExt=!1,i=0;i<ALLOWED_EXTENSIONS.length;i++)hasExt=newVal.toLowerCase().indexOf(ALLOWED_EXTENSIONS[i])>=0?!0:hasExt;return newVal&&angular.isString(newVal)&&hasExt?void loadImage(newVal):void(scope.hasBackgroundImage=!1)}),scope.$watch("hasBackgroundImage",function(newVal){newVal===!0?element.removeClass(NOT_SET_CLASS):element.addClass(NOT_SET_CLASS)})}}}]),wonderlandApp.directive("mRadiusPicker",[function(){var NUM_OF_CLASS_VARIETIES=3,CLASS_SIZES=["small","medium","large"];return{scope:!1,link:function(scope,element,attrs){var usedSizes=angular.copy(CLASS_SIZES);if(attrs.mRadiusPicker){usedSizes=[];for(var i=0;i<CLASS_SIZES.length;i++)attrs.mRadiusPicker.indexOf(CLASS_SIZES[i])>=0&&usedSizes.push(CLASS_SIZES[i])}if(usedSizes.length){var version=Math.floor(Math.random()*NUM_OF_CLASS_VARIETIES)+1,size=usedSizes[Math.floor(Math.random()*usedSizes.length)];element.addClass("radius-v"+version+"-"+size)}}}}]),wonderlandApp.directive("mRotate",["$timeout",function(){function kcRotate(elem,deg){var Dx,Dy,iecos,iesin,halfWidth,halfHeight,dummy,rad=deg*(Math.PI/180);iecos=Math.cos(rad),iesin=Math.sin(rad),halfWidth=elem.offsetWidth/2,halfHeight=elem.offsetHeight/2,Dx=-halfWidth*iecos+halfHeight*iesin+halfWidth,Dy=-halfWidth*iesin-halfHeight*iecos+halfHeight,elem.style.transform="rotate("+rad+"rad)",elem.style.mozTransform="rotate("+rad+"rad)",elem.style.webkitTransform="rotate("+rad+"rad)",elem.style.OTransform="rotate("+rad+"rad)",elem.style.msTransform="rotate("+rad+"rad)",elem.style.filter="progid:DXImageTransform.Microsoft.Matrix(M11="+iecos+", M12="+-iesin+", M21="+iesin+", M22="+iecos+", Dx="+Dx+", Dy="+Dy+", SizingMethod=auto expand)",elem.style.msFilter="progid:DXImageTransform.Microsoft.Matrix(M11="+iecos+", M12="+-iesin+", M21="+iesin+", M22="+iecos+", Dx="+Dx+", Dy="+Dy+", SizingMethod=auto expand)",dummy=document.createElement("div"),dummy.innerHTML="<!--[if gte IE 9]><br /><![endif]-->",1==dummy.getElementsByTagName("br").length&&(elem.style.filter="none"),dummy=null}var TOTAL_COUNT=0;return{scope:!1,link:function(scope,element){var originalDeg=0,doNewRotation=function(angleOverride){var newAngle=angleOverride||0;if(!angular.isNumber(angleOverride)){TOTAL_COUNT+=1;var multiplier=TOTAL_COUNT%2?-1:1;newAngle=3*Math.random()*multiplier}return kcRotate(element[0],newAngle),newAngle};originalDeg=doNewRotation()}}}]),wonderlandApp.directive("mSelectOnClick",function(){return{restrict:"A",link:function(scope,element){element.on("mouseup",function(){this.select()})}}}),wonderlandApp.directive("mTotaliser",["$filter",function($filter){return{restrict:"AE",scope:{raised:"@mRaised",total:"@mTotal",rank:"@mRank",rankTotal:"@mRankTotal"},template:'<div><span class="body-mega color-brand margin-right-tiny" ng-bind="raised|mCurrency:\'£\'"></span><span class="dis-inline-block"><span> raised of the </span><span class="body-highlight color-brand" ng-bind="total|mCurrency:\'£\'"></span><span> target</span></span></div><div class="totaliser"><div class="current-total" ng-style="{\'width\': cappedCurrentPercentage + \'%\'}"></div></div><div class="form-info"><span class="float-left" ng-show="total>0" ng-cloak><span ng-bind="currentPercentage"></span>%</span><span class="float-right" ng-show="rank">Ranked #<span ng-bind="rank"></span><span ng-show="rankTotal"> of <span ng-bind="rankTotal"></span>&nbsp;<div ng-pluralize count="rankTotal" when="{\'1\': \'party\', \'other\': \'parties\'}"></div></span></span></div>',link:function(scope){scope.$watch("raised + total",function(){var cp=$filter("percentageRounder")(scope.raised,scope.total,!1);scope.currentPercentage=cp;var cpc=cp>100?100:cp;scope.cappedCurrentPercentage=cpc})}}}]),wonderlandApp.directive("mValidNumber",function(){return{require:"?ngModel",link:function(scope,element,attrs,ngModelCtrl){ngModelCtrl&&(ngModelCtrl.$parsers.push(function(val){var clean=val.replace(/[^0-9|.]+/g,"");return val!==clean&&(ngModelCtrl.$setViewValue(clean),ngModelCtrl.$render()),clean}),element.bind("keypress",function(event){32===event.keyCode&&event.preventDefault()}))}}}),wonderlandApp.directive("mValueMatcher",[function(){return{scope:{m:"=ngModel"},link:function(scope,element,attrs){var hasInitiallySet=!1;scope.$watch("m",function(){hasInitiallySet||(hasInitiallySet=!0,scope.m=attrs.value)})}}}]),wonderlandApp.directive("mVerticalAlign",["debounce","$timeout","$window",function(debounce,$timeout,$window){return{link:function(scope,element,attrs){var hasInited=!1,isActive=!1,$possibleParent=$(element).closest("."+attrs.mAlignParent),$myParent=$possibleParent&&$possibleParent.length?$possibleParent[0]:$(element).parent(),reAlign=debounce(function(){element.css("top",(parentHeight()-myHeight())/2)},200),parentHeight=function(){return $($myParent).height()+Number($($myParent).css("padding-top").replace("px",""))+Number($($myParent).css("padding-bottom").replace("px",""))},myHeight=function(){return $(element).height()+Number($(element).css("padding-top").replace("px",""))+Number($(element).css("padding-bottom").replace("px",""))};attrs.$observe("mVerticalAlign",function(newVal){hasInited||"true"!==newVal&&newVal!==!0||(isActive=!0,angular.element($window).bind("resize",reAlign),reAlign(),$timeout(reAlign,500)),hasInited||(hasInited=!0),"true"!==newVal&&newVal!==!0&&(isActive=!1)}),scope.$on("childImageLoadedBroadcast",function(){isActive&&reAlign()})}}}]),wonderlandApp.directive("mWindowClickToggle",["$document","$timeout",function($document,$timeout){return{scope:{toggle:"=mWindowClickToggle"},link:function(scope,element){scope.toggle=!1,$document.bind("click",function(event){var isClickedElementChildOfPopup=element.find(event.target).length>0;isClickedElementChildOfPopup||$timeout(function(){scope.toggle=!1})})}}}]),wonderlandApp.filter("datePreviewFormat",[function(){return function(dateString){var newFormattedDate="";return dateString&&(newFormattedDate=moment(dateString).format("dddd D MMM, YYYY")+" at "+moment(dateString).format("HH.mm")),newFormattedDate}}]),wonderlandApp.filter("dateSuffix",function(){var suffixes=["st","nd","rd"];return function(num){var suffix="";if(angular.isNumber(num)&&num>0){var ind=[1,2,3].indexOf(num%10),lastTwoDigits=num%100;suffix=ind>=0&&!(lastTwoDigits>10&&20>lastTwoDigits)?suffixes[ind]:"th"}return num+suffix}}),wonderlandApp.filter("escape",function(){return function(url){return encodeURIComponent(url)}}),wonderlandApp.filter("percentageRounder",function(){return function(current,total,capAt100){var p=0;return capAt100=null===capAt100?!0:!!capAt100,current=Number(current),total=Number(total),!isNaN(current)&&!isNaN(total)&&total>0&&(p=Math.floor(current/total*100),capAt100&&(p=p>100?100:p)),p=0>p?0:p,p=isNaN(p)?0:p}}),wonderlandApp.filter("mCurrency",["$filter",function($filter){return function(amount,currencySymbol){var currency=$filter("currency"),formattedCurrency=currency(amount,currencySymbol);return formattedCurrency=formattedCurrency.replace("(","-").replace(")","").replace(".00","")}}]),wonderlandApp.filter("addressJoiner",[function(){return function(addressString,separator){var addressParts=[];if(angular.isString(addressString))for(var originalParts=addressString.split(separator),i=0;i<originalParts.length;i++)angular.isString(originalParts[i])&&originalParts[i].length>0&&"null"!==originalParts[i]&&addressParts.push(originalParts[i]);var finalAddress=addressParts.join(", ");return finalAddress.length<=0&&(finalAddress="An address hasn't been set yet"),finalAddress}}]),wonderlandApp.filter("striptags",[function(){return function(htmlString){var ret=htmlString;return angular.isString(htmlString)&&(ret=htmlString.replace(/<[^>]+>/gi,"")),ret}}]),wonderlandApp.filter("formatAmountComplete",[function(){return function(col){var complete=0,total=col.length||0;if(angular.isArray(col))for(var i=0;total>i;i++)col[i].complete===!0&&complete++;return"("+complete+" of "+total+")"}}]),wonderlandApp.filter("mLimitTo",["$filter",function($filter){return function(str,limit,suffix){return $filter("limitTo")(str,limit)+(str.length>limit&&suffix?suffix:"")}}]),wonderlandApp.filter("mQuality",[function(){return function(str,quality){var newStr=str;return str&&!isNaN(quality)&&(newStr=str.replace(/quality=[0-9]+/i,"quality="+quality)),newStr}}]),wonderlandApp.filter("mWidth",[function(){return function(str,width){var newStr=str;return str&&!isNaN(width)&&(newStr=str.replace(/width=\d+/i,"width="+width)),newStr}}]),wonderlandApp.filter("forceNullString",[function(){return function(str){return str||"null"}}]),wonderlandApp.filter("forceBlankString",[function(){return function(str){return str||""}}]),wonderlandApp.factory("debounce",function(){return function(fn,wait){var TO=null,getWait=angular.isFunction(wait)?wait:function(){return wait},wrapper=function(){var self=this,args=Array.prototype.slice.call(arguments);wrapper.cancel(),TO=setTimeout(function(){TO=null,fn.apply(self,args)},getWait())};return wrapper.cancel=function(){null!==TO&&(clearTimeout(TO),TO=null)},wrapper.running=function(){return null!==TO},wrapper}}),wonderlandApp.factory("facebook",["$window","$q",function($window,$q){var fbDeferred=$q.defer(),fbReady=fbDeferred.promise,fbAuthentication=null,fbUserDetails=null,fbAppId={live:"670543089727850"};return $window.fbAsyncInit=function(){FB.init({appId:fbAppId.live,xfbml:!1,version:"v2.1"}),fbDeferred.resolve()},function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];d.getElementById(id)||(js=d.createElement(s),js.id=id,js.src="//connect.facebook.net/en_US/sdk.js",fjs.parentNode.insertBefore(js,fjs))}(document,"script","facebook-jssdk"),{getLoginStatus:function(){var loginStatusDeferred=$q.defer();return fbReady.then(function(){FB.getLoginStatus(function(response){fbAuthentication=response;var resultingStatus="not_logged_in";("connected"===response.status||"not_authorized"===response.status)&&(resultingStatus=response.status),loginStatusDeferred.resolve(resultingStatus)})}),loginStatusDeferred.promise},doLogin:function(){var loginDeferred=$q.defer();return FB.login(function(response){fbAuthentication=response;var resultingStatus="not_logged_in";("connected"===response.status||"not_authorized"===response.status)&&(resultingStatus=response.status),loginDeferred.resolve(resultingStatus)},{scope:"public_profile,email"}),loginDeferred.promise},getUserDetails:function(){var userDeferred=$q.defer();return FB.api("/me",function(response){fbUserDetails=response,userDeferred.resolve(response)}),userDeferred.promise},authenticationDetails:function(){return fbAuthentication},userDetails:function(){return fbUserDetails}}}]),wonderlandApp.factory("fileUpload",["$document","$q","uniqueId",function($document,$q,uniqueId){return{backgroundUpload:function(form){var deferred=$q.defer(),formTarget="frame_form_target_"+uniqueId(),targetIframe=$("<iframe/>",{name:formTarget,id:formTarget}).appendTo($document.find("body"));return form.attr("target",formTarget),form.submit(),targetIframe.load(function(){form.scope().$apply(function(){var response=targetIframe[0].contentWindow.document.body.innerHTML;response=response.replace(/<\/?[^>]+>/gi,""),targetIframe.remove();var responseJson=null;try{responseJson=angular.fromJson(response)}catch(e){}deferred.resolve(responseJson)})}),deferred.promise}}}]),wonderlandApp.factory("mHttpBackend",function(){return function(opts){return $.ajax(opts)}}),wonderlandApp.factory("mHttp",["$compile","$document","$q","$rootScope","$window","mHttpBackend","$timeout","uniqueId",function($compile,$document,$q,$rootScope,$window,mHttpBackend,$timeout,uniqueId){var cancelFns={},mHttp=function(opts){function onResponse(args,success){deferred[success?"resolve":"reject"].apply(deferred,Array.prototype.slice.call(args)),optsWithDefaults.invokeApply&&$timeout(function(){$rootScope.$apply()})}function cleanup(){delete cancelFns[promise._requestId]}var optsWithDefaults=angular.extend({method:"GET",async:!0,headers:{},invokeApply:!0},opts),xhrOpts={url:optsWithDefaults.url,type:optsWithDefaults.method,timeout:optsWithDefaults.timeout,data:optsWithDefaults.data,dataType:optsWithDefaults.dataType,async:optsWithDefaults.async,headers:optsWithDefaults.headers,success:function(){optsWithDefaults.onSuccess&&optsWithDefaults.onSuccess.apply(mHttp,Array.prototype.slice.call(arguments)),onResponse(arguments,!0)},error:function(){onResponse(arguments,!1)}};if(optsWithDefaults.requestProgress&&(xhrOpts.xhr=function(){function setProgress(){progress=Math.min((xhr.readyState-1)/3+downloadProgress/3,1),optsWithDefaults.requestProgress(progress),optsWithDefaults.invokeApply&&$timeout(function(){$rootScope.$apply()})}var xhr=$.ajaxSettings.xhr(),progress=0,downloadProgress=0;return xhr.addEventListener("progress",function(event){event.lengthComputable&&(downloadProgress=event.loaded/event.total,setProgress())},!1),xhr.addEventListener("readystatechange",setProgress),xhr}),optsWithDefaults.formData&&!optsWithDefaults.data){var formData=new $window.FormData;angular.forEach(optsWithDefaults.formData,function(val,key){formData.append(key,val)}),xhrOpts.data=formData,xhrOpts.processData=!1,xhrOpts.contentType=!1}var deferred=$q.defer(),promise=deferred.promise;promise._requestId=uniqueId(),cancelFns[promise._requestId]=function(){xhr.abort()},promise.then(cleanup,cleanup);var xhr=mHttpBackend(xhrOpts);return promise};return mHttp.isInProgress=function(promise){return promise&&promise._requestId in cancelFns},mHttp.cancel=function(promise){mHttp.isInProgress(promise)&&cancelFns[promise._requestId]()},mHttp.get=function(url,opts){return mHttp(angular.extend({method:"GET",url:url},opts))},mHttp.post=function(url,opts){return mHttp(angular.extend({method:"POST",url:url},opts))},mHttp.del=function(url,opts){return mHttp(angular.extend({method:"DELETE",url:url},opts))},mHttp.load=function(element,scope,url,opts){return mHttp(angular.extend({method:"GET",url:url,element:element,onSuccess:function(html){element.html(html),$compile(element.contents())(scope)}},opts))},mHttp}]),wonderlandApp.factory("paf",["mHttp","$q",function(mHttp,$q){var FIND_BY_POSTCODE="/umbraco/Api/PostcodeAnywhereApi/FindByPostcode",RETRIEVE_BY_ID="/umbraco/Api/PostcodeAnywhereApi/RetrieveById",returnObj={getAddressFromPostcode:function(postCode){var deferred=$q.defer(),promise=deferred.promise,formSubmitRequest=mHttp.get(FIND_BY_POSTCODE,{data:{postcode:postCode},dataType:"json"});return formSubmitRequest.then(function(response){response&&response.length?deferred.resolve(response):deferred.reject()},function(){deferred.reject()}),promise},getAddressFromIdField:function(idField){var deferred=$q.defer(),promise=deferred.promise,formSubmitRequest=mHttp.get(RETRIEVE_BY_ID,{data:{idField:idField},dataType:"json"});return formSubmitRequest.then(function(response){response&&response.length?deferred.resolve(returnObj.formatAddress(response[0])):deferred.reject()},function(){deferred.reject()}),promise},formatAddress:function(address){var newAddress=angular.copy(address),combiners=[address.companyField,address.line1Field,address.line2Field,address.line3Field,address.line4Field,address.line5Field],firstValidInLoop=!0,remainder=[];return angular.forEach(combiners,function(value){value&&(firstValidInLoop?(firstValidInLoop=!1,newAddress.line1Field=value):remainder.push(value))}),newAddress.line2Field=remainder.join(", "),newAddress}};return returnObj}]),wonderlandApp.factory("safeApply",[function(){return function(scope,fn){scope.$$phase?fn&&fn(scope):scope.$apply(fn)}}]),wonderlandApp.factory("uniqueId",function(){var counter=0;return function(){return counter++,counter}});