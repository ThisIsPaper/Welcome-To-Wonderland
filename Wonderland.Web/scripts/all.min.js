...
wonderlandApp.config([ "$provide", function($provide) {
    ...
    $scope.partyDetailsDataForForm = null, $scope.partyDetailsDataInit = function(partyDetailsData) {
        ...
        $scope.partyDetailsDataForForm.processing = !1, response && response.Success === !0 ? (dataObject.error = null, 
        $scope.partyDetailsDataInit(dataObject), $ocModal.close("partyDetailsModal")) : response.Errors && ($scope.partyDetailsDataForForm.error = response.Errors[0].ErrorMessages[0]);
