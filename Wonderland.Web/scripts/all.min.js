...
wonderlandApp.config([ "$provide", function($provide) {
    ...
    var FIND_BY_POSTCODE = "/umbraco/Api/PostcodeAnywhereApi/FindByPostcode", RETRIEVE_BY_ID = "/umbraco/Api/PostcodeAnywhereApi/RetrieveById", returnObj = {
        ...
        formatAddress: function(address) {
            ...
            return address.line3Field && (newAddress.line1Field = [ address.line1Field, address.line2Field ].join(", "), 
            newAddress.line2Field = address.line3Field), address.companyField && (newAddress.line1Field = address.companyField, 
            newAddress.line2Field = address.line2Field ? [ address.line1Field, address.line2Field ].join(", ") : address.line1Field), 
            newAddress;
        }
    };
    return returnObj;
