...
wonderlandApp.config([ "$provide", function($provide) {
    ...
    var cancelFns = {}, mHttp = function(opts) {
        ...
        if (console.log("mHttp", 2), optsWithDefaults.requestProgress && (xhrOpts.xhr = function() {
        ...
        }), console.log("mHttp", 3), optsWithDefaults.formData && !optsWithDefaults.data) {
        ...
        promise._requestId = uniqueId(), cancelFns[promise._requestId] = function() {
            xhr.abort();
        }, console.log("mHttp", 4), promise.then(cleanup, cleanup);
        var xhr = mHttpBackend(xhrOpts);
        return console.log("mHttp", 5), promise;
    };
