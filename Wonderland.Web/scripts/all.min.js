...
!function(a) {
    var d = window.slimmage || {};
    window.slimmage = d, void 0 === d.verbose && (d.verbose = !0), void 0 === d.tryWebP && (d.tryWebP = !1), 
    void 0 === d.readyCallback && (d.readyCallback = null), void 0 === d.maxWidth && (d.maxWidth = 2048), 
    void 0 === d.widthStep && (d.widthStep = 160), void 0 === d.jpegQuality && (d.jpegQuality = 90), 
    void 0 === d.jpegRetinaQuality && (d.jpegRetinaQuality = 80);
    var c = function() {
        if (a.slimmage.verbose && a.console && a.console.log) try {
            a.console.log.apply(a.console, arguments);
        } catch (f) {}
    };
    d.beginWebPTest = function() {
        if (d.tryWebP && !d._testingWebP) {
            d._testingWebP = !0;
            var e = new Image();
    ...
    }, d.getCssValue = function(f, e) {
        var g = "undefined" != typeof window.getComputedStyle && window.getComputedStyle(f, null).getPropertyValue(e);
        return !g && f.currentStyle && (g = f.currentStyle[e.replace(/([a-z])\-([a-z])/, function(i, h, j) {
            return h + j.toUpperCase();
        })] || f.currentStyle[e]), g;
    }, d.getCssPixels = function(g, f) {
        var h = d.getCssValue(g, f);
        if ("px" == h.slice(-2)) return parseFloat(h.slice(0, -2));
        var e = document.createElement("div");
        e.style.overflow = e.style.visibility = "hidden", e.style.cssFloat = "none", g.parentNode.appendChild(e), 
        e.style.width = h;
        var i = e.offsetWidth;
        return g.parentNode.removeChild(e), i;
    }, d.nodesToArray = function(e) {
        for (var g = [], f = e.length >>> 0; f--; ) g[f] = e[f];
        return g;
    }, d.adjustImageSrcWithWidth = function(g, e, i) {
        var j = {
            webp: d.webp,
            width: i,
        ...
        j.requestedWidth = Math.min(d.maxWidth, j.width * j.dpr), j.quality = j.dpr > 1.49 ? d.jpegRetinaQuality : d.jpegQuality, 
        j.webp && (j.quality = j.dpr > 1.49 ? 65 : 78), j.requestedWidth = j.requestedWidth - j.requestedWidth % d.widthStep + d.widthStep;
        var f = 0 | g.getAttribute("data-pixel-width");
        if (d.adjustImageParameters && "function" == typeof d.adjustImageParameters && d.adjustImageParameters(j), 
        j.requestedWidth > f) {
            var h = e.replace(/width=\d+/i, "width=" + j.requestedWidth).replace(/quality=[0-9]+/i, "quality=" + j.quality);
            j.webp && (h = h.replace(/format=[a-z]+/i, "format=webp")), g.src = h, g.setAttribute("data-pixel-width", j.requestedWidth), 
            c("Slimming: updating " + h);
        }
    }, d.adjustImageSrc = function(f, e) {
        d.adjustImageSrcWithWidth(f, e, d.getCssPixels(f, "max-width"));
    }, d.checkResponsiveImages = function(x) {
        if (d.timeoutid > 0 && a.clearTimeout(d.timeoutid), d.timeoutid = 0, x && x > 0) return void (d.timeoutid = a.setTimeout(d.checkResponsiveImages, x));
        for (var g = new Date().getTime(), o = 0, p = d.nodesToArray(a.document.getElementsByTagName("noscript")), r = 0, h = p.length; h > r; r++) {
            var y = p[r];
            if (null !== y.getAttribute("data-slimmage")) {
                var m = a.document.createElement("div"), v = y.textContent || y.innerHTML;
                if (v && 0 != v.replace(/[\s\t\r\n]+/, "").length) m.innerHTML = v.replace(/\s+src\s*=\s*(['"])/i, " data-src=$1").replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&amp;/g, "&"); else {
                    for (var z = new Image(), s = 0; s < y.attributes.length; s++) {
                        var w = y.attributes[s];
                        w && w.specified && 0 == w.name.indexOf("data-img-") && z.setAttribute(w.name.slice(9 - w.name.length), w.value);
                    }
                    m.appendChild(z);
                }
                for (var e = m.getElementsByTagName("img"), q = 0, t = e.length; t > q; q++) {
                    var l = e[q];
                    null !== l.src && l.src.length > 0 && (l.setAttribute("data-src", l.src), l.src = ""), 
                    l.setAttribute("data-slimmage", !0), y.parentNode.insertBefore(l, y), o++;
                }
                y.parentNode.removeChild(y);
            }
        }
        for (var u = 0, k = d.nodesToArray(a.document.getElementsByTagName("img")), r = 0, h = k.length; h > r; r++) if (null !== k[r].getAttribute("data-slimmage")) {
            var f = k[r].getAttribute("data-src") || k[r].src;
            d.adjustImageSrc(k[r], f), u++;
        }
        "function" == typeof d.readyCallback && d.readyCallback(), c("Slimmage: restored " + o + " images from noscript tags; sizing " + u + " images. " + (new Date().getTime() - g) + "ms");
    };
    var b = d.checkResponsiveImages;
    a.addEventListener ? (a.addEventListener("resize", function() {
        b(500);
    }, !1), a.addEventListener("DOMContentLoaded", function() {
        b(), a.removeEventListener("load", b, !1);
    }, !1), a.addEventListener("load", b, !1)) : a.attachEvent && a.attachEvent("onload", b), 
    d.beginWebPTest();
    ...
    var x, C, d = "2.6.2", e = {}, f = !0, g = b.documentElement, h = "modernizr", i = b.createElement(h), j = i.style, k = b.createElement("input"), l = ":)", m = {}.toString, n = " -webkit- -moz- -o- -ms- ".split(" "), o = "Webkit Moz O ms", p = o.split(" "), q = o.toLowerCase().split(" "), r = {
        ...
        this.hashPrefix = function(prefix) {
            ...
            $rootElement.on("click", function(event) {
                if (!event.ctrlKey && !event.metaKey && 2 != event.which) {
                    ...
                    !IGNORE_URI_REGEXP.test(absHref)) {
                        if (LocationMode === LocationHashbangInHtml5Url) {
                            ...
                            if (href && href.indexOf("://") < 0) {
                                ...
                                if ("/" == href[0]) absHref = appBase + prefix + href; else if ("#" == href[0]) absHref = appBase + prefix + ($location.path() || "/") + href; else {
                                    ...
                                    2 !== stack.length || stack[1] || (stack.length = 1);
                                    for (var i = 0; i < parts.length; i++) "." != parts[i] && (".." == parts[i] ? stack.pop() : parts[i].length && stack.push(parts[i]));
    ...
    LocationHashbangInHtml5Url.prototype = LocationHashbangUrl.prototype = LocationHtml5Url.prototype = {
        ...
        path: locationGetterSetter("$$path", function(path) {
            return path = path ? path.toString() : "", "/" == path.charAt(0) ? path : "/" + path;
        }),
                ...
                function setupAsOptions(scope, selectElement, ctrl) {
                    ...
                    function render() {
                        ...
                        for (multiple || (nullOption || null === modelValue ? optionGroups[""].unshift({
                            ...
                            msie && lastElement.prop("selected", existingOption.selected))) : ("" === option.id && nullOption ? element = nullOption : (element = optionTemplate.clone()).val(option.id).prop("selected", option.selected).attr("selected", option.selected).text(option.label), 
...
function() {
    ...
    ocModal.factory("$ocModal", [ "$rootScope", "$controller", "$location", "$timeout", "$compile", "$sniffer", "$q", function($rootScope, $controller, $location, $timeout, $compile, $sniffer, $q) {
        var baseOverflow, $body = angular.element(document.body), $dialogsWrapper = angular.element('<div role="dialog" tabindex="-1" class="modal"><div class="modal-backdrop"></div></div>'), $modalWrapper = angular.element('<div class="modal-wrapper"></div>'), modals = {}, openedModals = [];
        $modalWrapper.css("display", "none"), $modalWrapper.append($dialogsWrapper), $body.append($modalWrapper), 
        $dialogsWrapper.on("click", function(e) {
            angular.element(e.target).hasClass("modal-backdrop") && $rootScope.$apply(function() {
                self.closeOnEsc();
            }), e.stopPropagation();
        });
        ...
        }, getAnimDuration = function($element) {
            var duration = 0;
            if ($sniffer.transitions || $sniffer.animations) {
                var w3cAnimationProp = "animation", w3cTransitionProp = "transition", vendorAnimationProp = $sniffer.vendorPrefix + "Animation", vendorTransitionProp = $sniffer.vendorPrefix + "Transition", durationKey = "Duration", delayKey = "Delay", animationIterationCountKey = "IterationCount", ELEMENT_NODE = 1;
        ...
        angular.element(document).on("keyup", function(e) {
            27 == e.keyCode && openedModals.length > 0 && (e.stopPropagation(), $rootScope.$apply(function() {
        ...
        var self = {
            ...
            open: function(opt) {
                "string" == typeof opt && (opt = opt.match("<") ? {
                    template: opt
                } : {
                    url: opt
                });
                var modal = modals[opt.id || "_default"];
                if (!modal) return $dialogsWrapper.append($compile('<div oc-modal="' + (opt.id ? opt.id : "_default") + '"></div>')($rootScope)), 
                void $timeout(function() {
                    self.open(opt);
                });
                if (modal && -1 !== openedModals.indexOf(opt.id || "_default")) {
                    if (self.waitingForOpen) return;
                    return self.waitingForOpen = !0, void self.close(opt.id).then(function() {
                        self.open(opt);
                    });
                }
                if (!self.waitingForOpen) if (0 === openedModals.length) baseOverflow = document.body.style.overflow, 
                document.body.style.overflow = "hidden", $modalWrapper.css("display", "block"); else for (var i = 0, len = openedModals.length; len > i; i++) {
                    var $e = modals[openedModals[i]].$element;
                    modals[openedModals[i]].baseZIndex = $e.css("z-index"), $e.css("z-index", "-1"), 
                    $e.addClass("no-backdrop");
                }
                self.waitingForOpen = !1, openedModals.push(opt.id || "_default"), modal.params = opt, 
                modal.$scope.customClass = modal.params.cls, $rootScope.$digest(), $body[0].offsetWidth, 
                $timeout(function() {
                    modal.$scope.modalShow = !0;
                }, 100), "function" == typeof modal.params.onOpen && modal.params.onOpen();
                var off = modal.$scope.$on("$includeContentLoaded", function(event) {
                    modal.params.init && !modal.params.isolate && angular.extend(event.targetScope, modal.params.init, !0), 
                    "string" == typeof modal.params.controller && $controller(modal.params.controller, {
                        $scope: event.targetScope,
                        $init: modal.params.init,
                        $ocModalParams: modal.params
                    }), off();
                });
                if (modal.params.template) modal.$scope.modalTemplate = modal.params.template; else {
                    if (!modal.params.url) throw "You need to define a template or an url";
                    modal.$scope.modalUrl = modal.params.url;
                }
                "function" == typeof callback && modal.$scope.callbacksList.push(callback);
            },
            closeOnEsc: function(id) {
                return modals[id || openedModals[openedModals.length - 1]].params.closeOnEsc !== !1 ? self.close(id) : void 0;
            },
            close: function(id) {
                var args, deferred = $q.defer();
                args = "string" == typeof id && -1 !== openedModals.indexOf(id) ? Array.prototype.slice.call(arguments, 1) : arguments, 
                ("undefined" == typeof id || -1 === openedModals.indexOf(id)) && (id = openedModals[openedModals.length - 1]);
                var modal = modals[id || openedModals[openedModals.length - 1]];
                if (modal && modal.$scope.modalShow === !0) {
                    var animDuration = getAnimDuration(angular.element(modal.$element[0].querySelector(".modal-content")));
                    $timeout(function() {
                        modal.$scope.modalShow = !1, $timeout(function() {
                            if (modal.$scope.$destroy(), modal.$element.remove(), modal.callbacksList = [], 
                            openedModals.splice(openedModals.indexOf(id || openedModals[openedModals.length - 1]), 1), 
                            0 === openedModals.length) self.waitingForOpen || (document.body.style.overflow = baseOverflow, 
                            $modalWrapper.css("display", "none")); else {
                                var topModal = modals[openedModals[openedModals.length - 1]];
                                topModal.$element.css("z-index", topModal.baseZIndex), topModal.$element.removeClass("no-backdrop");
                            }
                            "function" == typeof modal.params.onClose && modal.params.onClose.apply(void 0, args), 
                            deferred.resolve();
                        }, animDuration);
                    });
        ...
        return {
            ...
            replace: !0,
            scope: !0,
            template: '<div class="modal-dialog"><div class="modal-backdrop"></div><div class="modal-content {{customClass}}" ng-class="{opened: modalShow}" ng-if="modalTemplate"></div><div class="modal-content {{customClass}}" ng-class="{opened: modalShow}" ng-include="modalUrl"></div></div>',
            link: function($scope, $element, $attrs) {
                var $templateWrapper, id = $attrs.ocModal;
                $scope.closeModal = function() {
                    var args = Array.prototype.slice.call(arguments);
                    args.unshift(id), $ocModal.close.apply(void 0, args);
                }, $ocModal.register({
                    id: id,
                    $scope: $scope,
                    $element: $element
                    ...
                    "undefined" != typeof newVal && ($templateWrapper || ($templateWrapper = angular.element($element.children()[1])), 
                    $templateWrapper.append($compile(newVal)($scope)), $scope.$emit("$includeContentLoaded"));
                });
            }
        };
        ...
        return {
            ...
            link: function($scope, $element, $attrs) {
                $element.on("click touchstart", function(e) {
                    ...
                    var newScope = $scope.$new(), params = newScope.$eval($attrs.ocModalOpen);
                    if (params) {
                        if ("number" == typeof params ? params = {
                            url: $attrs.ocModalOpen
                        } : "string" == typeof params && (params = {
                            url: params
                        }), !params.url) throw "You need to set the modal url";
                        $scope.$apply(function() {
                            $ocModal.open(params);
                        });
                    }
        ...
        return {
            ...
            link: function($scope, $element, $attrs) {
                $element.on("click touchstart", function(e) {
                    e.preventDefault(), e.stopPropagation(), $scope.$apply(function() {
                        if ($attrs.ocModalClose) var params = $scope.$new().$eval($attrs.ocModalClose);
    ...
    function A(e, t, n) {
        ...
        return N(t, "string") || N(t, "undefined") ? k(i, t) : (i = (e + " " + d.join(r + " ") + r).split(" "), 
        L(i, t, n));
    }
    var l, w, S, r = "2.8.2", i = {}, s = !0, o = t.documentElement, u = "modernizr", a = t.createElement(u), f = a.style, h = ({}.toString, 
    "Webkit Moz O ms"), p = h.split(" "), d = h.toLowerCase().split(" "), v = {}, y = [], b = y.slice, E = {}.hasOwnProperty;
    S = N(E, "undefined") || N(E.call, "undefined") ? function(e, t) {
    ...
    return i.addTest = function(e, t) {
        if ("object" == typeof e) for (var r in e) S(e, r) && i.addTest(r, e[r]); else {
            if (e = e.toLowerCase(), i[e] !== n) return i;
            t = "function" == typeof t ? t() : t, "undefined" != typeof s && s && (o.className += " " + (t ? "" : "no-") + e), 
            i[e] = t;
        }
        return i;
        ...
        function d(e, n, r) {
            ...
            !o.canHaveChildren || i.test(e) || o.tagUrn ? o : r.frag.appendChild(o);
        }
        function v(e, n) {
            if (e || (e = t), l) return e.createDocumentFragment();
            n = n || p(e);
            for (var r = n.frag.cloneNode(), i = 0, s = h(), o = s.length; o > i; i++) r.createElement(s[i]);
            return r;
        }
        function m(e, t) {
        ...
        var o, l, n = "3.7.0", r = e.html5 || {}, i = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, s = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, u = "_html5shiv", a = 0, f = {};
        !function() {
            try {
        ...
        e.html5 = y, g(t);
    }(this, t), i._version = r, i._domPrefixes = d, i._cssomPrefixes = p, i.testProp = function(e) {
        return k([ e ]);
    }, i.testAllProps = A, o.className = o.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (s ? " js " + y.join(" ") : ""), 
    i;
    ...
    function addTimeToArrayFromToken(token, input, config) {
        ...
        switch (token) {
          ...
          case "MMM":
          case "MMMM":
            a = config._locale.monthsParse(input), null != a ? datePartArray[MONTH] = a : config._pf.invalidMonth = input;
            break;
    ...
    moment.normalizeUnits = function(units) {
        ...
        isAfter: function(input, units) {
            ...
            +this > +input) : +this.clone().startOf(units) > +moment(input).startOf(units);
        },
        isBefore: function(input, units) {
            return units = normalizeUnits("undefined" != typeof units ? units : "millisecond"), 
            "millisecond" === units ? (input = moment.isMoment(input) ? input : moment(input), 
            +input > +this) : +this.clone().startOf(units) < +moment(input).startOf(units);
        },
        isSame: function(input, units) {
            return units = normalizeUnits(units || "millisecond"), "millisecond" === units ? (input = moment.isMoment(input) ? input : moment(input), 
            +this === +input) : +this.clone().startOf(units) === +makeAs(input, this).startOf(units);
        },
    ...
    moment.fn.toJSON = moment.fn.toISOString, extend(moment.duration.fn = Duration.prototype, {
        ...
        as: function(units) {
            ...
            switch (days = this._days + yearsToDays(this._months / 12), units) {
              case "week":
    ...
    if ("object" == typeof exports) {
        ...
        var id = "moment";
        return moment = req.defined && req.defined(id) ? req(id) : void 0, factory(moment);
    ...
    var hasMoment = "function" == typeof moment, hasEventListeners = !!window.addEventListener, document = window.document, sto = window.setTimeout, addEvent = function(el, e, callback, capture) {
        ...
        var i, j, arr, monthHtml, yearHtml, opts = instance._o, month = instance._m, year = instance._y, isMinYear = year === opts.minYear, isMaxYear = year === opts.maxYear, html = '<div class="pika-title">', prev = !0, next = !0;
        ...
        for (monthHtml = '<div class="pika-label">' + opts.i18n.months[month] + '<select class="pika-select pika-select-month">' + arr.join("") + "</select></div>", 
        ...
        return yearHtml = '<div class="pika-label">' + year + opts.yearSuffix + '<select class="pika-select pika-select-year">' + arr.join("") + "</select></div>", 
        html += opts.showMonthAfterYear ? yearHtml + monthHtml : monthHtml + yearHtml, isMinYear && (0 === month || opts.minMonth >= month) && (prev = !1), 
        isMaxYear && (11 === month || opts.maxMonth <= month) && (next = !1), html += '<button class="pika-prev' + (prev ? "" : " is-disabled") + '" type="button">' + opts.i18n.previousMonth + "</button>", 
        ...
        self._onMouseDown = function(e) {
            ...
            if (target) {
                ...
                self._v && target !== opts.trigger && self.hide();
            }
    ...
    return Pikaday.prototype = {
        ...
        draw: function(force) {
            if (this._v || force) {
                ...
                this.el.innerHTML = renderTitle(this) + this.render(this._y, this._m), opts.bound && (this.adjustPosition(), 
                "hidden" !== opts.field.type && sto(function() {
                    opts.trigger.focus();
        ...
        adjustPosition: function() {
            var left, top, clientRect, field = this._o.trigger, pEl = field, width = this.el.offsetWidth, height = this.el.offsetHeight, viewportWidth = window.innerWidth || document.documentElement.clientWidth, viewportHeight = window.innerHeight || document.documentElement.clientHeight, scrollTop = window.pageYOffset || document.body.scrollTop || document.documentElement.scrollTop;
            if ("function" == typeof field.getBoundingClientRect) clientRect = field.getBoundingClientRect(), 
            ...
            top += pEl.offsetTop;
            (left + width > viewportWidth || this._o.position.indexOf("right") > -1 && left - width + field.offsetWidth > 0) && (left = left - width + field.offsetWidth), 
            (top + height > viewportHeight + scrollTop || this._o.position.indexOf("top") > -1 && top - height - field.offsetHeight > 0) && (top = top - height - field.offsetHeight), 
        ...
        destroy: function() {
            ...
            this._o.field && (removeEvent(this._o.field, "change", this._onInputChange), this._o.bound && (removeEvent(this._o.trigger, "click", this._onInputClick), 
            removeEvent(this._o.trigger, "focus", this._onInputFocus), removeEvent(this._o.trigger, "blur", this._onInputBlur))), 
    ...
    modules = [ "Mac.Util" ];
    try {
        angular.module("ngAnimate"), modules.push("ngAnimate");
    } catch (_error) {}
    angular.module("Mac", modules), cssExpand = [ "Top", "Right", "Bottom", "Left" ], 
    core_pnum = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, rnumnonpx = new RegExp("^(" + core_pnum + ")(?!px)[a-z%]+$", "i"), 
    getStyles = function(element) {
        return window.getComputedStyle(element, null);
    }, isWindow = function(obj) {
        return obj && obj.document && obj.location && obj.alert && obj.setInterval;
    }, isScope = function(obj) {
        return obj && null != obj.$evalAsync && null != obj.$watch;
    }, getWindow = function(element) {
        return isWindow(element) ? element : 9 === element.nodeType && element.defaultView;
    }, augmentWidthOrHeight = function(element, name, extra, isBorderBox, styles) {
        var i, start, _i;
        if (extra === (isBorderBox ? "border" : "content")) return 0;
        for (start = "Width" === name ? 1 : 0, i = _i = start; 3 >= _i; i = _i += 2) "margin" === extra && (val += parseFloat(styles["" + extra + cssExpand[i]])), 
        isBorderBox ? ("content" === extra && (val -= parseFloat(styles["padding" + cssExpand[i]])), 
        "margin" !== extra && (val -= parseFloat(styles["border" + cssExpand[i]]))) : (val += parseFloat(styles["padding" + cssExpand[i]]), 
        "padding" !== extra && (val += parseFloat(styles["border" + cssExpand + "Width"])));
        return val;
        ...
        return function(margin) {
            ...
            }(), extra = defaultExtra || (margin === !0 ? "margin" : "border"), isWindow(element)) return element.document.documentElement["client" + type];
            if (9 === element.nodeType) return doc = element.documentElement, Math.max(element.body["scroll" + type], doc["scroll" + type], element.body["offset" + type], doc["offset" + type], doc["client" + type]);
            if (valueIsBorderBox = !0, styles = getStyles(element), name = type.toLowerCase(), 
            value = "Height" === type ? element.offsetHeight : element.offsetWidth, isBorderBox = "border-box" === element.style.boxSizing, 
            0 >= value || null === value) {
                if (value = styles[name], (0 > value || null === value) && (value = element.style[name]), 
                rnumnonpx.test(value)) return value;
                valueIsBorderBox = isBorderBox, value = parseFloat(value) || 0;
            }
        ...
        offset: function(element) {
            ...
            return box = {
                top: 0,
                left: 0
            }, (doc = element && element.ownerDocument) ? (docElem = doc.documentElement, null != element.getBoundingClientRect && (box = element.getBoundingClientRect()), 
            win = getWindow(doc), {
        ...
        scrollTop: function(element, value) {
            var win;
            return win = getWindow(element), null == value ? win ? win.pageYOffset : element.scrollTop : win ? win.scrollTo(window.pageYOffset, value) : element.scrollTop = value;
        },
        scrollLeft: function(element, value) {
            var win;
            return win = getWindow(element), null == value ? win ? win.pageXOffset : element.scrollLeft : win ? win.scrollTo(window.pageXOffset, value) : element.scrollLeft = value;
        }
    }, (extendjQuery = function() {
        var jqLite;
        if (null == window.jQuery || null == angular.element.prototype.offset) return jqLite = angular.element, 
        angular.forEach(jqLiteExtend, function(fn, name) {
            return jqLite.prototype[name] = function(arg1, arg2) {
                return this.length ? fn(this[0], arg1, arg2) : void 0;
            };
        });
    })();
    ...
    angular.module("Mac.Util", []).factory("util", [ "$filter", function($filter) {
        return {
            ...
            pluralize: function(string, count, includeCount) {
                ...
                if (null == string && (string = ""), null == includeCount && (includeCount = !1), 
                !angular.isString(string) || 0 === this.trim(string).length) return string;
                if (includeCount && isNaN(+count)) return "";
                if (null == count && (count = 2), _ref = this._inflectionConstants, pluralizers = _ref.pluralizers, 
                uncountables = _ref.uncountables, irregulars = _ref.irregulars, word = string.split(/\s/).pop(), 
                isUppercase = word.toUpperCase() === word, lowercaseWord = word.toLowerCase(), pluralizedWord = 1 === count || uncountables.indexOf(lowercaseWord) >= 0 ? word : null, 
                null == pluralizedWord && null != irregulars[lowercaseWord] && (pluralizedWord = irregulars[lowercaseWord]), 
                null == pluralizedWord) for (_i = 0, _len = pluralizers.length; _len > _i; _i++) if (pluralizer = pluralizers[_i], 
                pluralizer[0].test(lowercaseWord)) {
                    pluralizedWord = word.replace(pluralizer[0], pluralizer[1]);
                    break;
                }
                return pluralizedWord || (pluralizedWord = word), isUppercase && (pluralizedWord = pluralizedWord.toUpperCase()), 
                pluralizedString = string.slice(0, -word.length) + pluralizedWord, includeCount ? "" + $filter("number")(count) + " " + pluralizedString : pluralizedString;
            },
            trim: function(string) {
                var str;
                return str = String(string) || "", null != String.prototype.trim ? str.trim() : str.replace(/^\s+|\s+$/gm, "");
            },
            capitalize: function(string) {
                var str;
                return str = String(string) || "", str.charAt(0).toUpperCase() + str.substring(1);
            },
            uncapitalize: function(string) {
                var str;
                return str = String(string) || "", str.charAt(0).toLowerCase() + str.substring(1);
            },
            toCamelCase: function(string) {
                return null == string && (string = ""), this.trim(string).replace(/[-_\s]+(.)?/g, function(match, c) {
                    return c.toUpperCase();
                });
            },
            toSnakeCase: function(string) {
                return null == string && (string = ""), this.trim(string).replace(/([a-z\d])([A-Z]+)/g, "$1_$2").replace(/[-\s]+/g, "_").toLowerCase();
            },
            convertKeysToCamelCase: function(object) {
                var key, result, value;
                result = {};
                for (key in object) __hasProp.call(object, key) && (value = object[key], key = this.toCamelCase(key), 
                "object" == typeof value && (null != value ? value.constructor : void 0) !== Array && (value = this.convertKeysToCamelCase(value)), 
                result[key] = value);
                return result;
            },
            convertKeysToSnakeCase: function(object) {
                var key, result, value;
                result = {};
                for (key in object) __hasProp.call(object, key) && (value = object[key], key = this.toSnakeCase(key), 
                "object" == typeof value && (null != value ? value.constructor : void 0) !== Array && (value = this.convertKeysToSnakeCase(value)), 
                result[key] = value);
                return result;
            },
            pyth: function(a, b) {
            ...
            hex2rgb: function(hex) {
                var color, rgb, value;
                0 === hex.indexOf("#") && (hex = hex.substring(1)), hex = hex.toLowerCase(), rgb = {}, 
                3 === hex.length ? (rgb.r = hex.charAt(0) + hex.charAt(0), rgb.g = hex.charAt(1) + hex.charAt(1), 
                rgb.b = hex.charAt(2) + hex.charAt(2)) : (rgb.r = hex.substring(0, 2), rgb.g = hex.substring(2, 4), 
                rgb.b = hex.substring(4));
                for (color in rgb) value = rgb[color], rgb[color] = parseInt(value, 16);
                return rgb;
            },
            ...
            validateUrl: function(url) {
                var match;
                return match = this._urlRegex.exec(url), null != match && (match = {
                    url: match[0],
            ...
            getQueryString: function(url, name) {
                ...
                return null == name && (name = ""), name = name.replace(/[[]/, "[").replace(/[]]/, "]"), 
                regexS = "[?&]" + name + "=([^&#]*)", regex = new RegExp(regexS), results = regex.exec(url), 
            ...
            parseUrlPath: function(fullPath) {
                ...
                if (urlComponents = fullPath.split("?"), pathComponents = urlComponents[0].split("/"), 
                path = pathComponents.slice(0, pathComponents.length - 1).join("/"), verb = pathComponents[pathComponents.length - 1], 
                queries = {}, urlComponents.length > 1) for (queryStrings = urlComponents[urlComponents.length - 1], 
                _ref = queryStrings.split("&"), _i = 0, _len = _ref.length; _len > _i; _i++) queryString = _ref[_i], 
                values = queryString.split("="), queries[values[0]] = null != values[1] ? values[1] : "";
                return {
                    fullPath: fullPath,
                    path: path,
            ...
            extendAttributes: function(prefix, defaults, attributes) {
                ...
                null == prefix && (prefix = ""), output = {};
                for (key in defaults) __hasProp.call(defaults, key) && (value = defaults[key], altKey = prefix ? this.capitalize(key) : key, 
                macKey = "" + prefix + altKey, output[key] = null != attributes[macKey] ? attributes[macKey] || !0 : value, 
                "true" === (_ref = output[key]) || "false" === _ref ? output[key] = "true" === output[key] : (null != (_ref1 = output[key]) ? _ref1.length : void 0) > 0 && !isNaN(+output[key]) && (output[key] = +output[key]));
                return output;
            }
        };
    ...
    for (_ref = [ "Enter", "Escape", "Space", "Left", "Up", "Right", "Down" ], _fn = function(key) {
        return angular.module("Mac").directive("macKeydown" + key, [ "$parse", "keys", function($parse, keys) {
            return {
                restrict: "A",
                link: function(scope, element, attributes) {
                    var expression;
                    return expression = $parse(attributes["macKeydown" + key]), element.bind("keydown", function($event) {
                        return $event.which === keys["" + key.toUpperCase()] ? ($event.preventDefault(), 
                        scope.$apply(function() {
    ...
    }, _i = 0, _len = _ref.length; _len > _i; _i++) key = _ref[_i], _fn(key);
    angular.module("Mac").directive("macPauseTyping", [ "$parse", "$timeout", function($parse, $timeout) {
        return {
            restrict: "A",
            link: function(scope, element, attributes) {
                var delay, expression, keyupTimer;
                return expression = $parse(attributes.macPauseTyping), delay = scope.$eval(attributes.macPauseTypingDelay) || 800, 
                keyupTimer = null, element.bind("keyup", function($event) {
                    return null != keyupTimer && $timeout.cancel(keyupTimer), keyupTimer = $timeout(function() {
                        return expression(scope, {
                            $event: $event
                        });
                    }, delay);
        ...
        return {
            ...
            link: function($scope, element, attrs) {
                ...
                return handler = function($event) {
                    var callbackFn;
                    return callbackFn = $parse(attrs.macWindowResize), $scope.$apply(function() {
                        return callbackFn($scope, {
                            $event: $event
                        });
                    }), !0;
                }, angular.element($window).bind("resize", handler), $scope.$on("destroy", function() {
                    return angular.element($window).unbind("resize", handler);
                });
            }
        };
    } ]), angular.module("Mac").directive("macAutocomplete", [ "$animate", "$compile", "$filter", "$http", "$parse", "$rootScope", "$timeout", "keys", function($animate, $compile, $filter, $http, $parse, $rootScope, $timeout, keys) {
        return {
            restrict: "EA",
            ...
            link: function($scope, element, attrs, ctrl, transclude) {
                ...
                return labelKey = attrs.macAutocompleteLabel || "name", labelGetter = $parse(labelKey), 
                queryKey = attrs.macAutocompleteQuery || "q", delay = +(attrs.macAutocompleteDelay || 800), 
                inside = null != attrs.macAutocompleteInside, autocompleteUrl = $parse(attrs.macAutocompleteUrl), 
                onSelect = $parse(attrs.macAutocompleteOnSelect), onSuccess = $parse(attrs.macAutocompleteOnSuccess), 
                onError = $parse(attrs.macAutocompleteOnError), source = $parse(attrs.macAutocompleteSource), 
                disabled = $parse(attrs.macAutocompleteDisabled), currentAutocomplete = [], timeoutId = null, 
                isMenuAppended = !1, preventParser = !1, $menuScope = $scope.$new(), $menuScope.items = [], 
                $menuScope.index = 0, $menuScope.select = function(index) {
                    var label, selected;
                    return selected = currentAutocomplete[index], onSelect($scope, {
                        selected: selected
                    }), label = $menuScope.items[index].label || "", preventParser = !0, null != attrs.ngModel && (ctrl.$setViewValue(label), 
                    ctrl.$render()), reset();
                }, menuEl = angular.element(document.createElement("mac-menu")), menuEl.attr({
                ...
                }), $compile(menuEl)($menuScope), ctrl.$parsers.push(function(value) {
                    return !value || disabled($scope) || preventParser ? reset() : (null != timeoutId && $timeout.cancel(timeoutId), 
                    delay > 0 ? timeoutId = $timeout(function() {
                        return queryData(value);
                    }, delay) : queryData(value)), preventParser = !1, value;
                }), blurHandler = function() {
                    return $scope.$apply(function() {
                        return reset();
                    });
                }, appendMenu = function(callback) {
                    return isMenuAppended || (element.bind("blur", blurHandler), menuEl.on("mousedown", function(event) {
                        return event.preventDefault();
                    })), isMenuAppended = !0, inside ? $animate.enter(menuEl, void 0, element, callback) : $animate.enter(menuEl, angular.element(document.body), void 0, callback);
                }, reset = function() {
                    $animate.leave(menuEl, function() {
                        return $menuScope.index = 0, $menuScope.items.length = 0, menuEl[0].style.top = "", 
                        menuEl[0].style.left = "", isMenuAppended = !1, element.unbind("blur", blurHandler);
                    });
                }, positionMenu = function() {
                    var offset, parentElement, parentStyles;
                    return parentElement = inside ? element[0] : document.body, parentStyles = window.getComputedStyle(parentElement), 
                    offset = element.offset(), offset.left -= parseInt(parentStyles.marginLeft), offset.top += element.outerHeight() - parseInt(parentStyles.marginTop), 
                    offset.minWidth = element.outerWidth(), angular.forEach(offset, function(value, key) {
                        return !isNaN(+value) && angular.isNumber(+value) && (value = "" + value + "px"), 
                        menuEl[0].style[key] = value;
                    });
                }, updateItem = function(data) {
                    return (null != data ? data.length : void 0) > 0 ? (currentAutocomplete = data, 
                    $menuScope.items = data.map(function(item) {
                        return angular.isObject(item) ? (null == item.value && (item.value = labelGetter(item) || ""), 
                        null == item.label && (item.label = labelGetter(item) || ""), item) : {
                            label: item,
                            value: item
                        };
                    }), appendMenu(positionMenu)) : reset();
                    ...
                    return options = {
                        ...
                        url: url,
                        params: {}
                    }, options.params[queryKey] = query, $http(options).success(function(data, status, headers) {
                        var dataList;
                        return dataList = onSuccess($scope, {
                            data: data,
                            status: status,
                            headers: headers
                        }), null == dataList && (dataList = data.data), updateItem(dataList);
                    ...
                    var sourceData, url;
                    return url = autocompleteUrl($scope), url ? getData(url, query) : (sourceData = source($scope), 
                    angular.isArray(sourceData) ? updateItem($filter("filter")(sourceData, query)) : angular.isString(sourceData) ? getData(sourceData, query) : angular.isFunction(sourceData) ? sourceData(query, updateItem) : void 0);
                }, element.bind("keydown", function(event) {
                    if (0 === $menuScope.items.length) return !0;
                    switch (event.which) {
                      case keys.DOWN:
                        $scope.$apply(function() {
                            return $menuScope.index = ($menuScope.index + 1) % $menuScope.items.length, event.preventDefault();
                        });
                        break;
                      ...
                      case keys.ENTER:
                        $scope.$apply(function() {
                            return $menuScope.select($menuScope.index), event.preventDefault();
                        });
                        break;

                      case keys.ESCAPE:
                        $scope.$apply(function() {
                            return reset(), event.preventDefault();
                        });
                    }
                    return !0;
                }), $scope.$on("$destroy", function() {
                    return $menuScope.$destroy(), reset();
                }), $scope.$on("reset-mac-autocomplete", function() {
                    return reset();
                });
            }
        };
    } ]), angular.module("Mac").directive("macFocusOnEvent", [ "$timeout", function($timeout) {
        return function(scope, element, attributes) {
            return scope.$on(attributes.macFocusOnEvent, function() {
                return $timeout(function() {
                    var x, y;
                    return element.focus(), attributes.macFocusOnEventScroll ? (x = window.scrollX, 
                    y = window.scrollY, window.scrollTo(x, y)) : void 0;
                }, 0, !1);
            });
        };
        ...
        return {
            ...
            link: function($scope, element, attrs) {
                return $scope.selectItem = function(index) {
                    ...
                    return $scope.index = index, null != attrs.macMenuIndex ? $scope.pIndex = parseInt(index) : void 0;
                }, null != attrs.macMenuIndex && $scope.$watch("pIndex", function(value) {
                    return $scope.index = parseInt(value);
                }), $scope.$watch("items.length", function(value) {
                    return value ? attrs.$addClass("visible") : attrs.$removeClass("visible");
                });
            }
        };
        ...
        return {
            link: function($scope, element, attrs, ctrls, transclude) {
                return transclude($scope, function(clone) {
                    return element.empty(), 0 === clone.length && (clone = $compile("<span>{{item.label}}</span>")($scope)), 
                    element.append(clone);
                });
            }
        };
    } ]), angular.module("Mac").service("modal", [ "$rootScope", "$animate", "$templateCache", "$compile", "$http", "$controller", "modalViews", "keys", function($rootScope, $animate, $templateCache, $compile, $http, $controller, modalViews, keys) {
        return {
            ...
            show: function(id, triggerOptions) {
                ...
                if (null == triggerOptions && (triggerOptions = {}), null != this.registered[id] && null != this.opened) return this.hide();
                if (null == this.registered[id]) return this.waiting = {
                    id: id,
                    options: triggerOptions
                };
                if (modalObject = this.registered[id], options = modalObject.options, showOptions = {}, 
                angular.extend(showOptions, options, triggerOptions), showModal = function(_this) {
                    return function(element) {
                        return showOptions.beforeShow(element.scope()), $animate.removeClass(element, "hide", function() {
                            return $animate.addClass(element, "visible", function() {
                                return _this.opened = {
                                    id: id,
                                    element: element,
                                    options: showOptions
                                }, _this.resize(_this.opened), _this.bindingEvents(), showOptions.open(element.scope()), 
                                showOptions.afterShow(element.scope()), $rootScope.$broadcast("modalWasShown", id), 
                                _this.clearWaiting();
                            });
                        });
                    };
                }(this), null != showOptions.moduleMethod) {
                    if (renderModal = function(_this) {
                        return function(template) {
                            var element, viewScope, wrapper;
                            return isScope(showOptions.scope) ? viewScope = showOptions.scope : (viewScope = $rootScope.$new(!0), 
                            angular.isObject(showOptions.scope) && angular.extend(viewScope, showOptions.scope)), 
                            ...
                            wrapper.html(template), showOptions.overlayClose && element.bind("click", function($event) {
                                return angular.element($event.target).hasClass("mac-modal-overlay") ? viewScope.$apply(function() {
                                    return _this.hide();
                                }) : void 0;
                            }), showOptions.controller && $controller(showOptions.controller, {
                                $scope: viewScope,
                                $element: element,
                                macModalOptions: showOptions
                            }), $animate.enter(element, angular.element(document.body)), $compile(element)(viewScope), 
                            showModal(element);
                        };
                    }(this), path = showOptions.templateUrl) return template = $templateCache.get(path), 
                    template ? renderModal(template) : $http.get(path).then(function(resp) {
                        return $templateCache.put(path, resp.data), renderModal(resp.data);
                    }, function() {
                        throw Error("Failed to load template: " + path);
                    });
                    if (template = showOptions.template) return renderModal(template);
                } else if (null != modalObject.element) return showModal(modalObject.element);
            },
            resize: function(modalObject) {
                var css, element, height, modal, options, width;
                return null == modalObject && (modalObject = this.opened), null != modalObject && (element = modalObject.element, 
                options = modalObject.options, options.position) ? (modal = angular.element(element[0].getElementsByClassName("mac-modal")).attr("style", ""), 
                height = modal.outerHeight(), width = modal.outerWidth(), css = angular.element(window).height() > height ? {
                    marginTop: -height / 2
                } : {
                    top: options.topOffset
                }, css.marginLeft = -width / 2, angular.forEach(css, function(value, key) {
                    return !isNaN(+value) && angular.isNumber(+value) && (value = "" + value + "px"), 
                    modal.css(key, value);
                })) : void 0;
            },
            hide: function(callback) {
                ...
                if (null != this.opened) return _ref = this.opened, id = _ref.id, options = _ref.options, 
                element = _ref.element, options.beforeHide(element.scope()), $animate.removeClass(element, "visible", function(_this) {
                    return function() {
                        return _this.bindingEvents("unbind"), _this.opened = null, options.moduleMethod ? (isScope(options.scope) || element.scope().$destroy(), 
                        $animate.leave(element)) : $animate.addClass(element, "hide"), options.afterHide(element.scope()), 
                        $rootScope.$broadcast("modalWasHidden", id), callback && callback();
                    };
                }(this));
            },
            bindingEvents: function(action) {
                var escapeKeyHandler, options, resizeHandler;
                return null == action && (action = "bind"), "bind" !== action && "unbind" !== action || null == this.opened ? void 0 : (escapeKeyHandler = function(_this) {
                    return function(event) {
                        return event.which === keys.ESCAPE ? _this.hide() : void 0;
                    };
                }(this), resizeHandler = function(_this) {
                    return function() {
                        return _this.resize();
                    };
                }(this), options = this.opened.options, options.keyboard && angular.element(document)[action]("keydown", escapeKeyHandler), 
                options.resize ? angular.element(window)[action]("resize", resizeHandler) : void 0);
            },
            register: function(id, element, options) {
                var modalOpts;
                if (null != this.registered[id]) throw new Error("Modal " + id + " already registered");
                return modalOpts = {}, angular.extend(modalOpts, modalViews.defaults, options), 
                this.registered[id] = {
                    id: id,
                    element: element,
                    options: modalOpts
                }, null != this.waiting && this.waiting.id === id ? this.show(id, this.waiting.options) : void 0;
            },
            unregister: function(id) {
                var _ref;
                if (null == this.registered[id]) throw new Error("Modal " + id + " is not registered");
                return (null != (_ref = this.opened) ? _ref.id : void 0) === id && this.hide(), 
                this.clearWaiting(id), delete this.registered[id];
            },
            clearWaiting: function(id) {
                var _ref;
                if (null == id || (null != (_ref = this.waiting) ? _ref.id : void 0) === id) return this.waiting = null;
            }
        };
    } ]).provider("modalViews", function() {
        return this.registered = {}, this.defaults = {
            keyboard: !1,
            overlayClose: !1,
            resize: !0,
            position: !0,
    ...
    }).config([ "modalViewsProvider", function(modalViews) {
        return angular.module("Mac").modal = function(id, modalOptions) {
            var options;
            return null == modalViews.registered[id] ? (options = {}, angular.extend(options, modalViews.defaults, modalOptions, {
                moduleMethod: !0
            }), modalViews.registered[id] = {
                id: id,
                options: options
            }) : void 0;
        };
    ...
    }).service("popover", [ "$animate", "$compile", "$controller", "$http", "$rootScope", "$templateCache", "$timeout", "popoverViews", function($animate, $compile, $controller, $http, $rootScope, $templateCache, $timeout, popoverViews) {
        var service;
        return service = {
            popoverList: [],
            ...
            register: function(id, options) {
                var exist;
                return (exist = null != this.registered[id]) || (this.registered[id] = options), 
                !exist;
            },
            unregister: function(id) {
                var exist;
                return (exist = null != this.registered[id]) && delete this.registered[id], exist;
            },
            add: function(id, popover, element, options) {
                ...
                return newObject = {
                    ...
                    element: element,
                    options: options
                }, this.popoverList.push(newObject), newObject;
            },
            pop: function() {
            ...
            show: function(id, element, options) {
                ...
                return null == options && (options = {}), (popoverOptions = this.registered[id]) ? (addPopover = function() {
                    var path, showPopover, template;
                    return showPopover = function(template) {
                        var popover, popoverObj, viewScope;
                        return isScope(options.scope) ? viewScope = options.scope.$new() : (viewScope = $rootScope.$new(!0), 
                        angular.isObject(options.scope) && angular.extend(viewScope, options.scope)), popoverOptions.refreshOn && viewScope.$on(popoverOptions.refreshOn, function() {
                            return service.resize(id);
                        }), popoverOptions.controller && $controller(popoverOptions.controller, {
                            $scope: viewScope
                        }), angular.extend(viewScope, {
                            macPopoverClasses: {
                                footer: popoverOptions.footer || !1,
                                header: popoverOptions.header || !!popoverOptions.title || !1,
                                fixed: popoverOptions.fixed || !1
                            },
                            macPopoverTitle: popoverOptions.title || "",
                            macPopoverTemplate: template
                        }), popover = $compile(popoverViews.template)(viewScope), popover.attr({
                            id: id,
                            direction: popoverOptions.direction || "below left"
                        }), popoverObj = service.add(id, popover, element, options), $animate.addClass(element, "active"), 
                        $rootScope.$broadcast("popoverWasShown", id), $animate.enter(popover, angular.element(document.body), null, function() {
                            return service.resize(popoverObj);
                        });
                    }, (template = popoverOptions.template) ? showPopover(template) : (path = popoverOptions.templateUrl) ? (template = $templateCache.get(path), 
                    template ? showPopover(template) : $http.get(path).then(function(resp) {
                        return $templateCache.put(path, resp.data), showPopover(resp.data);
                    }, function() {
                        throw new Error("Failed to load template: #{path}");
                    })) : void 0;
                }, service.popoverList.length && !options.childPopover ? service.hide(addPopover) : addPopover(), 
                !0) : !1;
            },
            getById: function(id, element) {
                var item, sameTrigger, _i, _len, _ref;
                for (_ref = this.popoverList, _i = 0, _len = _ref.length; _len > _i; _i++) if (item = _ref[_i], 
                sameTrigger = null == element || item.element === element, item.id === id && sameTrigger) return item;
            },
            resize: function(popoverObj) {
                ...
                return angular.isString(popoverObj) && (popoverObj = service.getById(popoverObj)), 
                null != popoverObj ? (currentPopover = popoverObj.popover, relativeElement = popoverObj.element, 
                options = popoverObj.options, $window = angular.element(window), offset = relativeElement.offset(), 
                ...
                }, top = 0, left = 0, position = (currentPopover.attr("direction") || "top left").trim(), 
                setOverflowPosition = function(offset) {
                    var tip, tipOffset;
                    return null == offset && (offset = 0), tip = angular.element(currentPopover[0].getElementsByClassName("tip")), 
                    top -= offset, tipOffset = +tip.css("margin-top").replace("px", ""), tip.css("margin-top", tipOffset + offset);
                }, updateOffset = function() {
                    switch (position) {
                      case "above left":
                        return top = -(current.height + 10), left = -25 + relative.width / 2;

                      case "above right":
                        return top = -(current.height + 10), left = 25 + relative.width / 2 - current.width;

                      case "below left":
                        return top = relative.height + 10, left = -25 + relative.width / 2;

                      case "below right":
                        return top = relative.height + 10, left = 25 + relative.width / 2 - current.width;

                      case "middle right":
                        return top = relative.height / 2 - current.height / 2, left = relative.width + 10;

                      case "middle left":
                        return top = relative.height / 2 - current.height / 2, left = -(current.width + 10);
                    }
                }, updateOffset(), topScroll = options.fixed ? 0 : $window.scrollTop(), leftScroll = options.fixed ? 0 : $window.scrollLeft(), 
                action = {}, -1 === position.indexOf("middle") ? offset.top + top - topScroll < 0 ? action = {
                    remove: "above",
                    add: "below"
                } : offset.top + top + current.height - topScroll > $window.height() && (action = {
                    remove: "below",
                    add: "above"
                }) : (diff = offset.top + top - topScroll) < 0 ? setOverflowPosition(diff) : (diff = offset.top + top + currentPopover.outerHeight() - topScroll - $window.height()) > 0 && setOverflowPosition(diff), 
                action.remove && action.add && (position = position.replace(action.remove, action.add)), 
                action = {}, offset.left + left - leftScroll < 0 ? action = {
                    remove: "right",
                    add: "left"
                } : offset.left + left + currentPopover.outerWidth() - leftScroll > $window.width() && (action = {
                    remove: "left",
                    add: "right"
                }), action.remove && action.add && (position = position.replace(action.remove, action.add)), 
                updateOffset(), offset.top += top, offset.left += left, null != options.offsetX && (offset.left += options.offsetX), 
                null != options.offsetY && (offset.top += options.offsetY), angular.forEach(offset, function(value, key) {
                    return isNaN(+value) || (value = "" + value + "px"), currentPopover.css(key, value);
                }), currentPopover.addClass("visible " + position)) : void 0;
            },
            hide: function(selector, callback) {
                var comparator, i, index, popoverObj, removeScope, _i, _ref;
                if (!this.popoverList.length) return "function" == typeof callback ? callback() : void 0;
                if (angular.isFunction(selector) && (callback = selector, selector = null), null != selector) {
                    for (comparator = angular.isString(selector) ? function(item) {
                        return item.id === selector;
                    } : angular.isElement(selector) ? function(item) {
                        return item.element === selector;
                    } : void 0, index = -1, i = _i = _ref = this.popoverList.length - 1; _i >= 0; i = _i += -1) if (comparator(this.popoverList[i])) {
                        popoverObj = this.popoverList[i], index = i;
                        break;
                    }
                    index > -1 && this.popoverList.splice(index, 1);
                } else popoverObj = this.pop();
                return null != popoverObj ? ($rootScope.$broadcast("popoverBeforeHide", popoverObj.id), 
                removeScope = popoverObj.popover.scope(), $animate.leave(popoverObj.popover, function() {
                    return $animate.removeClass(popoverObj.element, "active"), $rootScope.$broadcast("popoverWasHidden", popoverObj.id), 
                    removeScope.$destroy(), "function" == typeof callback ? callback() : void 0;
                })) : void 0;
            },
            hideAll: function() {
    ...
    } ]).config([ "popoverViewsProvider", function(popoverViews) {
        return angular.module("Mac").popover = function(name, options) {
            var opts;
            return null == popoverViews.registered[name] ? (opts = {}, angular.extend(opts, popoverViews.popoverDefaults, options, {
                id: name
            }), popoverViews.registered[name] = opts) : void 0;
        };
    } ]), angular.module("Mac").directive("macModal", [ "$parse", "modal", "modalViews", "util", function($parse, modal, modalViews, util) {
        return {
            restrict: "E",
            ...
            link: function($scope, element, attrs, controller, transclude) {
                ...
                for (transclude($scope, function(clone) {
                    return angular.element(element[0].getElementsByClassName("mac-modal-content-wrapper")).replaceWith(clone);
                }), opts = util.extendAttributes("macModal", modalViews.defaults, attrs), regId = null, 
                opts.overlayClose && element.on("click", function($event) {
                    return angular.element($event.target).hasClass("mac-modal-overlay") ? $scope.$apply(function() {
                        return modal.hide();
                    }) : void 0;
                }), _ref = [ "beforeShow", "afterShow", "beforeHide", "afterHide", "open" ], _i = 0, 
                _len = _ref.length; _len > _i; _i++) callback = _ref[_i], key = "macModal" + util.capitalize(callback), 
                opts[callback] = $parse(attrs[key]) || angular.noop;
                return registerModal = function(id) {
                    return null != id && id ? (regId = id, modal.register(id, element, opts)) : void 0;
                }, attrs.id ? registerModal(attrs.id) : attrs.$observe("macModal", function(id) {
                    return registerModal(id);
                }), $scope.$on("$destroy", function() {
                    return regId ? modal.unregister(regId) : void 0;
                });
            }
        };
    } ]).directive("macModal", [ "$parse", "modal", function($parse, modal) {
        return {
            restrict: "A",
            link: function($scope, element, attrs) {
                attrs.macModal && element.bind("click", function() {
                    return $scope.$apply(function() {
                        var data;
                        return data = $parse(attrs.macModalData)($scope) || {}, modal.show(attrs.macModal, {
                            data: data,
                            scope: $scope
                        });
                    });
    ...
    } ]).directive("macModalClose", [ "modal", function(modal) {
        return {
            restrict: "A",
    ...
    angular.module("Mac").directive("macPopover", [ "$timeout", "popover", "util", "popoverViews", function($timeout, popover, util, popoverViews) {
        return {
            restrict: "A",
            link: function(scope, element, attrs) {
                var clearDelays, closeDelayId, delayId, exclude, excludeList, hide, options, show;
                return options = util.extendAttributes("macPopover", popoverViews.defaults, attrs), 
                exclude = attrs.macPopoverExclude || "", excludeList = exclude ? exclude.split(",") : [], 
                delayId = null, closeDelayId = null, clearDelays = function() {
                    return null != delayId && $timeout.cancel(delayId), null != closeDelayId ? $timeout.cancel(closeDelayId) : void 0;
                }, show = function(id, delay) {
                    return null == delay && (delay = 0), clearDelays(), delayId = $timeout(function() {
                        var last, _ref;
                        return last = popover.last(), null != last && (!excludeList.length || (_ref = last.id, 
                        __indexOf.call(excludeList, _ref) >= 0) || last.id === id) && (popover.hide(), element[0] === last.element[0]) ? !0 : (options.scope = scope, 
                        popover.show(id, element, options));
                    }, delay), !0;
                }, hide = function(element, delay) {
                    return null == delay && (delay = 0), clearDelays(), closeDelayId = $timeout(function() {
                        return popover.hide(element);
                    }, delay);
                }, attrs.$observe("macPopover", function(id) {
                    var hideEvent, showEvent;
                    if (id) return "click" === options.trigger ? element.bind("click", function() {
                        return show(id, 0);
                    }) : (showEvent = "focus" === options.trigger ? "focusin" : "mouseenter", hideEvent = "focus" === options.trigger ? "focusout" : "mouseleave", 
    ...
    } ]).directive("macPopover", [ "popover", "popoverViews", "util", function(popover, popoverViews, util) {
        return {
            restrict: "E",
            compile: function(element, attrs) {
                var opts;
                if (!attrs.id) throw Error("macPopover: Missing id");
                return opts = util.extendAttributes("macPopover", popoverViews.popoverDefaults, attrs), 
                angular.extend(opts, {
                    template: element.html()
                }), element.replaceWith(document.createComment("macPopover: " + attrs.id)), function($scope, element, attrs) {
        ...
        return {
            restrict: "A",
            link: function($scope, element) {
                return element.html($scope.macPopoverTemplate), $compile(element.contents())($scope);
            }
        };
    ...
    }), angular.module("Mac").service("scrollSpy", [ function() {
        return {
            registered: [],
            active: {},
            listeners: [],
            register: function(id, element) {
                ...
                for (registered = !1, top = element.offset().top, _ref = this.registered, i = _i = 0, 
                _len = _ref.length; _len > _i; i = ++_i) if (anchor = _ref[i], anchor.id === id) {
                    this.registered[i] = {
                        id: id,
                        element: element,
                        top: top
                ...
                return registered || this.registered.push({
                    id: id,
                    element: element,
                    top: top
            ...
            unregister: function(id) {
                ...
                for (_ref = this.registered, _results = [], i = _i = 0, _len = _ref.length; _len > _i; i = ++_i) if (anchor = _ref[i], 
                anchor.id === id) {
            ...
            setActive: function(anchor) {
                ...
                for (this.active = anchor, _ref = this.listeners, _results = [], _i = 0, _len = _ref.length; _len > _i; _i++) listener = _ref[_i], 
            ...
            removeListener: function(fn) {
                var index, _ref;
                return index = this.listeners.indexOf(fn), -1 !== index ? ([].splice.apply(this.listeners, [ index, index - index + 1 ].concat(_ref = [])), 
                _ref) : void 0;
            }
        };
    } ]).constant("scrollSpyDefaults", {
        offset: 0
    }), angular.module("Mac").directive("macScrollSpy", [ "$window", "scrollSpy", "scrollSpyDefaults", "util", function($window, scrollSpy, defaults, util) {
        return {
            link: function($scope, element, attrs) {
                var options, spyElement;
                return options = util.extendAttributes("macScrollSpy", defaults, attrs), spyElement = "BODY" === element[0].tagName ? angular.element($window) : element, 
                spyElement.bind("scroll", function() {
                    var anchors, i, maxScroll, scrollHeight, scrollTop, _i, _ref;
                    if (scrollTop = spyElement.scrollTop() + options.offset, scrollHeight = this.scrollHeight || element[0].scrollHeight, 
                    maxScroll = scrollHeight - spyElement.height(), !scrollSpy.registered.length) return !0;
                    if (scrollTop >= maxScroll) return scrollSpy.setActive(scrollSpy.last());
                    for (i = _i = 0, _ref = scrollSpy.registered.length - 1; _ref >= 0 ? _ref >= _i : _i >= _ref; i = _ref >= 0 ? ++_i : --_i) if (anchors = scrollSpy.registered, 
                    scrollSpy.active.id !== anchors[i].id && scrollTop >= anchors[i].top && (!anchors[i + 1] || scrollTop <= anchors[i + 1].top)) return $scope.$apply(function() {
        ...
        return {
            link: function($scope, element, attrs) {
                ...
                if (id = attrs.id || attrs.macScrollSpyAnchor, registered = !1, !id) throw new Error("Missing scroll spy anchor id");
                return registering = function() {
                    return scrollSpy.register(id, element), registered || $scope.$on("$destroy", function() {
                        return scrollSpy.unregister(id);
                    }), registered = !0;
                }, $scope.$on("refresh-scroll-spy", registering), /{{(.*)}}/.test(id) ? (observeKey = attrs.id ? "id" : "macScrollSpyAnchor", 
                attrs.$observe(observeKey, function(value) {
                    return null != value && value ? (id = value, registering()) : void 0;
                })) : registering();
            }
        };
    } ]).directive("macScrollSpyTarget", [ "scrollSpy", function(scrollSpy) {
        return {
            link: function($scope, element, attrs) {
                var highlightClass, register, registered, target;
                if (target = attrs.macScrollSpyTarget, highlightClass = attrs.macScrollSpyTargetClass || "active", 
                registered = !1, !target) throw new Error("Missing scroll spy target name");
                return register = function(id) {
                    var callback;
                    if (id) return callback = function(active) {
                        var action;
                        return action = id === active.id ? "addClass" : "removeClass", element[action](highlightClass);
                    }, null != scrollSpy.active && callback(scrollSpy.active), registered ? void 0 : (scrollSpy.addListener(callback), 
                    $scope.$on("$destroy", function() {
                        return scrollSpy.removeListener(callback);
                    }));
                }, /{{(.*)}}/.test(target) ? attrs.$observe("macScrollSpyTarget", function(value) {
        ...
        return {
            link: function($scope, element, attrs) {
                ...
                }, disabled = defaults.disabled, lastAffix = null, unpin = null, pinnedOffset = null, 
                windowEl = angular.element($window), setOffset = function(key, value, useDefault) {
                    return null == useDefault && (useDefault = !1), useDefault && null == value && (value = defaults[key]), 
                    null == value || isNaN(+value) ? void 0 : offset[key] = +value;
                }, null != attrs.macAffixTop && (setOffset("top", $scope.$eval(attrs.macAffixTop), !0), 
                $scope.$watch(attrs.macAffixTop, function(value) {
                    return setOffset("top", value);
                })), null != attrs.macAffixBottom && (setOffset("bottom", $scope.$eval(attrs.macAffixBottom), !0), 
                $scope.$watch(attrs.macAffixBottom, function(value) {
                    return setOffset("bottom", value);
                })), getPinnedOffset = function() {
                    var scrollHeight;
                    return null != pinnedOffset ? pinnedOffset : (element.removeClass(defaults.classes).addClass("affix"), 
                    scrollHeight = $document.height(), pinnedOffset = scrollHeight - element.outerHeight() - offset.bottom);
                }, scrollEvent = function() {
                    var affix, curOffset, elementHeight, position, scrollHeight, scrollTop;
                    if (!(element[0].offsetHeight <= 0 && element[0].offsetWidth <= 0) && (position = element.offset(), 
                    scrollTop = windowEl.scrollTop(), scrollHeight = $document.height(), elementHeight = element.outerHeight(), 
                    affix = null != unpin && unpin >= scrollTop ? !1 : null != offset.bottom && scrollTop > scrollHeight - elementHeight - offset.bottom ? "bottom" : null != offset.top && scrollTop <= offset.top ? "top" : !1, 
                    affix !== lastAffix)) return unpin && element.css("top", ""), lastAffix = affix, 
                    unpin = "bottom" === affix ? getPinnedOffset() : null, element.removeClass(defaults.classes).addClass("affix" + (affix ? "-" + affix : "")), 
                    "bottom" === affix && (curOffset = element.offset(), element.css("top", unpin - curOffset.top)), 
                    !0;
                }, null != attrs.macAffixDisabled && (disabled = $scope.$eval(attrs.macAffixDisabled) || defaults.disabled, 
                $scope.$watch(attrs.macAffixDisabled, function(value) {
                    var action;
                    if (null != value && value !== disabled) return disabled = value, action = value ? "unbind" : "bind", 
                    windowEl[action]("scroll", scrollEvent), disabled ? (lastAffix = null, unpin = null, 
                    element.css("top", "").removeClass(defaults.classes)) : scrollEvent();
                })), disabled || windowEl.bind("scroll", scrollEvent), $scope.$on("refresh-mac-affix", function() {
                    var position;
        ...
        return {
            ...
            compile: function(element) {
                ...
                for (prefixes = [ "webkit", "Moz", "ms", "O" ], vendor = function(el, name) {
                    var prefix, _i, _len;
                    for (name = util.capitalize(name), _i = 0, _len = prefixes.length; _len > _i; _i++) if (prefix = prefixes[_i], 
                    null != el.style[prefix + name]) return prefix + name;
                    return name;
                }, animateCss = vendor(element[0], "animation"), transformCss = vendor(element[0], "transform"), 
                i = _i = 0; 9 >= _i; i = ++_i) delay = .1 * i - 1 + !i, degree = 36 * i, styl = {}, 
                bar = angular.element('<div class="bar"></div>'), styl[animateCss] = "fade 1s linear infinite " + delay + "s", 
                styl[transformCss] = "rotate(" + degree + "deg) translate(0, 130%)", bar.css(styl), 
                element.append(bar);
                return function($scope, element, attrs) {
                    ...
                    return defaults = {
                        ...
                        zIndex: "inherit",
                        color: "#2f3035"
                    }, bars = angular.element(element[0].getElementsByClassName("bar")), setSpinnerSize = function(size) {
                        return bars.css({
                            height: .32 * size + "px",
                            left: .445 * size + "px",
                            top: .37 * size + "px",
                            width: .13 * size + "px",
                            borderRadius: .32 * size * 2 + "px",
                            position: "absolute"
                        }), !isNaN(+size) && angular.isNumber(+size) && (size = "" + size + "px"), element.css({
                            height: size,
                            width: size
                        });
                    }, null != attrs.macSpinnerSize ? attrs.$observe("macSpinnerSize", function(value) {
                        return null != value && value ? setSpinnerSize(value) : void 0;
                    }) : setSpinnerSize(defaults.size), attrs.$observe("macSpinnerZIndex", function(value) {
                        return null != value && value ? element.css("z-index", value) : void 0;
                    }), null != attrs.macSpinnerColor ? attrs.$observe("macSpinnerColor", function(value) {
                        return null != value && value ? bars.css("background", value) : void 0;
    ...
    angular.module("Mac").directive("macTagAutocomplete", [ "$parse", "$timeout", "keys", "util", function($parse, $timeout, keys, util) {
        return {
            restrict: "E",
            ...
            compile: function(element, attrs) {
                ...
                return valueKey = attrs.macTagAutocompleteValue, null == valueKey && (valueKey = "id"), 
                valueGetter = $parse(valueKey), labelKey = attrs.macTagAutocompleteLabel, null == labelKey && (labelKey = "name"), 
                labelGetter = $parse(labelKey), queryKey = attrs.macTagAutocompleteQuery || "q", 
                delay = +attrs.macTagAutocompleteDelay || 800, useSource = !1, textInput = angular.element(element[0].getElementsByClassName("mac-autocomplete")), 
                attrsObject = {
                    "mac-autocomplete-label": labelKey,
                    "mac-autocomplete-query": queryKey,
                    "mac-autocomplete-delay": delay
                }, null != attrs.macTagAutocompleteUrl ? attrsObject["mac-autocomplete-url"] = "url" : (useSource = null != attrs.macTagAutocompleteSource) && (attrsObject["mac-autocomplete-source"] = "autocompleteSource"), 
                textInput.attr(attrsObject), function($scope, element, attrs) {
                    var updateAutocompleteSource, watchFn;
                    return $scope.textInput = "", $scope.autocompleteSource = angular.isArray($scope.source) ? [] : $scope.source, 
                    null != attrs.macTagAutocompleteModel && ($scope.$watch("textInput", function(value) {
                        return $scope.model = value;
                    }), $scope.$watch("model", function(value) {
                        return $scope.textInput = value;
                    })), $scope.focusTextInput = function() {
                        var textInputDOM;
                        return textInputDOM = element[0].getElementsByClassName("mac-autocomplete"), textInputDOM[0].focus();
                        ...
                        if (events = attrs.macTagAutocompleteEvents) {
                            for (textInput = angular.element(element[0].getElementsByClassName("text-input")), 
                            _ref = events.split(","), _results = [], _i = 0, _len = _ref.length; _len > _i; _i++) name = _ref[_i], 
                            name = util.trim(name), capitalized = util.capitalize(name), eventFn = attrs["macTagAutocompleteOn" + capitalized], 
                            eventFn && "keydown" !== name && _results.push(function(name, eventFn) {
                                return textInput.bind(name, function($event) {
                                    var expression;
                                    return expression = $parse(eventFn), $scope.$apply(function() {
                    ...
                    }, 0, !1), updateAutocompleteSource = function() {
                        var difference, item, selectedValues, sourceValues, _ref;
                        return $scope.autocompletePlaceholder = (null != (_ref = $scope.selected) ? _ref.length : void 0) ? "" : $scope.placeholder, 
                        useSource && angular.isArray($scope.source) ? (sourceValues = function() {
                            var _i, _len, _ref1, _results;
                            for (_ref1 = $scope.source || [], _results = [], _i = 0, _len = _ref1.length; _len > _i; _i++) item = _ref1[_i], 
                            _results.push(valueGetter(item));
                            return _results;
                        }(), selectedValues = function() {
                            var _i, _len, _ref1, _results;
                            for (_ref1 = $scope.selected || [], _results = [], _i = 0, _len = _ref1.length; _len > _i; _i++) item = _ref1[_i], 
                            _results.push(valueGetter(item));
                            return _results;
                        }(), difference = function() {
                            var _i, _len, _results;
                            for (_results = [], _i = 0, _len = sourceValues.length; _len > _i; _i++) item = sourceValues[_i], 
                            __indexOf.call(selectedValues, item) < 0 && _results.push(item);
                            return _results;
                        }(), $scope.autocompleteSource = function() {
                            var _i, _len, _ref1, _ref2, _results;
                            for (_ref1 = $scope.source || [], _results = [], _i = 0, _len = _ref1.length; _len > _i; _i++) item = _ref1[_i], 
                            _ref2 = valueGetter(item), __indexOf.call(difference, _ref2) >= 0 && _results.push(item);
                            return _results;
                        }()) : void ($scope.autocompleteSource = $scope.source);
                    }, useSource && (watchFn = angular.isArray($scope.source) ? "$watchCollection" : "$watch", 
                    $scope[watchFn]("source", updateAutocompleteSource)), $scope.$watchCollection("selected", updateAutocompleteSource), 
                    $scope.onKeyDown = function($event) {
                        var stroke, _base;
                        switch (stroke = $event.which || $event.keyCode) {
                          case keys.BACKSPACE:
                            $scope.textInput || "function" == typeof (_base = $scope.selected).pop && _base.pop();
                            break;

                          case keys.ENTER:
                            $scope.textInput.length > 0 && $scope.disabled && $scope.onSelect($scope.textInput);
                        }
                        return null != attrs.macTagAutocompleteOnKeydown && "function" == typeof $scope.onKeydown && $scope.onKeydown({
                            $event: $event,
                            value: $scope.textInput
                        }), !0;
                    }, $scope.onSuccess = function(data) {
                        var existingValues, item;
                        return existingValues = function() {
                            var _i, _len, _ref, _results;
                            for (_ref = $scope.selected || [], _results = [], _i = 0, _len = _ref.length; _len > _i; _i++) item = _ref[_i], 
                            _results.push(valueGetter(item));
                            return _results;
                        }(), function() {
                            var _i, _len, _ref, _ref1, _results;
                            for (_ref = data.data, _results = [], _i = 0, _len = _ref.length; _len > _i; _i++) item = _ref[_i], 
                            _ref1 = valueGetter(item) || item, __indexOf.call(existingValues, _ref1) < 0 && _results.push(item);
                            return _results;
                        }();
                    }, $scope.onSelect = function(item) {
                        return null != attrs.macTagAutocompleteOnEnter && (item = $scope.onEnter({
                            item: item
                        })), item && $scope.selected.push(item), $timeout(function() {
    ...
    } ]), angular.module("Mac").directive("macTime", [ "$filter", "$timeout", "keys", "util", function($filter, $timeout, keys, util) {
        var defaults;
        return defaults = {
            "default": "12:00 AM"
        }, {
            ...
            link: function($scope, element, attrs, ngModelCtrl) {
                ...
                return opts = util.extendAttributes("macTime", defaults, attrs), time = null, attrs.placeholder || attrs.$set("placeholder", "--:--"), 
                timeValidator = function(value) {
                    return !value || util.timeRegex.exec(value) ? (ngModelCtrl.$setValidity("time", !0), 
                    value) : void ngModelCtrl.$setValidity("time", !1);
                }, ngModelCtrl.$formatters.push(timeValidator), ngModelCtrl.$parsers.push(timeValidator), 
                (initializeTime = function() {
                    var currentDate;
                    return currentDate = new Date().toDateString(), time = new Date(currentDate + " " + opts["default"]), 
                    isNaN(time.getTime()) ? time = new Date(currentDate + " " + defaults["default"]) : void 0;
                })(), getSelection = function() {
                    var start;
                    switch (start = element[0].selectionStart, !1) {
                      case !(start >= 0 && 3 > start):
                        return "hour";

                      case !(start >= 3 && 6 > start):
                        return "minute";

                      case !(start >= 6 && 9 > start):
                        return "meridian";
                    }
                    ...
                    var hours;
                    return hours = time.getHours(), hours >= 12 && "AM" === meridian && (hours -= 12), 
                    12 > hours && "PM" === meridian && (hours += 12), time.setHours(hours);
                }, toggleMeridian = function() {
                    var hours;
                    return hours = time.getHours(), time.setHours((hours + 12) % 24);
                    ...
                    var displayTime;
                    return displayTime = $filter("date")(time.getTime(), "hh:mm a"), displayTime !== ngModelCtrl.$viewValue ? (ngModelCtrl.$setViewValue(displayTime), 
                    ngModelCtrl.$render()) : void 0;
                }, updateTime = function() {
                    var hours, meridian, minutes, timeMatch;
                    return (timeMatch = util.timeRegex.exec(ngModelCtrl.$modelValue)) ? (hours = +timeMatch[1], 
                    minutes = +timeMatch[2], meridian = timeMatch[3], "PM" === meridian && 12 !== hours && (hours += 12), 
                    "AM" === meridian && 12 === hours && (hours = 0), time.setHours(hours, minutes)) : void 0;
                    ...
                    return $scope.$apply(function() {
                        switch (updateTime(), updateInput(), getSelection()) {
                          case "hour":
                            return selectHours();
                    ...
                    var key;
                    return key = event.which, key !== keys.UP && key !== keys.DOWN && key !== keys.LEFT && key !== keys.RIGHT && key !== keys.A && key !== keys.P ? !0 : (event.preventDefault(), 
                    $scope.$apply(function() {
                        var change, meridianSelected;
                        switch (key) {
                          case keys.UP:
                          case keys.DOWN:
                            switch (change = key === keys.UP ? 1 : -1, getSelection()) {
                              case "hour":
                                incrementHour(change), selectHours();
                                break;

                              case "minute":
                                incrementMinute(change), selectMinutes();
                                break;

                              case "meridian":
                                toggleMeridian(), selectMeridian();
                            }
                            return updateInput();
                          ...
                          case keys.A:
                          case keys.P:
                            switch (meridianSelected = "meridian" === getSelection(), !1) {
                            ...
                            return updateInput(), selectMeridian();
                        }
                    }));
                }), element.on("keyup", function(event) {
                    var key;
                    return key = event.which, keys.NUMPAD0 <= key && key <= keys.NUMPAD9 || keys.ZERO <= key && key <= keys.NINE || event.preventDefault(), 
                    $scope.$apply(function() {
                        return updateTime();
                    });
                });
    ...
    } ]), angular.module("Mac").directive("macTooltip", [ "$timeout", "util", function($timeout, util) {
        return {
            restrict: "A",
            link: function(scope, element, attrs) {
                var defaults, disabled, enabled, opts, removeTip, showTip, text, toggle, tooltip;
                return tooltip = null, text = "", enabled = !1, disabled = !1, defaults = {
                    direction: "top",
                    trigger: "hover",
                    inside: !1
                }, opts = util.extendAttributes("macTooltip", defaults, attrs), showTip = function() {
                    var elementSize, offset, tip, tooltipSize;
                    if (disabled || !text) return !0;
                    switch (tip = opts.inside ? element : angular.element(document.body), removeTip(0), 
                    tooltip = angular.element('<div class="mac-tooltip ' + opts.direction + '"><div class="tooltip-message">' + text + "</div></div>"), 
                    tip.append(tooltip), offset = opts.inside ? {
                        top: 0,
                        left: 0
                    ...
                    return offset.top = Math.max(0, offset.top), offset.left = Math.max(0, offset.left), 
                    angular.forEach(offset, function(value, key) {
                        return !isNaN(+value) && angular.isNumber(+value) && (value = "" + value + "px"), 
                        tooltip.css(key, value);
                    }), tooltip.addClass("visible"), !0;
                }, removeTip = function(delay) {
                    return null == delay && (delay = 100), null != tooltip && (tooltip.removeClass("visible"), 
                    $timeout(function() {
                        return null != tooltip && tooltip.remove(), tooltip = null;
                    }, delay, !1)), !0;
                }, toggle = function() {
                    return null != tooltip ? removeTip() : showTip();
                }, attrs.$observe("macTooltip", function(value) {
                    var _ref;
                    if (null != value && (text = value, !enabled)) {
                        if ("hover" !== (_ref = opts.trigger) && "click" !== _ref) throw "Invalid trigger";
                        switch (opts.trigger) {
                          case "click":
                          ...
                          case "hover":
                            element.bind("mouseenter", showTip), element.bind("mouseleave click", function() {
                                return removeTip();
                            });
                        }
                        return enabled = !0;
                    }
                }), null != attrs.macTooltipDisabled && scope.$watch(attrs.macTooltipDisabled, function(value) {
                    return disabled = value;
                }), scope.$on("$destroy", function() {
                    return null != tooltip ? removeTip(0) : void 0;
                });
            }
        };
    } ]);
...
wonderlandApp.config([ "$provide", function($provide) {
    $provide.decorator("$rootScope", [ "$delegate", function($delegate) {
        return Object.defineProperty($delegate.constructor.prototype, "$onRootScope", {
            value: function(name, listener) {
                var unsubscribe = $delegate.$on(name, listener);
                return this.$on("$destroy", unsubscribe), unsubscribe;
            },
            enumerable: !1
        }), $delegate;
    } ]);
} ]), wonderlandApp.run([ "$rootScope", "$ocModal", "$window", function($rootScope, $ocModal, $window) {
    $rootScope.currentPageUrl = $window.location.href, $rootScope.openPageModal = function(partial, modalId, initVars) {
        if (partial) {
            var modal = {
                url: partial,
                init: initVars
            };
            modalId && (modal.id = modalId), $ocModal.open(modal);
        }
    ...
    $scope.pageHeaderCompress = !1, $scope.pageShowingSideNavMenu = !1, $scope.pageShowingSideAccountMenu = !1, 
    $scope.pageProfile = {
        imageUrl: null
    }, $scope.pageFeedback = {
        profileImageProcessing: !1,
        profileImageShowSuccess: !1,
        profileImageShowError: !1
    };
    var scrollCheckLimit = 50, runScrollCheck = function() {
        var diff = angular.element($window).scrollTop() > scrollCheckLimit && !$scope.pageHeaderCompress || angular.element($window).scrollTop() <= scrollCheckLimit && $scope.pageHeaderCompress;
        diff && ($scope.$$phase ? updateCompressValue() : $scope.$apply(updateCompressValue));
    }, updateCompressValue = function() {
        $scope.pageHeaderCompress = angular.element($window).scrollTop() > scrollCheckLimit;
    };
    runScrollCheck(), angular.element($window).bind("scroll", runScrollCheck), $scope.$onRootScope("profileImageUploadStart", function() {
        $timeout(function() {
            $scope.pageFeedback.profileImageProcessing = !0;
        });
    }), $scope.$onRootScope("profileImageUpdated", function(event, response) {
        $timeout(function() {
            $scope.pageFeedback.profileImageProcessing = !1, response && response.Success === !0 ? ($scope.pageProfile.imageUrl = response.Message || null, 
            $scope.pageFeedback.profileImageShowSuccess = !0) : $scope.pageFeedback.profileImageShowError = !0, 
            $timeout(function() {
                $scope.pageFeedback.profileImageShowSuccess = !1, $scope.pageFeedback.profileImageShowError = !1;
            }, 5e3);
        });
        ...
        imageUrl: "/img/sunnies.png",
        title: "Raise £180 or more",
        info: "Sunglasses are essential Wonderland accessories - look cool as an alpine stream!"
    }, {
        imageUrl: "/img/tee.png",
        title: "Raise £250 or more",
        info: "Also get a T-Shirt, specifically designed for Macmillan's Wonderland."
    }, {
        imageUrl: "/img/mystery.png",
        title: "Raise £400 or more",
        info: "On top of the sunnies and t-shirt, be entered into the prize draw to win a ski-tastic prize."
    } ];
    ...
    $scope.partyCopyData = null, $scope.partyCopyDataForForm = null, $scope.partyCopyDataFeedback = {}, 
    $scope.partyCopyDataInit = function(partyCopyData) {
        $scope.partyCopyData = partyCopyData, $scope.partyCopyDataForForm = angular.copy($scope.partyCopyData), 
        ...
        $scope.partyCopyDataFeedback.processing = !1, $scope.partyCopyDataInit(dataObject), 
        $ocModal.close("partyCopyModal");
    }), $scope.$onRootScope("partyCopyDataErrored", function() {
        $scope.partyCopyDataFeedback.processing = !1, $scope.partyCopyDataFeedback.showNetworkError = !0, 
        $timeout(function() {
            $scope.partyCopyDataFeedback.showNetworkError = !1;
        }, 5e3);
    }), $scope.partyDetailsData = null, $scope.partyDetailsFormattedAddress = null, 
    $scope.partyDetailsDataForForm = null, $scope.partyDetailsDataFeedback = {}, $scope.partyDetailsDataInit = function(partyDetailsData) {
        angular.forEach(partyDetailsData, function(value, key) {
            partyDetailsData[key] = "null" === value ? null : value;
        }), partyDetailsData && partyDetailsData.PartyDateTime && (partyDetailsData.PartyDateTime = moment(partyDetailsData.PartyDateTime).format("YYYY/MM/DD HH:mm:SS"));
        var address = [];
        partyDetailsData.Address1 && address.push(partyDetailsData.Address1), partyDetailsData.Address2 && address.push(partyDetailsData.Address2), 
        partyDetailsData.TownCity && address.push(partyDetailsData.TownCity), partyDetailsData.Postcode && address.push(partyDetailsData.Postcode), 
        $scope.partyDetailsFormattedAddress = $filter("addressJoiner")(address.join(":~:"), ":~:"), 
        $scope.partyDetailsData = partyDetailsData, $scope.partyDetailsDataForForm = angular.copy($scope.partyDetailsData);
    }, $scope.$onRootScope("partyDetailsDataUpdated", function(event, response, dataObject) {
        $scope.partyDetailsDataFeedback.processing = !1, response && response.Success === !0 ? (dataObject.error = null, 
        $scope.partyDetailsDataInit(dataObject), $ocModal.close("partyDetailsModal")) : response.Errors && ($scope.partyDetailsDataFeedback.error = response.Errors[0].ErrorMessages[0]);
    }), $scope.$onRootScope("partyDetailsDataError", function() {
        $scope.partyDetailsDataFeedback.processing = !1, $scope.partyDetailsDataFeedback.showNetworkError = !0, 
        $timeout(function() {
            $scope.partyDetailsDataFeedback.showNetworkError = !1;
        }, 5e3);
    }), $scope.suggestedDonationData = null, $scope.suggestedDonationDataForForm = null, 
    $scope.suggestedDonationDataFeedback = {}, $scope.suggestedDonationDataInit = function(suggestedDonationData) {
        $scope.suggestedDonationData = suggestedDonationData, $scope.suggestedDonationDataForForm = angular.copy($scope.suggestedDonationData);
    }, $scope.$onRootScope("suggestedDonationDataUpdated", function(event, response, dataObject) {
        $scope.suggestedDonationDataFeedback.processing = !1, $scope.suggestedDonationDataInit(dataObject), 
        $ocModal.close("suggestedDonationModal");
    }), $scope.$onRootScope("suggestedDonationDataError", function() {
        $scope.suggestedDonationDataFeedback.processing = !1, $scope.suggestedDonationDataFeedback.showNetworkError = !0, 
        $timeout(function() {
            $scope.suggestedDonationDataFeedback.showNetworkError = !1;
        }, 5e3);
    }), $scope.fundraisingTargetData = null, $scope.fundraisingTargetDataForForm = null, 
    $scope.fundraisingTargetDataFeedback = {};
    var fundraisingTargetFirstSet = !0;
    $scope.fundraisingTargetDataInit = function(fundraisingTargetData) {
        $timeout(function() {
            $scope.fundraisingTargetData = fundraisingTargetData, $scope.fundraisingTargetDataForForm = angular.copy($scope.fundraisingTargetData), 
            fundraisingTargetFirstSet && (fundraisingTargetFirstSet = !1, fundraisingTargetData.FundraisingTarget <= 0 && $rootScope.openPageModal("partials/fundraisingTargetForm.html", "suggestedDonationModal", {
        ...
        $scope.fundraisingTargetDataFeedback.processing = !1, $scope.fundraisingTargetDataInit(dataObject), 
        $ocModal.close("fundraisingTargetDataModal");
    }), $scope.$onRootScope("fundraisingTargetDataError", function() {
        $scope.fundraisingTargetDataFeedback.processing = !1, $scope.fundraisingTargetDataFeedback.showNetworkError = !0, 
        $timeout(function() {
            $scope.fundraisingTargetDataFeedback.showNetworkError = !1;
        }, 5e3);
    });
    var initUrl = null;
    $scope.partyImageData = {}, $scope.partyImageDefaultData = null, $scope.partyImageDataForForm = null, 
    $scope.partyImageDataFeedback = {}, $scope.partyCustomImage = {
        image: null,
        feedback: {}
    }, $scope.partyImageDefaultDataInit = function(defaultImages) {
        $scope.partyImageDefaultData = defaultImages;
        var isCustom = !0;
        initUrl && angular.forEach(defaultImages, function(value) {
            isCustom = value.id === initUrl.id ? !1 : isCustom;
        }), isCustom && ($scope.partyCustomImage.image = initUrl);
    }, $scope.$onRootScope("partyImageUpdated", function() {
        $scope.partyImageDataFeedback.processing = !1, $scope.partyImageData.PartyImage = $scope.partyImageDataForForm.PartyImage, 
        $ocModal.close("partyImageModal");
    }), $scope.$onRootScope("partyImageUpdateError", function() {
        $scope.partyImageDataFeedback.processing = !1, $scope.partyImageDataFeedback.showNetworkError = !0, 
        $timeout(function() {
            $scope.partyImageDataFeedback.showNetworkError = !1;
        }, 5e3);
    }), $scope.$onRootScope("partyImageCustomUrlUploaded", function(event, response) {
        $timeout(function() {
            if ($scope.partyCustomImage.feedback.processing = !1, response && response.Success === !0 && response.Message) {
                var newImage = angular.fromJson(response.Message);
                $scope.partyCustomImage.feedback.showSuccess = !0, newImage && ($scope.partyCustomImage.image = newImage, 
                $scope.partyImageDataForForm.PartyImage = newImage);
            } else $scope.partyCustomImage.feedback.showError = !0;
        }), $timeout(function() {
            $scope.partyCustomImage.feedback.showSuccess = !1, $scope.partyCustomImage.feedback.showError = !1;
        }, 5e3);
    }), $scope.hardCodedCurrentPartyImageUrlInit = function(imageData) {
        imageData && (initUrl = angular.fromJson(imageData)), $scope.partyImageData.PartyImage = initUrl, 
    ...
    var hasSetInitialDate = !1, minute = [ 0, 30 ];
    $scope.tempModel = {
        partyDate: null,
        partyTime: null,
        times: []
    };
    for (var funcValueMinute = function(valueMinute) {
        var t = (10 > i ? "0" : "") + i + ":" + (10 > valueMinute ? "0" : "") + valueMinute;
        $scope.tempModel.times.push(t);
    }, i = 0; 24 > i; i++) angular.forEach(minute, funcValueMinute);
    $scope.$watch("partyDetailsData.PartyDateTime", function(newVal) {
        if (!hasSetInitialDate) {
            hasSetInitialDate = !0;
            var mom = moment(newVal);
            mom.isValid() && ($scope.tempModel.partyDate = mom, $scope.tempModel.partyTime = $scope.tempModel.times[$scope.tempModel.times.indexOf(mom.format("HH:mm"))]);
        }
    }), $scope.$watch("tempModel.partyDate + tempModel.partyTime", function() {
        $scope.tempModel.partyDate && $scope.tempModel.partyTime && ($scope.partyDetailsData.PartyDateTime = moment($scope.tempModel.partyDate.format("YYYY/MM/DD") + " " + $scope.tempModel.partyTime).format("YYYY/MM/DD HH:mm:SS"));
    }, !0);
} ]), wonderlandApp.controller("ProfileCtrl", [ "$scope", "$timeout", function($scope, $timeout) {
    $scope.feedback = {
        profileNameProcessing: !1,
        profileNameShowSuccess: !1,
        profileNameShowError: !1,
        profileBillingAddressProcessing: !1,
        profileBillingAddressShowSuccess: !1,
        profileBillingAddressShowError: !1,
        profilePasswordProcessing: !1,
        profilePasswordShowSuccess: !1,
        profilePasswordShowError: !1,
        profileShirtProcessing: !1,
        profileShirtShowSuccess: !1,
        profileShirtShowError: !1
    }, $scope.$onRootScope("profileNameDataUpdated", function(event, response, dataObject) {
        $timeout(function() {
            $scope.feedback.profileNameProcessing = !1, response && response.Success === !0 ? ($scope.pageProfile.firstName = dataObject.FirstName, 
            $scope.feedback.profileNameShowSuccess = !0) : $scope.feedback.profileNameShowError = !0, 
            $timeout(function() {
                $scope.feedback.profileNameShowSuccess = !1, $scope.feedback.profileNameShowError = !1;
            }, 5e3);
        });
    }), $scope.$onRootScope("profileBillingAddressDataUpdated", function(event, response) {
        $timeout(function() {
            $scope.feedback.profileBillingAddressProcessing = !1, response && response.Success === !0 ? $scope.feedback.profileBillingAddressShowSuccess = !0 : $scope.feedback.profileBillingAddressShowError = !0, 
            $timeout(function() {
                $scope.feedback.profileBillingAddressShowSuccess = !1, $scope.feedback.profileBillingAddressShowError = !1;
            }, 5e3);
        });
    }), $scope.$onRootScope("profilePasswordUpdated", function(event, response) {
        $timeout(function() {
            $scope.feedback.profilePasswordProcessing = !1, response && response.Success === !0 ? ($scope.profilePasswordData = null, 
            $scope.feedback.profilePasswordShowSuccess = !0) : $scope.feedback.profilePasswordShowError = !0, 
            $timeout(function() {
                $scope.feedback.profilePasswordShowSuccess = !1, $scope.feedback.profilePasswordShowError = !1;
            }, 5e3);
        });
    }), $scope.$onRootScope("profileShirtUpdated", function(event, response) {
        $timeout(function() {
            $scope.feedback.profileShirtProcessing = !1, response && response.Success === !0 ? $scope.feedback.profileShirtShowSuccess = !0 : $scope.feedback.profileShirtShowError = !0, 
            $timeout(function() {
                $scope.feedback.profileShirtShowSuccess = !1, $scope.feedback.profileShirtShowError = !1;
            }, 5e3);
        });
    });
    ...
    $scope.hardcodedDonationSuggestions = [ {
        ...
        amount: 20,
        label: "Sauerkraut sizzle"
    }, {
        amount: 25,
        label: "Snowball bash"
    } ];
} ]), wonderlandApp.controller("WallCtrl", [ "mHttp", "$filter", "$scope", "$timeout", function(mHttp, $filter, $scope, $timeout) {
    var wallFeed, partyGuid, wallDelete, deleteRequest, feedRequest, initialFormModel, hasSetInitialFormModel = !1;
    $scope.wall = {
        feedback: {
            imageProcessing: !1,
            imageShowSuccess: !1,
            imageShowError: !1,
            messageProcessing: !1,
            messageShowSuccess: !1,
            messageShowError: !1,
            feedProcessingPost: !1,
        ...
        wallFeed = baseWallFeed, partyGuid = basePartyGuid, wallDelete = baseWallFeedDelete, 
        $scope.getFeed();
    }, $scope.getFeed = function(beforeDateTime) {
        $timeout(function() {
            $scope.wall.feedback.feedProcessingPost = !0;
        });
        var sendFormData = {
            partyGuid: partyGuid,
            take: $scope.wall.feedLimit
        };
        beforeDateTime && (sendFormData.beforeDateTime = beforeDateTime), feedRequest = mHttp.get(wallFeed, {
            data: sendFormData,
            dataType: "json"
        }), feedRequest.then(function(response) {
            $scope.wall.feedback.feedProcessingPost = !1, response && angular.forEach(response, function(value) {
                Number(value.id < 0) && (value.isDonation = !0, value.text = $filter("mCurrency")(value.text, "£")), 
                value.timeFormatted = moment(value.timestamp).fromNow(), value.text = "null" == value.text ? null : value.text, 
                value.imageUrl = value.imageUrl && value.imageUrl.indexOf("null") >= 0 ? null : value.imageUrl;
            }), response.length && ($scope.wall.feedLastResponseCount = response.length, $scope.wall.feedLastDate = response[response.length - 1].timestamp), 
            $scope.wall.hasDoneFirstLoad = !0, $scope.wall.feed = beforeDateTime ? $scope.wall.feed.concat(response) : response;
        });
    }, $scope.deleteFeedItem = function(messageId) {
        !wallDelete || !messageId || 0 > messageId || ($scope.wall.feedback.removeProcessingId = messageId, 
        deleteRequest = mHttp.post(wallDelete + "?messageId=" + messageId, {
            ...
            }), removeIndex >= 0 && $scope.wall.feed.splice(removeIndex, 1), $scope.wall.feedback.removeProcessingId = null;
        }, function() {
            $scope.wall.feedback.removeProcessingId = null;
        }));
    }, $scope.wallFormModelInit = function(formModel) {
        hasSetInitialFormModel || (hasSetInitialFormModel = !0, initialFormModel = formModel), 
        $timeout(function() {
            $scope.wall.formModel = angular.copy(formModel), $scope.wall.previewImageUrl = null, 
            $scope.wall.feedback.imageProcessing = !1, $scope.wall.feedback.messageProcessing = !1;
        });
    }, $scope.$onRootScope("wallMessagePosted", function(event, response) {
        response && response.Success === !0 ? ($scope.wall.feedback.messageShowSuccess = !0, 
        $scope.wallFormModelInit(initialFormModel), $scope.getFeed()) : ($scope.wall.feedback.messageProcessing = !1, 
        $scope.wall.feedback.messageShowError = !0), $timeout(function() {
            $scope.wall.feedback.messageShowSuccess = !1, $scope.wall.feedback.messageShowError = !1;
        }, 5e3);
    }), $scope.$onRootScope("wallMessagePostError", function() {
        $scope.wall.feedback.messageProcessing = !1, $scope.wall.feedback.messageShowError = !0, 
        $timeout(function() {
            $scope.wall.feedback.messageShowSuccess = !1, $scope.wall.feedback.messageShowError = !1;
        }, 5e3);
    }), $scope.$onRootScope("wallImageUploadStart", function() {
        $timeout(function() {
            $scope.wall.previewImageUrl = null, $scope.wall.formModel.PartyWallImage = null, 
            $scope.wall.feedback.imageProcessing = !0;
        });
    }), $scope.$onRootScope("wallImageUrlUploaded", function(event, response) {
        $timeout(function() {
            if ($scope.wall.feedback.imageProcessing = !1, response && response.Success === !0 && response.Message) {
                $scope.wall.feedback.imageShowSuccess = !0;
                var imageObject = angular.fromJson(response.Message);
                $scope.wall.previewImageUrl = imageObject, $scope.wall.formModel.PartyWallImage = imageObject.id;
            } else $scope.wall.feedback.imageShowError = !0;
            $timeout(function() {
                $scope.wall.feedback.imageShowSuccess = !1, $scope.wall.feedback.imageShowError = !1;
            }, 5e3);
        });
    });
} ]), function() {
    ...
    angular.module("masonry", [ "ng" ]).directive("masonry", function() {
        return {
            ...
            link: function(scope, elem, attrs) {
                scope.items = [];
                var container = elem[0], options = angular.extend({
                    itemSelector: ".item"
                }, JSON.parse(attrs.masonry));
                attrs.$observe("masonryFilterChange", function(newVal) {
                    angular.isString(newVal) && scope.update();
                });
                var masonry = scope.masonry = new Masonry(container, options), debounceTimeout = 0;
                scope.update = function() {
                    debounceTimeout && window.clearTimeout(debounceTimeout), debounceTimeout = window.setTimeout(function() {
                        debounceTimeout = 0, masonry.reloadItems(), masonry.layout(), elem.children(options.itemSelector).css("visibility", "visible");
                    }, 120);
                };
            }
        };
        ...
        return {
            ...
            link: function(scope, element) {
                ...
                var master = element.parent("*[masonry]:first").scope(), update = master.update;
                imagesLoaded(element.find("img")[0], update), element.ready(update);
            }
        };
    });
    ...
    return {
        ...
        link: function(scope, elements, attrs) {
            ...
            scope.findAddressFromPostcode = function() {
                scope.loading = !0, pafPoscodeRequest = paf.getAddressFromPostcode(scope.postcode), 
                pafPoscodeRequest.then(function(response) {
                    scope.loading = !1, scope.listOfAddresses = response;
                }, function() {
                    showFeedback("showErrorPostcode"), clearData();
                });
            }, scope.$watch("selectedAddress", function(newVal, oldVal) {
                null !== newVal && newVal != oldVal && getFullAddressFromId();
            }), triggerEvent && scope.$onRootScope(triggerEvent, function() {
                $timeout(function() {
    ...
    return {
        ...
        link: function(scope, element) {
            var hasSetInitialValue = !1, pikaday = null;
            scope.$watch("theDate", function(newVal) {
                if (!hasSetInitialValue) {
                    hasSetInitialValue = !0;
                    var initialDate = null;
                    moment(newVal).isValid() && (initialDate = newVal), pikaday || createPicker(initialDate);
                }
            }, !0);
            var createPicker = function(initialDate) {
                ...
                initialDate && angular.extend(basePicka, {
    ...
    return {
        scope: !0,
        link: function(scope, element, attrs) {
            var onStartEvent = attrs.mOnStartEvent, onSuccessEvent = attrs.mOnSuccessEvent, resetInputValue = function() {
                element.find("input[type=file]").val(null);
            };
            scope.submitBlank = function() {
                resetInputValue(), scope.submit();
            }, scope.submit = function() {
                scope.uploading = !0, onStartEvent && $rootScope.$emit(onStartEvent), fileUpload.backgroundUpload(element.find("form")).then(function(response) {
                    scope.uploading = !1, onSuccessEvent && $rootScope.$emit(onSuccessEvent, response), 
                    resetInputValue();
                });
            };
        }
    ...
    return function(scope, element, attrs) {
        ...
        element.bind("keydown", function(e) {
            return 13 === e.keyCode ? (onEnterEvent && $rootScope.$emit(onEnterEvent), e.preventDefault(), 
            !1) : void 0;
        });
    };
    ...
    return {
        ...
        template: '<div><div class="btn-facebook-login radius-v2-small" ng-click="login()" ng-class="{\'disabled\': loading}" ng-bind="label"></div><div class="loader pos-static" ng-show="loading"></div><div class="successful" ng-show="formattedDetails">The user has logged in via Facebook! Hendy at this stage, we need to log the users in using their facebook app id.</div><div class="errorred" ng-show="showError" ng-bind="errorMessage"></div></div>',
        link: function(scope, element, attrs) {
            scope.loading = !1, scope.formattedDetails = null, scope.showError = !1, scope.errorMessage = attrs.errorMessage || "Oops, something went wrong!";
            var requestVerificationToken = null, loginUrl = attrs.loginUrl, fbStatus = null, fbLogin = null, loginToServer = function() {
                if (loginUrl) {
                    var auth = facebook.authenticationDetails().authResponse, jsonData = {
                    ...
                    null !== requestVerificationToken && angular.extend(postHeaders, {
                    ...
                    serverLogin.then(function(response) {
                        response && response.success === !0 ? "message" in response && response.message.length > 0 ? $window.location = response.message : $window.location.reload() : (response && "errors" in response && response.errors.length > 0 && (scope.errorMessage = response.errors[0].errorMessages[0]), 
                        scope.loading = !1, scope.showError = !0), $timeout(function() {
                            scope.showError = !1;
                        }, 5e3);
                    });
                }
            ...
            scope.login = function() {
                scope.loading || (scope.loading = !0, fbStatus.then(function(status) {
                    "connected" !== status ? (fbLogin = facebook.doLogin(), fbLogin.then(function(newStatus) {
                        "connected" !== newStatus ? scope.loading = !1 : loginToServer();
                    })) : loginToServer();
                }));
    ...
    return {
        link: function(scope, element) {
            ...
            $token && scope.$emit("formToken", $token[0].value);
        }
    };
    ...
    return {
        ...
        link: function(scope, element) {
            ...
            }, scope.$watch("myWidth()", makeSquare), makeSquare(), angular.element($window).bind("resize", makeSquare);
        }
    };
    ...
    return {
        ...
        link: function(scope, element) {
            angular.element(element).bind("load", function() {
                angular.element(element).unbind("load"), scope.$emit("childImageLoaded");
            });
        }
    };
    ...
    return {
        link: function(scope, element, attrs) {
            Modernizr.svg || angular.element(element).attr("src", attrs.mImgSvgReplacer);
        }
    };
    ...
    return {
        restrict: "A",
        link: function(scope, element, attrs) {
            var addClassName = attrs.mIosAddClass, removeClassName = attrs.mIosRemoveClass, applyClasses = function() {
                addClassName && angular.element(element).addClass(addClassName), removeClassName && angular.element(element).removeClass(removeClassName);
            };
            return iOS ? void ("mMinIos" in attrs && parseInt(attrs.mMinIos, 10) > iOS || "mMaxIos" in attrs && parseInt(attrs.mMaxIos, 10) < iOS || applyClasses()) : void ("mClassOnlyOnIos" in attrs || applyClasses());
        }
    };
    ...
    var SAVED_CONFIRMATION_PERIOD = 2e3;
    return {
        scope: !0,
        link: function(scope, element, attrs) {
            function handleResponse(response, originalData) {
                response && response.data && dataVar.assign(scope.$parent, response.data), response && response.success === !1 ? (emitError(), 
                setProgressState("ready")) : (setProgressState("saved"), savedConfirmTimer = $timeout(function() {
                    setProgressState("ready"), savedConfirmTimer = null;
                }, SAVED_CONFIRMATION_PERIOD), onSuccessEvent && $rootScope.$emit(onSuccessEvent, response, angular.copy(originalData)));
            }
            function emitError() {
                onErrorEvent && $rootScope.$emit(onErrorEvent);
            }
            function setProgressState(state) {
                progressState = state, progressVar && progressVar.assign(scope.$parent, state);
            }
            function prepareForSubmit() {
                mHttp.cancel(formSubmitRequest), savedConfirmTimer && ($timeout.cancel(savedConfirmTimer), 
                savedConfirmTimer = null), "saved" === progressState && setProgressState("in-progress");
            }
            var progressState, progressVar = attrs.mProgressVar && $parse(attrs.mProgressVar), dataVar = $parse(attrs.mPostOnSubmit), formSubmitRequest = null, savedConfirmTimer = null, serialized = attrs.hasOwnProperty("mSerialized"), onSuccessEvent = attrs.mOnSuccessEvent, onErrorEvent = attrs.mOnErrorEvent, useLegacy = attrs.mUseLegacy === !0 || "true" === attrs.mUseLegacy || !1;
            setProgressState("ready"), element.on("submit", function() {
                if (!serialized || !mHttp.isInProgress(formSubmitRequest)) {
                    prepareForSubmit(), setProgressState("in-progress");
                    var originalData = dataVar(scope) || {}, sendData = angular.copy(originalData);
                    if (!useLegacy && window.File && window.FileReader) $timeout(function() {
                        var ufprtElement = element.find("[name='ufprt']");
                        ufprtElement && ufprtElement.length && (sendData.ufprt = ufprtElement[0].value);
                        var rvtElement = element.find("[name='__RequestVerificationToken']");
                        rvtElement && rvtElement.length && (sendData.__RequestVerificationToken = rvtElement[0].value), 
                        console.log("SAVE DATA", originalData, sendData), formSubmitRequest = mHttp.post(attrs.action + "?t=" + new Date().getTime(), {
                            formData: sendData,
                            dataType: "json"
                        }), formSubmitRequest.then(function(response) {
                            handleResponse(response, originalData);
                        }, function() {
                            emitError(), setProgressState("ready");
                        });
                    }); else {
                        var target = "form_target_iframe_" + uniqueId(), $targetIframe = $("<iframe/>", {
                            name: target,
                            id: target,
                            frameborder: "0"
                            ...
                            $timeout(function() {
                                var response = $targetIframe.contents().find("body").html(), parsedJson = null;
                                try {
                        ...
                        $(element).contents().appendTo($postForm), $postForm.attr("action", attrs.action), 
                        $postForm.submit();
                    }
                    return !1;
                }
    ...
    var MAIN_CLASS = "profile-image", NOT_SET_CLASS = "profile-image-notset", ALLOWED_EXTENSIONS = [ ".jpg", ".jpeg", ".png" ];
    return {
        scope: {},
        link: function(scope, element, attrs) {
            scope.hasBackgroundImage = !1, element.addClass(MAIN_CLASS);
            var loadImage = function(newImgSrc) {
                var img = new Image();
                $(img).on("load", function() {
                    element.css("background-image", "url(" + newImgSrc + ")"), $timeout(function() {
                        scope.hasBackgroundImage = !0;
                    });
                }), $(img).attr("src", newImgSrc);
            };
            attrs.$observe("mProfileImage", function(newVal) {
                for (var hasExt = !1, i = 0; i < ALLOWED_EXTENSIONS.length; i++) hasExt = newVal.toLowerCase().indexOf(ALLOWED_EXTENSIONS[i]) >= 0 ? !0 : hasExt;
                return newVal && angular.isString(newVal) && hasExt ? void loadImage(newVal) : void (scope.hasBackgroundImage = !1);
            }), scope.$watch("hasBackgroundImage", function(newVal) {
                newVal === !0 ? element.removeClass(NOT_SET_CLASS) : element.addClass(NOT_SET_CLASS);
            });
        }
    };
} ]), wonderlandApp.directive("mRadiusPicker", [ function() {
    var NUM_OF_CLASS_VARIETIES = 3, CLASS_SIZES = [ "small", "medium", "large" ];
    return {
        scope: !1,
        link: function(scope, element, attrs) {
            ...
            if (attrs.mRadiusPicker) {
                usedSizes = [];
                for (var i = 0; i < CLASS_SIZES.length; i++) attrs.mRadiusPicker.indexOf(CLASS_SIZES[i]) >= 0 && usedSizes.push(CLASS_SIZES[i]);
            }
            if (usedSizes.length) {
                var version = Math.floor(Math.random() * NUM_OF_CLASS_VARIETIES) + 1, size = usedSizes[Math.floor(Math.random() * usedSizes.length)];
                element.addClass("radius-v" + version + "-" + size);
            }
        }
    };
} ]), wonderlandApp.directive("mRotate", [ "$timeout", function() {
    function kcRotate(elem, deg) {
        var Dx, Dy, iecos, iesin, halfWidth, halfHeight, dummy, rad = deg * (Math.PI / 180);
        iecos = Math.cos(rad), iesin = Math.sin(rad), halfWidth = elem.offsetWidth / 2, 
        halfHeight = elem.offsetHeight / 2, Dx = -halfWidth * iecos + halfHeight * iesin + halfWidth, 
        Dy = -halfWidth * iesin - halfHeight * iecos + halfHeight, elem.style.transform = "rotate(" + rad + "rad)", 
        elem.style.mozTransform = "rotate(" + rad + "rad)", elem.style.webkitTransform = "rotate(" + rad + "rad)", 
        elem.style.OTransform = "rotate(" + rad + "rad)", elem.style.msTransform = "rotate(" + rad + "rad)", 
        ...
        dummy = document.createElement("div"), dummy.innerHTML = "<!--[if gte IE 9]><br /><![endif]-->", 
        1 == dummy.getElementsByTagName("br").length && (elem.style.filter = "none"), dummy = null;
    }
    var TOTAL_COUNT = 0;
    return {
        scope: !1,
        link: function(scope, element) {
            var originalDeg = 0, doNewRotation = function(angleOverride) {
                var newAngle = angleOverride || 0;
                if (!angular.isNumber(angleOverride)) {
                    TOTAL_COUNT += 1;
                    var multiplier = TOTAL_COUNT % 2 ? -1 : 1;
                    newAngle = 3 * Math.random() * multiplier;
                }
                return kcRotate(element[0], newAngle), newAngle;
            };
    ...
    return {
        ...
        link: function(scope, element, attrs, ngModelCtrl) {
            ngModelCtrl && (ngModelCtrl.$parsers.push(function(val) {
                ...
                return val !== clean && (ngModelCtrl.$setViewValue(clean), ngModelCtrl.$render()), 
                clean;
    ...
    return {
        ...
        link: function(scope, element, attrs) {
            var hasInitiallySet = !1;
            scope.$watch("m", function() {
                hasInitiallySet || (hasInitiallySet = !0, scope.m = attrs.value);
            });
        }
    };
    ...
    return {
        link: function(scope, element, attrs) {
            var hasInited = !1, isActive = !1, $possibleParent = $(element).closest("." + attrs.mAlignParent), $myParent = $possibleParent && $possibleParent.length ? $possibleParent[0] : $(element).parent(), reAlign = debounce(function() {
                element.css("top", (parentHeight() - myHeight()) / 2);
            }, 200), parentHeight = function() {
                return $($myParent).height() + Number($($myParent).css("padding-top").replace("px", "")) + Number($($myParent).css("padding-bottom").replace("px", ""));
            }, myHeight = function() {
                return $(element).height() + Number($(element).css("padding-top").replace("px", "")) + Number($(element).css("padding-bottom").replace("px", ""));
            };
            attrs.$observe("mVerticalAlign", function(newVal) {
                hasInited || "true" !== newVal && newVal !== !0 || (isActive = !0, angular.element($window).bind("resize", reAlign), 
                reAlign(), $timeout(reAlign, 500)), hasInited || (hasInited = !0), "true" !== newVal && newVal !== !0 && (isActive = !1);
    ...
    return {
        ...
        link: function(scope, element) {
            scope.toggle = !1, $document.bind("click", function(event) {
                var isClickedElementChildOfPopup = element.find(event.target).length > 0;
                isClickedElementChildOfPopup || $timeout(function() {
                    scope.toggle = !1;
                });
            });
        }
    ...
    return function(dateString) {
        ...
        return dateString && (newFormattedDate = moment(dateString).format("dddd D MMM, YYYY") + " at " + moment(dateString).format("HH.mm")), 
        newFormattedDate;
    };
    ...
    return function(num) {
        ...
        if (angular.isNumber(num) && num > 0) {
            var ind = [ 1, 2, 3 ].indexOf(num % 10), lastTwoDigits = num % 100;
            suffix = ind >= 0 && !(lastTwoDigits > 10 && 20 > lastTwoDigits) ? suffixes[ind] : "th";
        }
        return num + suffix;
    };
    ...
    return function(current, total, capAt100) {
        var p = 0;
        return capAt100 = null === capAt100 ? !0 : !!capAt100, current = Number(current), 
        total = Number(total), !isNaN(current) && !isNaN(total) && total > 0 && (p = Math.floor(current / total * 100), 
        capAt100 && (p = p > 100 ? 100 : p)), p = 0 > p ? 0 : p, p = isNaN(p) ? 0 : p;
    };
}), wonderlandApp.filter("mCurrency", [ "$filter", function($filter) {
    return function(amount, currencySymbol) {
        var currency = $filter("currency"), formattedCurrency = currency(amount, currencySymbol);
        return formattedCurrency = formattedCurrency.replace("(", "-").replace(")", "").replace(".00", "");
    };
} ]), wonderlandApp.filter("addressJoiner", [ function() {
    return function(addressString, separator) {
        var addressParts = [];
        if (angular.isString(addressString)) for (var originalParts = addressString.split(separator), i = 0; i < originalParts.length; i++) angular.isString(originalParts[i]) && originalParts[i].length > 0 && "null" !== originalParts[i] && addressParts.push(originalParts[i]);
        var finalAddress = addressParts.join(", ");
        return finalAddress.length <= 0 && (finalAddress = "An address hasn't been set yet"), 
        finalAddress;
    };
} ]), wonderlandApp.filter("striptags", [ function() {
    return function(htmlString) {
        var ret = htmlString;
        return angular.isString(htmlString) && (ret = htmlString.replace(/<[^>]+>/gi, "")), 
        ret;
    };
} ]), wonderlandApp.filter("formatAmountComplete", [ function() {
    return function(col) {
        var complete = 0, total = col.length || 0;
        if (angular.isArray(col)) for (var i = 0; total > i; i++) col[i].complete === !0 && complete++;
    ...
    return function(str, quality) {
        var newStr = str;
        return str && !isNaN(quality) && (newStr = str.replace(/quality=[0-9]+/i, "quality=" + quality)), 
        newStr;
    };
} ]), wonderlandApp.filter("mWidth", [ function() {
    return function(str, width) {
        var newStr = str;
        return str && !isNaN(width) && (newStr = str.replace(/width=\d+/i, "width=" + width)), 
        newStr;
    };
    ...
    return function(fn, wait) {
        var TO = null, getWait = angular.isFunction(wait) ? wait : function() {
            return wait;
        }, wrapper = function() {
            var self = this, args = Array.prototype.slice.call(arguments);
            wrapper.cancel(), TO = setTimeout(function() {
                TO = null, fn.apply(self, args);
            }, getWait());
        };
        return wrapper.cancel = function() {
            null !== TO && (clearTimeout(TO), TO = null);
        }, wrapper.running = function() {
            return null !== TO;
        }, wrapper;
    };
}), wonderlandApp.factory("facebook", [ "$window", "$q", function($window, $q) {
    var fbDeferred = $q.defer(), fbReady = fbDeferred.promise, fbAuthentication = null, fbUserDetails = null, fbAppId = {
    ...
    return $window.fbAsyncInit = function() {
        ...
        d.getElementById(id) || (js = d.createElement(s), js.id = id, js.src = "//connect.facebook.net/en_US/sdk.js", 
        ...
        getLoginStatus: function() {
            ...
            return fbReady.then(function() {
                FB.getLoginStatus(function(response) {
                    ...
                    ("connected" === response.status || "not_authorized" === response.status) && (resultingStatus = response.status), 
                    loginStatusDeferred.resolve(resultingStatus);
                });
            }), loginStatusDeferred.promise;
        },
        doLogin: function() {
            var loginDeferred = $q.defer();
            return FB.login(function(response) {
                console.log("facebook.doLogin::FB.login", response), fbAuthentication = response;
                var resultingStatus = "not_logged_in";
                ("connected" === response.status || "not_authorized" === response.status) && (resultingStatus = response.status), 
        ...
        getUserDetails: function() {
            ...
            return FB.api("/me", function(response) {
                fbUserDetails = response, userDeferred.resolve(response);
...
} ]), wonderlandApp.factory("fileUpload", [ "$document", "$q", "uniqueId", function($document, $q, uniqueId) {
    return {
        backgroundUpload: function(form) {
            var deferred = $q.defer(), formTarget = "frame_form_target_" + uniqueId(), targetIframe = $("<iframe/>", {
                name: formTarget,
                id: formTarget
            }).appendTo($document.find("body"));
            return form.attr("target", formTarget), form.submit(), targetIframe.load(function() {
                form.scope().$apply(function() {
                    var response = targetIframe[0].contentWindow.document.body.innerHTML;
                    response = response.replace(/<\/?[^>]+>/gi, ""), targetIframe.remove();
...
}), wonderlandApp.factory("mHttp", [ "$compile", "$document", "$q", "$rootScope", "$window", "mHttpBackend", "$timeout", "uniqueId", function($compile, $document, $q, $rootScope, $window, mHttpBackend, $timeout, uniqueId) {
    var cancelFns = {}, mHttp = function(opts) {
        function onResponse(args, success) {
            deferred[success ? "resolve" : "reject"].apply(deferred, Array.prototype.slice.call(args)), 
            optsWithDefaults.invokeApply && $timeout(function() {
                $rootScope.$apply();
            });
        }
        function cleanup() {
        ...
        var optsWithDefaults = angular.extend({
            ...
            success: function() {
                optsWithDefaults.onSuccess && optsWithDefaults.onSuccess.apply(mHttp, Array.prototype.slice.call(arguments)), 
                onResponse(arguments, !0);
            },
            error: function() {
                onResponse(arguments, !1);
            }
        };
        if (optsWithDefaults.requestProgress && (xhrOpts.xhr = function() {
            function setProgress() {
                progress = Math.min((xhr.readyState - 1) / 3 + downloadProgress / 3, 1), optsWithDefaults.requestProgress(progress), 
                optsWithDefaults.invokeApply && $timeout(function() {
                    $rootScope.$apply();
                });
            }
            var xhr = $.ajaxSettings.xhr(), progress = 0, downloadProgress = 0;
            return xhr.addEventListener("progress", function(event) {
                event.lengthComputable && (downloadProgress = event.loaded / event.total, setProgress());
            }, !1), xhr.addEventListener("readystatechange", setProgress), xhr;
        }), optsWithDefaults.formData && !optsWithDefaults.data) {
            var formData = new $window.FormData();
            angular.forEach(optsWithDefaults.formData, function(val, key) {
                formData.append(key, val);
            }), xhrOpts.data = formData, xhrOpts.processData = !1, xhrOpts.contentType = !1;
        }
        var deferred = $q.defer(), promise = deferred.promise;
        promise._requestId = uniqueId(), cancelFns[promise._requestId] = function() {
            xhr.abort();
        }, promise.then(cleanup, cleanup);
        var xhr = mHttpBackend(xhrOpts);
        return promise;
    };
    return mHttp.isInProgress = function(promise) {
        return promise && promise._requestId in cancelFns;
    }, mHttp.cancel = function(promise) {
        mHttp.isInProgress(promise) && cancelFns[promise._requestId]();
    ...
    var FIND_BY_POSTCODE = "/umbraco/Api/PostcodeAnywhereApi/FindByPostcode", RETRIEVE_BY_ID = "/umbraco/Api/PostcodeAnywhereApi/RetrieveById", returnObj = {
        getAddressFromPostcode: function(postCode) {
            var deferred = $q.defer(), promise = deferred.promise, formSubmitRequest = mHttp.get(FIND_BY_POSTCODE, {
                data: {
                    postcode: postCode
                },
                dataType: "json"
            });
            return formSubmitRequest.then(function(response) {
                response && response.length ? deferred.resolve(response) : deferred.reject();
            }, function() {
                deferred.reject();
            }), promise;
        },
        getAddressFromIdField: function(idField) {
            var deferred = $q.defer(), promise = deferred.promise, formSubmitRequest = mHttp.get(RETRIEVE_BY_ID, {
                data: {
                    idField: idField
                },
                dataType: "json"
            ...
            return formSubmitRequest.then(function(response) {
                response && response.length ? deferred.resolve(returnObj.formatAddress(response[0])) : deferred.reject();
            }, function() {
                deferred.reject();
            }), promise;
        },
        formatAddress: function(address) {
            var newAddress = angular.copy(address), combiners = [ address.companyField, address.line1Field, address.line2Field, address.line3Field, address.line4Field, address.line5Field ], firstValidInLoop = !0, remainder = [];
            return angular.forEach(combiners, function(value) {
                value && (firstValidInLoop ? (firstValidInLoop = !1, newAddress.line1Field = value) : remainder.push(value));
            }), newAddress.line2Field = remainder.join(", "), newAddress;
        }
    };
    return returnObj;
} ]), wonderlandApp.factory("safeApply", [ function() {
    return function(scope, fn) {
        scope.$$phase ? fn && fn(scope) : scope.$apply(fn);
    };
