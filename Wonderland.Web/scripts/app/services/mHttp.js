...
*/
wonderlandApp.factory('mHttp', ['$compile', '$document', '$q', '$rootScope', '$window', 'mHttpBackend', 'safeApply', 'uniqueId',
                       function ( $compile,   $document,   $q,   $rootScope,   $window,   mHttpBackend,   safeApply,   uniqueId) {
    var cancelFns = {};
